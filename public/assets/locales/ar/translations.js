...
window.i18ln = {
  ...
  'errors.wrongLength': '{{description}} هو الطول الخاطئ، (يجب أن يكون {{is}} حرف)',
  ...
  'errors.greaterThanOrEqualTo': 'يجب أن يكون {{description}} أكبر من أو يساوي {{gte}}',
  'errors.equalTo': '{{description}} يجب أن يساوي {{is}}',
  'errors.lessThan': 'يجب أن يكون {{description}} أقل من {{lt}}',
  'errors.lessThanOrEqualTo': 'يجب أن يكون {{description}} أقل من أو يساوي {{lte}}',
  ...
  'common.add-to-collection-success': 'لقد ضفت {{contentTitle}} إلى {{collectionTitle}}. هل تريد تعديل ال {{collectionType}}؟',
  'common.add-to-lesson-success': 'لقد ضفت {{collectionTitle}} إلى {{contentTitle}}. هل تريد تعديل ال{{collectionType}}؟',
  ...
  'common.bookmarked-content-success': 'سيتم إضافة {{contentType}} الذي تم وضع إشارة مرجعية عليه إلى صفحة التعليم المستقل الخاصة بك',
  'common.bookmarked-success': 'سيتم إضافة كل المحتوى الذي تم وضع إشارة مرجعية عليه إلى صفحة التعليم المستقل الخاصة بك',
  ...
  'common.delete': 'حذف',
  'common.delete-instructions.links-inaccessible': 'سيتعذر الوصول إلى  جميع الروابط المشارَكة',
  'common.delete-instructions.content-inaccessible': 'سيتعذر وصول محتوى المساق المحذوف إلى الصفوف الدراسية المرتبطة به.',
  ...
  'common.errors.can-not-join-class': 'تعذر الانضمام إلى الصف الدراسي، يرجى إعادة المحاولة بعد قليل',
  'common.errors.assessment-not-added-to': 'تعذر إضافة التقييم للدرس في الوقت الحالي. يرجى إعادة المحاولة بعد قليل',
  'common.errors.assessment-not-copied': 'تعذر نسخ التقييم الآن. يرجى إعادة المحاولة بعد قليل',
  'common.errors.assessment-not-created': 'تعذر إنشاء التقييم الآن. يرجى إعادة المحاولة بعد قليل',
  'common.errors.assessment-not-updated': 'تعذر تحديث التقييم الآن. يرجى إعادة المحاولة بعد قليل',
  'common.errors.category-title-presence': 'يرجى إدخال عنوان الفئة',
  'common.errors.class-min-score': 'يجب أن يكون الحد الأدنى للعلامة بين 1 و 100',
  'common.errors.class-not-created': 'تعذر إنشاء الصف الدراسي الآن. يرجى إعادة المحاولة بعد قليل',
  'common.errors.class-title-presence': 'يرجى تسمية صفك الدراسي',
  'common.errors.collection-not-added-to': 'يتعذر إضافة المجموعة إلى الدرس في الوقت الحالي. يرجى إعادة المحاولة بعد قليل',
  'common.errors.collection-not-copied': 'تعذر نسخ المجموعة في الوقت الحالي، يرجى إعادة المحاولة بعد قليل',
  'common.errors.collection-not-created': 'تعذر إنشاء المجموعة في الوقت الحالي. يرجى إعادة المحاولة بعد قليل',
  'common.errors.collection-not-updated': 'تعذر تحديث المجموعة الآن. يرجى إعادة المحاولة بعد قليل',
  ...
  'common.errors.course-not-copied': 'تعذر نسخ المساق الدراسي في الوقت الحالي، يرجى إعادة المحاولة بعد قليل',
  'common.errors.course-not-created': 'تعذر إنشاء المساق الدراسي في الوقت الحالي. يرجى إعادة المحاولة بعد قليل',
  'common.errors.course-not-updated': 'تعذر تحديث المساق الدراسي في الوقت الحالي. يرجى إعادة المحاولة بعد قليل',
  ...
  'common.errors.hotspot-text-max-choices': 'لقد وصلت إلى الحد الأقصى من خيارات الإجابة',
  'common.errors.file-max-size': 'يتم دعم الملفات التي يقل حجمها عن 5 ميغابايت فقط',
  'common.errors.file-upload-missing': 'يرجى اختيار ملف بأي من الامتدادت التالية: {{extensiones}}',
  'common.errors.getting-next-resource': 'حدث خطأ في تثبيت الإجابات، يرجى المحاولة مرة أخرى.',
  'common.errors.lesson-not-copied': 'تعذر نسخ الدرس في الوقت الحالي. يرجى إعادة المحاولة بعد قليل',
  'common.errors.lesson-not-created': 'تعذر إنشاء الدرس في الوقت الحالي. يرجى إعادة المحاولة بعد قليل',
  'common.errors.lesson-not-loaded': 'تعذر تحميل الدرس في الوقت الحالي. يرجى إعادة المحاولة بعد قليل',
  ...
  'common.errors.profile-not-updated': 'تعذر تحديث الملف الشخصي في الوقت الحالي. يرجى إعادة المحاولة بعد قليل',
  'common.errors.question-not-added-to': 'تعذر إضافة سؤال إلى {{collectionType}} في الوقت الحالي. يرجى إعادة المحاولة بعد قليل',
  'common.errors.question-not-copied': 'تعذر نسخ السؤال في الوقت الحالي. يرجى  إعادة المحاولة بعد قليل',
  'common.errors.question-not-created': 'تعذر إنشاء سؤال في الوقت الحالي. يرجى إعادة المحاولة بعد قليل',
  'common.errors.question-not-updated': 'تعذر تحديث السؤال في الوقت الحالي. يرجى إعادة المحاولة بعد قليل',
  'common.errors.reset-password-error': 'هناك خطأ ما، لا يمكن إعادة تعيين كلمة المرور. يرجى المحاولة بعد قليل',
  'common.errors.reset-google-account-exists': 'لقد تم إنشاء حسابك باستخدام حساب جوجل، ولا يمكننا إعادة تعيين كلمة المرور الخاصة به. إذا نسيت كلمة المرور الخاصة بحساب جوجل، يجب عليك إعادة تعيينها عن طريق تطبيقات جوجل.',
  'common.errors.resource-description-length': 'الحد الأقصى لعدد الأحرف في الوصف هو 500 حرف.',
  ...
  'common.errors.resource-not-added-to-collection': 'تعذر إضافة المصدر إلى المجموعة في الوقت الحالي. يرجى إعادة المحاولة بعد قليل',
  'common.errors.resource-not-copied': 'تعذر نسخ المصدر في الوقت الحالي. يرجى إعادة المحاولة بعد قليل',
  'common.errors.resource-not-created': ' تعذر إنشاء المصدر في الوقت الحالي. الرجاء إعادة المحاولة بعد قليل',
  'common.errors.resource-not-updated': 'تعذر تحديث المصدر في الوقت الحالي. يرجى إعادة المحاولة بعد قليل',
  'common.errors.resource-same-host-url': 'لا يمكن أن تكون المصادر عبارة عن روابط خاصة بجورو',
  'common.errors.resource-title-length': 'الحد الأقصى لعدد الأحرف في العنوان هو 50 حرفاً',
  ...
  'common.errors.sign-in-credentials-not-valid': 'هناك خطأ ما، يرجة التأكد من اسم المستخدم وكلمة المرور والمحاولة مرة أخرى',
  'common.errors.sign-in-google-account-exists': 'يرجى تسجيل الدخول باستخدام جوجل، لا يمكننا إعادة تعيين كلمة المرور',
  'common.errors.sign-up-error': 'تعذر إنشاء الحساب الآن. يرجى إعادة المحاولة بعد قليل',
  'common.errors.sign-up-first-name': 'يرجى إدخال الاسم الاول',
  'common.errors.sign-up-last-name': 'يرجى إدخال اسم العائلة',
  'common.errors.sign-up-name-length': 'يجب أن يحتوي اسم العائلة على حرفين على الأقل',
  ...
  'common.errors.unit-not-copied': 'تعذر نسخ الوحدة في الوقت الحالي. يرجى إعادة المحاولة بعد قليل',
  'common.errors.unit-not-created': 'تعذر إنشاء الوحدة في الوقت الحالي. يرجى إعادة المحاولة بعد قليل',
  'common.errors.unit-not-loaded': 'تعذر تحميل الوحدة في الوقت الحالي. يرجى إعادة المحاولة بعد قليل',
  'common.errors.unit-title-required': 'يرجى إدخال عنوان الوحدة',
  'common.errors.user-email-presence': 'يرجى إدخال بريد إلكتروني صالح',
  'common.errors.username-length': 'يجب أن يتكون اسم المستخدم من 4 إلى 254 حرفاً. ',
  'common.errors.forgot-password-gmail': 'يرجى تسجيل الدخول باستخدام جوجل، لا يمكننا إعادة تعيين كلمة المرور',
  ...
  'common.link-out-message': '* إذا ظهر المصدر الخاص بك فارغاً عند المعاينة أعلاه، فقد تحتاج إلى تفعيل خاصية "ربط خارجي" لعرض المحتوى في صفحة أخرى.',
  ...
  'common.no-content-my-report': 'لا يوجد تقارير، سيكون لديك تقارير عند البدء بالتعلم.',
  ...
  'common.no-independent-results': 'عندما تبدأ البحث عن  {{contentType}} يحتوي على إشارة مرجعية، سيظهر هنا.',
  ...
  'common.remix-assessment-success': 'تمت إعادة مزج التقييم {{assessmentTitle}}. هل تريد تعديل هذا التقييم؟',
  'common.remix-collection': 'إعادة مزج المجموعة.',
  'common.remix-collection-lead': 'أنت على وشك إعادة مزج المجموعة.',
  'common.remix-collection-success': 'لقد قمت بإعادة مزج مجموعة {{collectionTitle}}. هل تريد تعديل هذه المجموعة؟',
  'common.remix-course': 'إعادة مزج المساق الدراسي.',
  'common.remix-course-lead': 'أنت على وشك إعادة مزج المساق الدراسي.',
  'common.remix-course-success': 'لقد قمت بإعادة مزج المساق الدراسي {{courseTitle}}. هل تريد تعديل هذا المساق؟',
  ...
  'common.remix-question-success': 'لقد قمت بإعادة مزج سؤال {{questionTitle}}. هل تريد تعديل هذا السؤال؟',
  'common.remix-resource': 'إعادة مزج المصدر',
  'common.remix-resource-lead': 'أنت على وشك إعادة مزج المصدر.',
  'common.remix-resource-success': 'لقد قمت بإعادة مزج مصدر {{resourceTitle}}. هل تريد تعديل هذا المصدر؟',
  ...
  'common.remix-warning': 'هناك الكثير من المحتوى الرائع في هذا المساق، ونسخه سيستغرق وقتاً، يرجى تأكيد بدء عملية النسخ وفي غضون 15 دقيقة ستكون نسختك على ملفك الشخصي. ',
  'common.remove': 'حذف',
  'common.report': 'تقرير',
  ...
  'common.select': 'اختر',
  'common.select-a-framework': 'يرجى أولا اختيار إطار المعايير في قسم معلومات المساق الدراسي أعلاه.',
  'common.sentence': 'جملة',
  'common.settings': 'إعدادات',
  'common.search': 'بحث',
  'common.search-placeholder': 'بحث',
  'common.search-placeholder-text': 'بحث...',
  'common.search-error-message': 'يجب أن تتكون مصطلحات البحث من 3 أحرف على الأقل.',
  ...
  'common.studen-id-display': 'هوية الطالب (غير ظاهرة على الملف الشخصي ولكن ظاهرة عند التقييم المجهول)',
  ...
  'common.warnings.on-air-connection-lost': 'فقدت لوحة تحكم "التقييم المباشر" الاتصال، وتتم إعادة المحاولة تلقائيا. يرجى عدم تحديث الشاشة.',
  'common.warnings.character-limit': 'لقد وصلت إلى الحد الأقصى من عدد الأحرف المسموح به',
  'common.word': 'كلمة',
  'common.yes': 'نعم',
  ...
  'index.browseContent.grades_missing_message': 'يرجى تحديد المرحلة الدراسية والموضوع.',
  ...
  'index.gettingStarted.toolkit.description': 'مرحبا بكم في جورو! ألق نظرة على هذه المصادر لمعرفة ما يمكنك القيام به مع جورو والبدء بسرعة.',
  'index.gettingStarted.classroom.title': 'قصص من الصف الدراسي',
  'index.gettingStarted.classroom.description': 'تعلم مقتدياً بالقصص المطروحة من قبل المعلمين الذين يقولون أن جورو قد أحدث فرقاً في صفوفهم الدراسية.',
  'index.gettingStarted.events.title': 'أهم الأحداث.',
  'index.gettingStarted.events.description': 'نقدم ندوات ودورات تدريبية مجانية لمساعدتك في البدء مع جورو.',
  ...
  'index.findDescription': 'تصفح الآلاف من المجموعات من الروضة وحتى الصف 12 التي أعدّها المعلمون  أو ابحث فيما يزيد عن 16 مليون مصدر. ',
  'index.remixDescription': 'أعد مزج المجموعات ونسق المحتوى لتلبية احتياجات طلابك.',
  'index.shareDescription': 'شارك المجموعات مع طلابك من خلال صفوف جورو. تسجيل الدخول غير مطلوب.',
  'index.monitorDescription': 'قم بقياس مدى تقدم وتفاعل الطلاب، للتدخل المباشر إذا تطلب الأمر ذلك.',
  'index.freeAndOpen.title': 'مجاني ومتوفر دائماً',
  'index.freeAndOpen.description': 'نؤمن بان التعليم حق من حقوق الإنسان. سيقدم موقع جورو للمعلمين والطلاب في جميع انحاء العالم خدمات تعليم مجانية دائمة وبدون إعلانات. ',
  ...
  'class.edit.class-greetings-placeholder': 'ألقِ التحية على طلابك أو حفزهم أو أنشئ إعلاناً لهم...إلخ',
  ...
  'class.analytics.performance.better-experience-message': 'للحصول على تجربة أفضل مع جورو، قم بعرض التحليل الخاص بالصف الدراسي على الحاسوب المكتبي أو الحاسوب اللوحي.',
  ...
  'class.analytics.performance.gru-grade-items.students.not-started': 'لم تبدأ.',
  ...
  'class.quick-start.new-course-desc': 'ابدأ بإنشاء مساق دراسي جديد، أو مجموعة أو تقييم',
  ...
  'content.classes.create.condition-prompt': 'كيف سينضم الطلاب إلى صفك الدراسي؟',
  'content.classes.create.condition-prompt-code': 'أي شخص لديه رمز الصف الدراسي',
  ...
  'content.classes.join.class-not-found': 'لم يتم العثور على الصف الدراسي. تأكد من إدخال رمز الصف الدراسي الصحيح.',
  ...
  'content.questions.edit.builder.answer-instructions.FIB': 'ضِف ما يصل إلى 5 ملحوظات وشرح للإجابة.',
  'content.questions.edit.builder.answer-instructions.HS_IMG': 'يمكنك إضافة ما يصل إلى 10 إجابات على شكل صورة واختيار إجابة صحيحة واحدة أو أكثر.',
  'content.questions.edit.builder.answer-instructions.HS_TXT': 'يمكنك إضافة ما يصل إلى 10 إجابات على شكل خيارات واختيار إجابة صحيحة واحدة أو أكثر.',
  'content.questions.edit.builder.answer-instructions.HT_HL_ST': 'عند كتابة السؤال، استخدم الأقواس للإشارة إلى الجمل المظللة. بحيث يحتوي زوج الأقواس الواحد على جملة واحدة فقط تنتهي بنقطة. مثال: بنى الخنزير الأول الصغير منزله من القش. (هاجم الذئب السيء الكبير المنزل من الأسفل.) بنى الخنزير الثاني بيته من الخشب. الحد الأقصى للأحرف: 5000',
  'content.questions.edit.builder.answer-instructions.HT_HL_WD': 'عند كتابة السؤال، استخدم الأقواس للإشارة إلى الكلمات المظللة. بحيث يحتوي زوج الأقواس الواحد على كلمة واحدة فقط. مثال: هاجم الذئب الشرير (الكبير) المنزل من (الأسفل). الحد الأقصى للأحرف: 5000',
  'content.questions.edit.builder.answer-instructions.HT_RO': 'يمكنك إضافة ما يصل إلى 10 إجابات بالترتيب الصحيح. حيث أن الترتيب سيكون عشوائيا لدى الطلاب.',
  'content.questions.edit.builder.answer-instructions.MA': 'يمكنك إضافة ما يصل إلى 10 إجابات وصورة وشرح وما يصل إلى 5 تلميحات.',
  'content.questions.edit.builder.answer-instructions.MC': 'يمكنك إضافة ما يصل إلى 10 إجابات وتحديد إجابة صحيحة واحدة. الحد الأقصى للأحرف: 200 ',
  'content.questions.edit.builder.answer-instructions.OE': 'اكتب الإجابة الصحيحة. الحد الأقصى للأحرف: 5000.',
  'content.questions.edit.builder.answer-instructions.T/F': 'اختر الإجابة الصحيحة.',
  'content.questions.edit.builder.question-instructions.FIB': 'عند كتابة السؤال بصيغة "املأ الفراغ"، استخدم الأقواس لتحديد الكلمات التي يجب أن يكون مكانها فارغاً في الجملة. مثال: "هاجم (الذئب) الشرير الكبير (المنزل) من الأسفل." يمكنك إضافة صورة أيضاً.',
  ...
  'content.questions.edit.builder.question-instructions.HT_HL': 'وجِه سؤالاً لطلابك.',
  ...
  'content.questions.edit.builder.submission-format.title': 'نموذج تقديم الطالب',
  'content.questions.edit.builder.submission-format.answer-type.text-box': 'مربع النص',
  'content.questions.edit.builder.feedback-grading.title': 'التغذية الراجعة و العلامة',
  'content.questions.edit.builder.feedback-grading.from-existing-rubric': 'من سلم التقييم الحالي',
  'content.questions.edit.builder.feedback-grading.scoring': 'العلامة',
  'content.questions.edit.builder.feedback-grading.maximum-points': 'الحد الأعلى لعدد النقاط',
  'content.questions.edit.builder.feedback-grading.increment': 'الحد الأدنى لعدد النقاط',
  'content.questions.edit.builder.feedback-grading.rubric-error': 'يرجا إضافة سلم تقييم',
  'content.modals.delete-bookmark.confirmation': 'هل تريد حذف االإشارة المرجعية عن الـ {{type}}؟',
  'content.modals.delete-bookmark.delete-error': 'تعذر حذف الإشارة المرجعية عن هذا الـ {{type}} الآن. يرجى إعادة المحاولة بعد قليل.',
  'content.modals.remove-class-activity.confirmation': 'هل أنت متأكد من حذف هذا {{type}} من قائمة نشاطات الصف اليومية؟ ',
  'content.modals.remove-class-activity.delete-error': 'تعذر حذف هذا {{type}} الآن، يرجى المحاولة بعد قليل.',
  'content.modals.delete-class.legend': 'أنت على وشك حذف صفك الدراسي',
  'content.modals.delete-class.student-access': 'لن يتمكن الطلاب من الولوج للصف الدراسي',
  'content.modals.delete-class.student-data-deleted': 'سيتم حذف جميع بيانات الطالب.',
  ...
  'content.modals.archive-class.links-not-accessible': 'سيتعذر الوصل إلى جميع الروابط المشاركة',
  'content.modals.archive-class.students-no-access': 'لن يتمكن الطلاب من ولوج الصف الدراسي',
  'content.modals.archive-class.not-add-students': 'لن تتمكن من إضافة المزيد من الطلاب إلى الصف الدراسي',
  'content.modals.archive-class.confirmation': 'هل أنت متأكد من أرشفة ',
  'content.modals.delete-content.legend': 'أنت على وشك حذف',
  'content.modals.delete-content.content-legend': '{{title}} - {{index}} {{type}} من {{parentName}}',
  'content.modals.delete-content.content-legend-header': '{{title}} من {{parentName}}',
  'content.modals.delete-content.delete-warning': 'سيتم حذف جميع المحتويات الموجودة في هذا {{type}}',
  'content.modals.delete-content.delete-error': 'تعذر حذف {{type}} في الوقت الحالي. يرجى إعادة المحاولة بعد قليل.',
  'content.modals.delete-content.confirmation': 'هل تريد المتابعة؟ يرجى كتابة "حذف" أدناه وانقر على "حذف".',
  'content.modals.delete-resource.legend': 'يرجى تأكيد حذف {{title}} بشكل نهائي.',
  'content.modals.delete-resource.delete-warning': 'سيتم حذف جميع المحتويات الموجودة في هذا {{type}}',
  'content.modals.delete-resource.delete-error': 'تعذر حذف {{type}} في الوقت الحالي. يرجى إعادة المحاولة بعد قليل.',
  'content.modals.delete-resource.confirmation': 'هل تريد المتابعة؟ يرجى النقر على \'حذف نهائي\'.',
  'content.modals.delete-resource.first-check': 'هذا حذف نهائي ولا يمكن التراجع عنه.',
  'content.modals.delete-resource.second-check': 'سيتم حذف جميع نسخ هذا المصدر في مجموعاتك ومجموعات أي مستخدم في منظمتك.',
  'content.modals.delete-rubric.legend': 'يرجى تأكيد حذف {{title}} بشكل نهائي.',
  'content.modals.delete-rubric.delete-warning': 'سيتم حذف المحتوى من سلم التقييم هذا',
  'content.modals.delete-rubric.delete-error': 'يتعذر حذف سلم التقييم الآن، يرجى المحاولة بعد قليل. ',
  'content.modals.delete-rubric.confirmation': 'هل تريد المتابعة؟ يرجى النقر على \'حذف نهائي\'.',
  'content.modals.delete-rubric.first-check': 'هذا حذف نهائي ولا يمكن التراجع عنه.',
  'content.modals.remove-content.legend': 'أنت على وجد حذف {{title}} من {{parentName}}',
  'content.modals.remove-content.remove-error': 'يتعذر حذف {{type}} في الوقت الحالي. يرجى إعادة المحاولة بعد قليل.',
  'content.modals.remove-content.confirmation': 'هل تريد المتابعة؟ يرجى كتابة "حذف" أدناه والنقر على "حذف".',
  'content.modals.remove-student.title': 'حذف الطالب وبياناته',
  'content.modals.remove-student.legend': 'أنت على وشك حذف{{studentName}} من هذا الفصل الدراسي وحذف جميع بياناته.',
  'content.modals.remove-student.data-inaccessible': 'سيتم حذف جميع البيانات الخاصة به  ولا يمكن الوصول إليها من قبل أيٍ منكم.',
  'content.modals.remove-student.classroom-access': 'لن يتمكن من الوصول إلى الصفوف الدراسية أو المحتوى.',
  'content.modals.remove-student.data-lost': 'في حال انضمامه مرة أخرى، سيفقد جميع البيانات السابقة.',
  'content.modals.remove-student.remove-error': 'تعذر حذف هذا الطالب في الوقت الحالي. يرجى إعادة المحاولة بعد قليل.',
  'content.modals.remove-student.confirmation': 'هل تريد المتابعة؟ يرجى كتابة "حذف" أدناه وانقر على "حذف".',
  'content.modals.quick-remove-content.legend': 'يرجى تأكيد حذف {{title}} من {{parentName}}.',
  'content.modals.quick-delete-content.legend': 'يرجى تأكيد حذف {{title}} من {{parentName}} بشكل نهائي.',
  'content.modals.quick-delete-content.delete': 'حذف نهائي',
  'content.resources.edit.best-practices': ' المصادر عبارة عن وسائط متعددة بصيغ مختلفة كالفيديوهات، والمحتوى التفاعلي والمواقع الإلكترونية وصور ومستندات جوجل وغيرها. كن مبدعاً واستخدم مصادرك الخاصة  أو ابحث بدهاء في مخزون جورو الوافر من المصادر.\n\nاستخدم المصادر بصيغها المتنوعة  لجذب انتباه طلابك إضافة للشرح الكلامي لإرشادهم أثناء استخدام المصدر. \n\nكما ننصح بربط كل سؤال بالمعايير الخاصة به أو المعايير الجزئية، و مهارات القرن الواحد والعشرين. يمكنك مراقبة تفاعل الطلاب مع المصادر من خلال لوحة التحكم الخاصة بك.',
  ...
  'student-landing.my-performance.primary-text': 'قم باختيار الأشياء التي تريد تحليلها، وسنقوم بإنشاء تقرير خاص بالأداء.',
  ...
  'student-landing.no-classrooms': 'لم تنضم إلى أي صف دراسي بعد . انقر على "انضم للصف" لإضافة الصف الخاص بمعلمك. بإمكانك أن تبحث عن الصفوف الدراسية المميزة تحت علامة تبويب "المكتبة".',
  ...
  'student-independent-learning.no-courses': 'ستظهر لك المساقات الدراسية التي تم وضع إشارات مرجعية عليها عندما تبحث عنها هنا. ',
  'student-independent-learning.no-collections': 'ستظهر لك المجموعات التي تم وضع إشارات مرجعية عليها عندما تبحث عنها هنا. ',
  'student-independent-learning.no-assessments': 'ستظهر لك التقييمات التي تم وضع إشارات مرجعية عليها عندما تبحث عنها هنا. ',
  'student-independent-learning.no-independent-results': 'ابحث عن "المكتبة" لتعلم أشياء جديدة.',
  'student-independent-learning.no-bookmarks': 'ستظهر المساقات الدراسية والمجموعات والتقييمات عندما يتم وضع إشارات مرجعية عليها هنا. ',
  ...
  'teacher-landing.create-classroom': 'أنشئ صفاً دراسياً ثم عين المحتوى ثم قم بدعوة طلابك.',
  ...
  'teacher-landing.class.class-management-tab.assessment-min-score': 'تقييم الحد الأدنى من النقاط للحصول على الجوائز',
  'teacher-landing.class.class-management-tab.assigned-course': 'المساق الدراسي المعيّن',
  ...
  'teacher-landing.class.class-management-tab.attend-class-with-code': 'احضر الصف مع رمزك الخاص.',
  'teacher-landing.class.class-management-tab.class-information': 'معلومات الصف',
  ...
  'teacher-landing.class.class-management-tab.click-to-copy-class-code': 'انقر لنسخ رمز الصف',
  'teacher-landing.class.class-management-tab.course-information': 'معلومات المساق الدراسي',
  ...
  'teacher-landing.class.class-management-tab.email-address': 'عنوان البريد الإلكتروني',
  ...
  'teacher-landing.class.class-management-tab.students-null': 'شارك رمز الصف مع الطلاب ليتمكنوا من الانضمام لصفك الدراسي.',
  ...
  'teacher-landing.class.back-to-class-activities': 'العودة إلى نشاطات الصف اليومية',
  ...
  'teacher-landing.class.class-activities-tab.add-from-course-map': 'ضِف من خريطة المساق الدراسي',
  'teacher-landing.class.class-activities-tab.add-from-my-content': 'ضِف من المحتوى الخاص بي',
  'teacher-landing.class.class-activities-tab.welcome-dca': 'أهلاً بك في نشاطات صفك اليومية، هنا يمكنك تعيين مجموعات وتقييمات لطلابك لإكمالها اليوم. \nملاحظة: أي تقارير يتم إنشاءها ستكون متوفرة اليوم حتى آخر محاولة. ',
  ...
  'teacher-landing.no-classrooms': 'لم تنشئ صفوف دراسية بعد، اضغط على "أنشئ صف دراسي"، أو ابحث عن المساقات الدراسية المميزة تحت علامة التبويب "المكتبة " ',
  'teacher-landing.no-course': 'لم تُعيِّن مساق دراسي لهذا الصف بعد.',
  'teacher-landing.teach': 'درِّس في صفوف جورو الدراسية.',
  'teacher-landing.welcome-course-map': 'في خريطة المساق الدراسي، يمكنك عرض محتوى المساق، وتشغيل التقيماات أو إيقافها، و إطلاق التقييمات في الوقت الحالي. كما يمكنك مشاهدة ',
  ...
  'goals.manage.goals-not-found': 'لم تحدد أي أهداف بعد. يمكنك إضافة هدف بالنقر على \\"Add Goal\\" أعلاه. ',
  'goals.create.error-add-title': 'يرجى إدخال الهدف',
  'goals.create.error-length-title': 'الحد الأقصى من الأحرف لكتابة الهدف 200 حرف',
  'goals.create.error-add-start-date': 'يرجى إدخال تاريخ البدء',
  'goals.create.error-add-end-date': 'يرجى إدخال تاريخ الانتهاء',
  'goals.create.error-greater-end-date': 'يجب أن يكون تاريخ الانتهاء أحدث من تاريخ البدء',
  'goals.create.error-add-status': 'يرجى تحديد حالة الهدف',
  'goals.create.error-length-reflection': 'الحد الأقصى من الأحرف لكتابة مدى تأثير الهدف 2000 حرف',
  ...
  'gru-add-to.add-assessment-to-lesson-lead': 'اختر تقييماً لإضافته إلى هذا الدرس.',
  ...
  'gru-add-to.add-to-collection-lead': 'اختر مجموعة تريد إضافة {{contentTitle}} لها.',
  'gru-add-to.add-to-existing-classroom': 'ضِف إلى الصف الدراسي الحالي.',
  'gru-add-to.add-to-existing-classroom-lead': 'اختر صفاً دراسياً تريد اضافته إلى ',
  'gru-add-to.add-to-assessment': 'ضِف إلى التقييم أو المجموعة.',
  'gru-add-to.add-to-assessment-lead': 'اختر تقييما تريد إضافة {{contentTitle}} إليه.',
  'gru-add-to.assessments-info': 'التقييمات المدرجة هنا لا تنتمي إلى درس أو مساق دراسي آخر.',
  'gru-add-to.collections-info': 'المجموعات المدرجة هنا لا تنتمي إلى درس أو مساق دراسي آخر. ',
  ...
  'gru-add-rubric-to-question.no-rubrics': 'لم تنشئ أي سلم تقييم لإرفاقه مع سؤال "الإجابة الكتابية". يمكنك إنشاء سلم تقييم تحت علامة تبويب "المحتوى الخاص بي" التي يمكن الولوج إليها من خلال ملفك الشخصي. ',
  ...
  'gru-assessment-confirmation.setting-forward-backward': 'يمكنك التنقل إلى الأمام وإلى الخلف للإجابة على الأسئلة.',
  'gru-assessment-confirmation.unlimited-attempts-left': 'لديك عدد غير محدد من المحاولات.',
  ...
  'gru-assessment-confirmation.attempts-left.zero': 'لديك {{count}} من المحاولات.',
  'gru-assessment-confirmation.attempts-left.one': 'تبقى لديك محاولة واحدة فقط.',
  'gru-assessment-confirmation.attempts-left.other': 'لديك {{count}} من المحاولات.',
  'gru-assessment-confirmation.attempts-left.other-teacher': 'Student have {{count}} attempts',
  'gru-assessment-confirmation.unlimited-attempts': 'لديك عدد غير محدد من المحاولات.',
  ...
  'gru-submit-confirmation.description': 'أنت على وشك إنهاء هذا الاختبار وإرسال جميع الأجوبة. أي سؤال لم تتم الإجابة عليه يعتبر جواباً خاطئاً. ',
  'gru-submit-confirmation.cancel': 'إلغاء',
  'gru-submit-confirmation.ok': 'ok',
  'gru-submit-confirmation.confirm': 'إنهاء الاختبار.',
  'gru-submit-confirmation.finish-description': 'انقر على "إنهاء الاختبار" لتثبيت إجاباتك.',
  'gru-quick-course-search.add-from-course': 'ضِف من المساق الحالي',
  'gru-quick-course-search.view-featured-courses': 'عرض المساقات الدراسية المميزة',
  ...
  'gru-category-panel.teacher.body': 'اكتشف المحتوى المتوافق مع المعايير ونسق المحتوى وتتبع تقدم الطلاب من خلال تحليلات البيانات.',
  'gru-category-panel.teacher.cta': 'شاهد القصص',
  'gru-category-panel.student.title': 'للطلاب',
  'gru-category-panel.student.body': 'ابتحث عن الاهتمامات وابنِ وراقب التقدم من خلال مواد التعليم. ',
  ...
  'gru-category-panel.district.body': 'تعاون  مع جورو لإطلاق العنان للتعليم المخصص ولمشاركة المنهاج الذي تمت مراجعته من قبل السلطات المعنية.',
  'gru-category-panel.district.cta': 'شاهد مدى تأثيرنا',
  'gru-category-panel.partner.title': 'للشركاء',
  'gru-category-panel.partner.body': 'تعاون مع شركائنا في المهمة لرفع نسبة التأثير الجماعي على بيئة التعليم. ',
  ...
  'gru-user-registration.joinDescription': 'جِد وامزج، وشارك أفضل مصادر التعليم المجانية من الروضة وحتى الصف 12. ',
  ...
  'gru-user-registration.descriptionWhyGoogle': 'إنشاء حسابك باستخدام جوجل سيكون أسهل وأسرع ولن تحتاج إلى كلمة مرور جديدة. ',
  ...
  'gru-welcome-message.text-temporary-one': 'يسعدنا مساعدتك خلال رحلتك في متصفح جورو التعليمي، ابحث عن أيقونة  "قم بجولة" ',
  'gru-welcome-message.text-temporary-two': 'للجولات الإرشادية حول كيفية استخدام مميزاتنا. ',
  'gru-welcome-message.text-one': 'يسعدنا مساعدتك خلال رحلتك في متصفح جورو التعليمي بالطرق التالية: ',
  'gru-welcome-message.text-two.subtitle': 'قم بجولة',
  'gru-welcome-message.text-two.text': 'توفير جولات إرشادية عن كيفية استخدام ميزاتنا.  ',
  'gru-welcome-message.text-three.subtitle': 'المساعدة',
  'gru-welcome-message.text-three.text': 'يمكنك الحصول على المساعدة في حال وجود أي أسئلة إضافية.',
  'gru-welcome-message.text-four.subtitle': 'جديد',
  'gru-welcome-message.text-four.text': 'يمكنك تحديد ميزات جديدة لتجربتها. ',
  'gru-welcome-message.text-five': 'إذا أردت العودة إلى صفحتك الرئيسية، ببساطة انقر على',
  ...
  'sign-up.error-email-taken': 'هذا البريد الإلكتروني مُستخدم، يرجى المحاولة مرة أخ\nرى',
  ...
  'sign-up.error-district-message': 'يرجى اختيار المقاطعة من القائمة أو قم بتزويدنا بها في "أخرى" ',
  ...
  'forgot-password.footer-google-description-1': 'حاول تسجيل الدخول مرة أخرى بالضغط على \\\'تسجيل الدخول باستخدام جوجل\\\'',
  'forgot-password.footer-description-1': 'ستصلك رسالة إلكترونية تتضمن رابطاً لإعادة تعيين كلمة المرور.',
  'forgot-password.footer-description-2': 'إذا كان لديك أي أسئلة، يرجى التواصل معنا. ',
  'forgot-password.mail': 'support@gooru.org',
  'forgot-password.error-email-not-exists': 'نعتذر، هذا البريد الاكتروني غير مُعرَّف',
  'forgot-password.secondStepTitle': 'تفقّد بريدك الالكتروني.',
  'forgot-password.secondStepDescription-1': 'لقد أرسلنا لك رسالة إلكترونية تتضمن رابطاً لإعادة تعيين كلمة المرور. ',
  ...
  'footer.footerDescription': 'يلتزم موقع جورو بالإبقاء على منصته التعليمية مفتوحة المصادر، وإتاحتها لبناء محتوى يحمل رخصة المشاع الإبداعي(CC0) ',
  ...
  'gru-image-picker.restriction': 'يجب أن تكون الصورة بصيغة  JPG أو GIF أو PNG وحجمها أقل من 5 ميغابايت.',
  'gru-image-picker.submit': 'استخدم الصورة',
  'gru-fib.instructions': 'يرجى كتابة إجابتك في الفراغ المناسب، ثم الضغط على \\"{{action}}\\".',
  'gru-hs-image.instructions': 'يرجى اختيار الصورة الصحيحة، ثم الضغط على \\"{{action}}\\".',
  'gru-hs-text.instructions': 'يرجى اختيار الإجابة الصحيحة، ثم الضغط على \\"{{action}}\\".',
  'gru-hot-text.instructions': 'يرجى اختيارالإجابة الصحيحة، ثم الضغط على \\"{{action}}\\".',
  ...
  'gru-multiple-answer.instructions': 'يرجى اختيارالإجابة الصحيحة، ثم الضغط على \\"{{action}}\\".',
  'gru-multiple-choice.instructions': 'يرجى اختيارالإجابة الصحيحة، ثم الضغط على \\"{{action}}\\".',
  'gru-open-ended.instructions': 'يرجى كتابة إجابتك في الحقل أدناه، ثم الضغط على \\"{{action}}\\". لحفظها عند الانتهاء.',
  'gru-open-ended.characterLimit': 'الحد الأقصى من الأحرف.',
  'gru-question-viewer.answer': 'إجابة',
  'gru-question-viewer.question': 'سؤال',
  'gru-true-false.instructions': 'يرجى اختيارالإجابة الصحيحة، ثم الضغط على \\"{{action}}\\".',
  'gru-true-false.true': 'صحيح',
  'gru-true-false.false': 'خطأ',
  'gru-reorder.instructions': 'يرجى إعادة ترتيب الإجابات بشكل صحيح، ثم النقر على \\"{{action}}\\".',
  ...
  'player.gru-viewer.not-iframe-url.header_1': 'لا يمكن عرض هذا المصدر في جورو.',
  'player.gru-viewer.not-iframe-url.header_external_assessment_1': 'لا يمكن عرض هذا التقييم باستخدام جورو.',
  'player.gru-viewer.not-iframe-url.header_2': 'لا يمكن عرض هذا المصدر في جورو.',
  'player.gru-viewer.not-iframe-url.view-resource': 'عرض المصدر',
  'player.gru-viewer.not-iframe-url.https_external': 'لا يمكن عرض هذا الرابط في جورو.',
  'player.gru-viewer.not-iframe-url.https_new_tab': 'انقر على الرابط أدناه لفتحه في صفحة تبويب جديدة.',
  'player.gru-viewer.not-iframe-url.footer_1': 'لماذا أرى هذه الصفحة الفارغة؟',
  'player.gru-viewer.not-iframe-url.footer_2': 'المصادر المضافة في جورو تأتي من آلاف الناشرين الذين',
  'player.gru-viewer.not-iframe-url.footer_3': 'ينشؤون ويشاركون المحتوى الخاص بهم. تحتوي المصادر على إعدادت مختلفة تتضمن',
  ...
  'gru-assessment-report.gru-summary.total-time-spent': 'إجمالي الوقت المستغرق.',
  'gru-assessment-report.hidden-report': 'لقد قام معلمك بإخفاء ملخص التقرير لهذا التقييم. ',
  ...
  'cards.gru-class-card.archived.request-report': 'لا يمكن تعديل هذا الصف الدراسي لأنه مؤرشف، ويمكن الوصول إلى بيانات الصف الدراسي الحالي من خلال التقرير.',
  'cards.gru-class-card.archived.report-in-progress': 'قد يستغرق إنشاء التقرير 20 دقيقة. يرجى التحقق مرة أخرى.',
  'cards.gru-class-card.archived.download-report': 'تنزيل بياناتك لهذا الصف.',
  'cards.gru-class-card.archived.no-report-available': 'لم يتم تعيين محتوى لهذا الصف',
  ...
  'home.no-classes-found.create-class.description': 'أنشئئ صف دراسي، عيِّن محتوى، ثم قم بدعوة الطلاب',
  ...
  'home.no-classes-found.join-class.description': 'انضم  إلى صف معلمك الدراسي، لتبدأ التعلم.',
  ...
  'home.no-classes-found.featured-courses.description': 'تصفح مساقات الرياضيات والعلوم والدراسات الاجتماعية ومهارات اللغة الإنجليزية.',
  'home.no-classes-found.featured-courses.button-text': 'المساقات الدراسية المميزة',
  'home.no-classes-found.teacher-toolkit.title': 'مجموعة أدوات المعلم',
  'home.no-classes-found.teacher-toolkit.description': 'لمجموعة الأدوات هذه مصادر تساعدك في البدء. ',
  ...
  'taxonomy.gru-taxonomy-selector.competency-subject-and-course': 'إطار الكفاءات والمساق الدراسي',
  'taxonomy.gru-taxonomy-selector.primary-subject-and-course': 'إطار المعايير والمساق الدراسي',
  'validations.unsavedChanges': 'لم يتم حفظ التغييرات بعد، هل تريد مغادرة هذه الصفحة؟ ',
  'featured.featured-title': 'المساقات الدراسية المميزة',
  'featured.featured-description': 'يتم تنظيم المساقات الدراسية المميزة من قبل معلمين مبتكِرين، وفحصها ومراجعتها من قِبل خبراء في المحتوى التعليمي. كما يتم تطبيقها في الصفوف الدراسية مع الطلاب. \nاكتشف وامزج ونسّق المساقات التعليمية لتخصيص التعليم ورفع مستوى تفاعل الطلاب مع هذه المساقات. اضغط هنا لمعرفة المزيد عن تطوير هذه المساقات.',
  'locateme.score': 'Score',
  'locateme.timespent': 'Time Spent',
  'locateme.view': 'View',
  'locateme.attempt': 'Attempt',
  'locateme.lastAcessesed': 'Last Accessed',
  'taxonomy.modals.gru-domain-picker.browseSelectorText': 'ما هي النطاقات التي ستغطيها هذه الوحدة؟',
  'taxonomy.modals.gru-domain-picker.selectedText.zero': 'تم تحديد {{count}} نطاقات',
  'taxonomy.modals.gru-domain-picker.selectedText.one': 'تم تحديد {{count}} نطاق',
  'taxonomy.modals.gru-domain-picker.selectedText.other': 'تم تحديد {{count}} نطاقات',
  ...
  'taxonomy.modals.gru-standard-picker.browseCompetencySelectorText': 'ما هي الكفاءات التي سيتم تغطيتها؟',
  'taxonomy.modals.gru-standard-picker.selectedText.zero': 'تم اختيار {{count}} معايير',
  'taxonomy.modals.gru-standard-picker.selectedText.one': 'تم اختيار {{count}} معيار ',
  'taxonomy.modals.gru-standard-picker.selectedText.other': 'تم اختيار {{count}} معايير',
  'taxonomy.modals.gru-standard-picker.selectedCompetencyText.zero': 'تم اختيار {{count}} كفاءات',
  'taxonomy.modals.gru-standard-picker.selectedCompetencyText.one': 'تم اختيار {{count}} كفاءة',
  'taxonomy.modals.gru-standard-picker.selectedCompetencyText.other': 'تم اختيار {{count}} كفاءات',
  ...
  'gru-settings-edit.feedback': 'یرى الطلاب ما إذا کانت إجاباتهم صحیحة أو خاطئة',
  ...
  'gru-settings-edit.disable-legend': 'يمكن للطلاب تشغيل التقييم من خريطة المساق الدراسي الخاصة بهم',
  'gru-icon-popover.settings-visibility-title': 'اجعل المحتوى الخاص بك مرئياً',
  'gru-icon-popover.settings-visibility-content': 'هذا يجعل المحتوى الخاص بك مرئياً في ملفك الشخصي. إذا كنت ترغب في مشاركة المساقات والمجموعات والتقييمات والمصادر و/ أو الأسئلة التي تنشئها مع الزملاء، نقترح عليك تفعيل هذه الميزة.',
  'gru-take-tour.text': 'جولة',
  'gru-take-tour.teacher-home.stepOne.title': 'قم بجولة',
  'gru-take-tour.teacher-home.stepOne.description': 'أهلاً بك في "قم بجولة" وفي صفحتك الرئيسية، لنبدأ الآن!',
  'gru-take-tour.teacher-home.stepTwo.title': 'شِعار',
  'gru-take-tour.teacher-home.stepTwo.description': 'ستعود إلى صفحتك الرئيسية بالنقر على الشِعار. ',
  'gru-take-tour.teacher-home.stepThree.title': 'شريط البحث',
  'gru-take-tour.teacher-home.stepThree.description': 'ابحث في فهرس المحتوى لدينا عن المواضيع التي تهمك.',
  'gru-take-tour.teacher-home.stepFour.title': 'الصفوف الدراسية',
  'gru-take-tour.teacher-home.stepFour.description': 'العودة إلى صفحتك الرئيسية.',
  'gru-take-tour.teacher-home.stepFive.title': 'مدير المحتوى',
  'gru-take-tour.teacher-home.stepFive.description': 'رابط لإنشاء المحتوى والولوج إليه بشكل سريع. ',
  'gru-take-tour.teacher-home.stepSix.title': 'المكتبة',
  'gru-take-tour.teacher-home.stepSix.description': 'تصفّح مساقاتنا الدراسية المميزة.',
  'gru-take-tour.teacher-home.stepSeven.title': 'ملفك الشخصي',
  'gru-take-tour.teacher-home.stepSeven.description': 'يمكنك ولوج وتحديث المحتوى الخاص بك وملفك الشخصي والإعدادات.',
  'gru-take-tour.teacher-home.stepEight.title': 'المساعدة',
  'gru-take-tour.teacher-home.stepEight.description': 'الذهاب إلى مركز الدعم أو تسجيل الخروج. ',
  'gru-take-tour.teacher-home.stepNine.title': 'الصفوف الدراسية',
  'gru-take-tour.teacher-home.stepNine.description': 'عرض قائمة الصفوف التي تُدرسها. ',
  'gru-take-tour.teacher-home.stepTen.title': 'الصفوف الدراسية المؤرشفة.',
  'gru-take-tour.teacher-home.stepTen.description': 'عرض قائمة الصفوف التي درَّستها في الماضي.',
  'gru-take-tour.teacher-home.stepEleven.title': 'أنشئ صفاً دراسياً',
  'gru-take-tour.teacher-home.stepEleven.description': 'قم بتسمية صفك الدراسي واضغط على الزر لإنشاء صف دراسي جديد. ',
  'gru-take-tour.student-home.stepOne.title': 'قم بجولة',
  'gru-take-tour.student-home.stepOne.description': 'أهلا بك في "قم بجولة" وفي صفحتك الرئيسية، لنشاهد الميزات المتوفرة لك في صفحتك الرئيسية. ',
  'gru-take-tour.student-home.stepFeaturedCourses.title': 'المساقات الدراسية المميزة',
  'gru-take-tour.student-home.stepFeaturedCourses.description': 'تصفح المساقات الدراسية المميزة في المواضيع التي تهمك في فهرس المحتوى الخاص بمتصفح التعليم.',
  'gru-take-tour.student-home.stepTwo.title': 'شِعار',
  'gru-take-tour.student-home.stepTwo.description': 'ستعود إلى صفحتك الرئيسية بالنقر على الشِعار. ',
  'gru-take-tour.student-home.stepThree.title': 'شريط البحث',
  'gru-take-tour.student-home.stepThree.description': 'ابحث عن  المواضيع التي تهمك في فهرس المحتوى.',
  ...
  'gru-take-tour.student-home.stepFive.description': 'تصفح المساقات الدراسية المميزة في متصفح التعليم وفي مكتبات الشركاء لإيجاد عدد من المواضيع التي تهمك.',
  'gru-take-tour.student-home.stepSix.title': 'أداء',
  'gru-take-tour.student-home.stepSix.description': 'اطلع على ملخص أدائك في المساقات التي سجلت فيها.',
  'gru-take-tour.student-home.stepSeven.title': 'ملفك الشخصي',
  'gru-take-tour.student-home.stepSeven.description': 'يمكنك تحديث وولوج المحتوى الخاص بك وملفك الشخصي',
  'gru-take-tour.student-home.stepEight.title': 'المساعدة',
  'gru-take-tour.student-home.stepEight.description': 'الذهاب إلى مركز الدعم أو تسجيل الخروج. ',
  'gru-take-tour.student-home.stepNine.title': 'الإعلانات',
  'gru-take-tour.student-home.stepNine.description': 'هنا سترى الإعلانات التي يرغب معلمك أو المدرسة أن تعرف عنها.',
  'gru-take-tour.student-home.stepTen.title': 'الصفوف الدراسية',
  'gru-take-tour.student-home.stepTen.description': 'شاهد جميع الصفوف الدراسية التي سجلت بها. ',
  'gru-take-tour.student-home.stepEleven.title': 'التعليم المستقل',
  'gru-take-tour.student-home.stepEleven.description': 'ابحث عن المواضيع التي وضعت عليها إشارة مرجعية والتي تريد أن تتعلمها. ',
  'gru-take-tour.student-home.stepTwelve.title': 'انضم للصف الدراسي',
  'gru-take-tour.student-home.stepTwelve.description': 'أدخِل رمز الصف الدراسي للانضمام إليه.',
  'gru-take-tour.student-home.stepThirteen.title': 'انتهيت!',
  'gru-take-tour.student-home.stepThirteen.description': 'والآن اضغط على مساق دراسي سجلت به، انضم للصف الدراسي، أو ابحث عن المحتوى الذي يهمك. ',
  'gru-take-tour.student-performance.stepOne.title': 'أهلا بك!',
  'gru-take-tour.student-performance.stepOne.description': 'مرحبا بكم في لوحة الأداء الخاصة بك. يمكنك استعراض أدائك في جميع الصفوف والمساقات الدراسية.',
  'gru-take-tour.student-performance.stepTwo.title': 'علامة تبويب تفصيل البيانات',
  'gru-take-tour.student-performance.stepTwo.description': 'انقر على السهم لتفصيل البيانات الخاصة بأدائك حسب النشاط والفترة الزمنية والموضوع والمساق الدراسي.',
  'gru-take-tour.student-performance.stepThree.title': 'تحديث التقرير',
  'gru-take-tour.student-performance.stepThree.description': 'بعد تحديد المرشِّحات، انقر على "تحديث التقرير" لعرض النتائج.',
  ...
  'gru-take-tour.student-performance.stepFive.description': 'امضِ قدما وحلّل أدائك!',
  'gru-take-tour.student-class.stepOne.title': 'أهلا بك!',
  'gru-take-tour.student-class.stepOne.description': 'أهلا بك في صفك الدراسي، هنا ستجد نشاطات صفك اليومية وخريطة المساق الدراسي وبيانات الأداء. لنبدأ الآن',
  'gru-take-tour.student-class.stepTopBar.title': 'المساق الدراسي، الأداء، الإكمال',
  'gru-take-tour.student-class.stepTopBar.description': 'شاهد ملخص عن المساق الدراسي والأداء العام حتى الآن. ',
  'gru-take-tour.student-class.stepTwo.title': 'أنشطة الصف اليومية',
  'gru-take-tour.student-class.stepTwo.description': 'يمكنك ولوج ودراسة النشاطات المعينة من قَبل معلمك اليوم . ',
  'gru-take-tour.student-class.stepThree.title': 'خريطة المساق الدراسي',
  'gru-take-tour.student-class.stepThree.description': 'انقر على الوحدات والدروس لإكمال المجموعات والتقييمات في المساق الدراسي.',
  'gru-take-tour.student-class.stepFour.title': 'تقريري',
  'gru-take-tour.student-class.stepFour.description': 'عاين أداء سصفك الدراسي العام.',
  'gru-take-tour.student-class.stepFive.title': 'انتهيت!',
  'gru-take-tour.student-class.stepFive.description': 'ابدأ بدراة المساق الدراسي بالنقر على "خريطة المساق الدراسي" أو "النشاطات اليومية"',
  'gru-take-tour.teacher-class.stepOne.title': 'أهلا بك!',
  'gru-take-tour.teacher-class.stepOne.description': 'أهلاً بك في صفك الدراسي، هنك يمكنك مشاهدة وتعيين نشاطات صفك اليومية وخريطة المساق وتحديث معلومات الصف ومشاهدة بيانات أداء الطلاب. لنبدأ الآن!',
  'gru-take-tour.teacher-class.stepTopBar.title': 'المساق الدراسي، الأداء، الإكمال',
  'gru-take-tour.teacher-class.stepTopBar.description': 'شاهد ملخص عن المساق الدراسي والأداء العام حتى الآن. ',
  'gru-take-tour.teacher-class.stepTwo.title': 'أنشطة الصف اليومية',
  'gru-take-tour.teacher-class.stepTwo.description': 'شاهد و عيِّن نشاطات اليوم لطلابك. ',
  'gru-take-tour.teacher-class.stepThree.title': 'خريطة المساق الدراسي',
  'gru-take-tour.teacher-class.stepThree.description': 'شاهد و عدِّل الوحدات و الدروس والمجموعات و التقييمات المُعيَّنة في هذا المساق.',
  'gru-take-tour.teacher-class.stepFour.title': 'تقريري',
  'gru-take-tour.teacher-class.stepFour.description': 'يمكنك مشاهدة ملخص عن آداء طلابك في المساق وولوج تقاريرهم. ',
  'gru-take-tour.teacher-class.stepClassManagement.title': 'إدارة الصف الدراسي. ',
  'gru-take-tour.teacher-class.stepClassManagement.description': 'عيِّن أو حدّث معلومات الصف والطلاب المسجلين فيه. ',
  'gru-take-tour.teacher-class.stepFive.title': 'انتهيت!',
  'gru-take-tour.teacher-class.stepFive.description': 'ولآن شارك الصف الدراسي مع طلابك.',
  'gru-take-tour.study-player.stepOne.title': 'أهلا بك!',
  'gru-take-tour.study-player.stepOne.description': 'هذا هو مشغل الدراسة الخاص بك، لنلق نظرة على الميزات المتوفرة لك. ',
  'gru-take-tour.study-player.stepTwo.title': 'خريطة المساق الدراسي',
  'gru-take-tour.study-player.stepTwo.description': 'انقر على الأيقونة في أي وقت للعودة إلى خريطة المساق.',
  'gru-take-tour.study-player.stepThree.title': 'اسم المساق الدراسي',
  'gru-take-tour.study-player.stepThree.description': 'يشير إلى المساق الذي تعمل عليه.',
  'gru-take-tour.study-player.stepFour.title': 'اقتراحات',
  'gru-take-tour.study-player.stepFour.description': 'المصادر الإضافية التي من الممكن أن ترغب بالبحث عنها بناءً على ما تدرسه',
  'gru-take-tour.study-player.stepFive.title': 'إنجاز',
  'gru-take-tour.study-player.stepFive.nuTitle': 'كفاءات',
  'gru-take-tour.study-player.stepFive.description': 'تشير إلى قدَر تقدمك في المساق. ',
  ...
  'gru-take-tour.study-player.stepSeven.description': 'أخبر معلمك عن رأيك في هذا المصدر.',
  ...
  'gru-take-tour.study-player.stepNine.description': 'انقر على الأيقونة في أي وقت للعودة إلى المجموعة أو التقييم.',
  'gru-take-tour.library.stepOne.title': 'أهلا بك!',
  'gru-take-tour.library.stepOne.description': 'أهلا بك في مكتبات متصفح التعلم. ',
  'gru-take-tour.library.stepTwo.title': 'المساقات الدراسية المميزة',
  'gru-take-tour.library.stepTwo.description': 'ابحث في المساقات الدراسية التي طورها وطبقعا المعلمون سابقاً في صفوفهم الدراسية.',
  'gru-take-tour.library.stepThree.title': 'مكتبات أخرى',
  'gru-take-tour.library.stepThree.description': 'ابحث في المحتوى الذي طوره شركاه جورو. ',
  'gru-take-tour.library.stepFour.title': 'معاينة',
  'gru-take-tour.library.stepFour.description': 'عاين المساق لمعرفة إذا ما كان مهم بالنسبة لك أم لا.',
  ...
  'gru-take-tour.library.stepSix.description': 'قم بوضع إشارة مرجعية على هذا المساق لمعاينته لاحقاً.',
  'gru-take-tour.profile.stepOne.title': 'أهلا بك!',
  'gru-take-tour.profile.stepOne.description': 'أهلاً بك في ملفك الشخصي، هنا يمكنك الولوج للمحتوى الخاص بك ومعلوماتك الشخصية و المتابعين.',
  'gru-take-tour.profile.stepTwo.title': 'المحتوى الخاص بي',
  'gru-take-tour.profile.stepTwo.description': 'أنشئ محتوى جديد، وشاهد المحتوى الذي قمت بإعادة مزجه.',
  'gru-take-tour.profile.stepThree.title': 'حولي',
  'gru-take-tour.profile.stepThree.description': 'حدِّث معلوماتك الشخصية ومعلومات المدرسة و الصورة الشخصية. ',
  'gru-take-tour.profile.stepFour.title': 'الأهداف',
  'gru-take-tour.profile.stepFour.description': 'ضَع و تعقب الأهداف لمساعدتك في تحقيق أهداف التعلم الخاصة بك. ',
  'gru-take-tour.profile.stepFive.title': 'متابِعون',
  'gru-take-tour.profile.stepFive.description': 'إذا أعجبك محتوى إحدى المساقات الدراسية، يمكنك متابعة الأشخاص الذين قاموا ببنائه. كما يمكنك مشاهدة المتابعين. ',
  'gru-take-tour.profile.stepSix.title': 'شارات',
  'gru-take-tour.profile.stepSix.description': 'شاهد الشارات التي حصلت عليها، ستحصل على شارة في حال إكمال تقييم معياري تم تعيينه من قِبل معلمك.',
  'gru-tour.assessments-settings.stepOne.title': 'التنقل والعلامات',
  'gru-tour.assessments-settings.stepOne.description': 'يحدد هذا الإعداد كيفية انتقال الطلاب خلال تقييم معيّن ويبين ما إذا كانت إجاباتهم صحيحة أم خاطئة. هذا الإعداد لا يُظهر لهم مفتاح الإجابة.',
  'gru-tour.assessments-settings.stepTwo.title': 'مفتاح الإجابة  وعدد المحاولات.',
  'gru-tour.assessments-settings.stepTwo.description': 'يتيح هذا الإعداد إظهار مفتاح الإجابة  ويحدد عدد المحاولات التي يملكها الطلاب في التقييم.',
  'gru-tour.overview.stepOne.title': 'خريطة المساق الدراسي',
  'gru-tour.overview.stepOne.description': 'تتيح خريطة المساق الدراسي للطلاب الوصول إلى جميع التقييمات والمجموعات التي تعيّنها لهم.',
  'gru-tour.overview.stepTwo.title': 'رمز الصف',
  'gru-tour.overview.stepTwo.description': 'لكل صف تقوم بإنشائه رمز خاص. ستعطي هذا الرمز للطلاب عندما يصبح صفك الدراسي جاهز لانضمامهم ووصولهم إلى المحتوى الخاص بك.',
  'gru-tour.overview.stepThree.title': 'مراقبة بيانات الطالب والصف.',
  'gru-tour.overview.stepThree.description': 'تتيح لك هذه الخطوة رؤية بيانات تقييم الصف والطالب عند استكمال الطلاب للتقييمات التي تشكّل جزءاً من المساق الدراسي.',
  'gru-tour.overview.stepFour.title': 'معلومات الصف االدراسي',
  'gru-tour.overview.stepFour.description': 'هنا يمكنك تعديل اسم صفك الدراسي، ونشر الإعلانات لطلابك، ورؤية أسماء الطلاب المسجلين فيه، وحذفه.',
  'gru-tour.overview.stepFive.title': 'تعديل محتوى المساق الدراسي.',
  'gru-tour.overview.stepFive.description': 'عندما تكون في صف دراسي، انقر هنا لتعديل أي محتوى في المساق الدراسي المعيّن لطلابك.',
  'gru-tour.overview.stepSix.title': 'رصد التقدم المحرز في الوقت الحقيقي!',
  'gru-tour.overview.stepSix.description': 'استخدم لوحة تحكم "الوقت الحقيقي" لرصد تقدم الصف المحرز على التقييم في نفس وقت عمله.\nانقر على أيقونة \'التقييم المباشر\' -الموجودة إلى يسار كل تقييم- لبدء تقييم الطلاب في نفس وقت عملهم',
  'gru-tour.quick-start.stepOne.title': 'التنقل بين الصفوف الدراسية',
  'gru-tour.quick-start.stepOne.description': 'هذا هو شكل الصف الدراسي الذي تم إنشاؤه حديثا. للرجوع إلى الصف الدراسي في أي وقت، انقر على \'الصفوف الدراسية\' واستخدم القائمة المنسدلة لتحديد الصفوف الدراسية التي ترغب في دخولها.',
  'gru-tour.quick-start.stepTwo.title': 'البدء؟ أنشئ تقييم!',
  'gru-tour.quick-start.stepTwo.description': 'نقترح عليك إنشاء تقييم كوسيلة للبدء مع جورو وتقييم مستوى فهم الطلاب الحالي في صفك.',
  'gru-tour.real-time.stepOne.title': 'تفاصيل الإجابات',
  'gru-tour.real-time.stepOne.description': 'انقر على كل سؤال للاطلاع على تفاصيل إجابات الطلاب.',
  'gru-tour.real-time.stepTwo.title': 'بيانات الطالب الفردية',
  'gru-tour.real-time.stepTwo.description': 'اختر خانة كلّ طالب للاطلاع على تقارير بيانات الطالب الفردية.',
  'gru-tour.real-time.stepThree.title': 'حدد طريقة عرض',
  'gru-tour.real-time.stepThree.description': 'اختر\'عرض العنوان\' أو \'عرض القائمة\' للاطلاع على خيارات عرض البيانات.',
  'gru-tour.real-time.stepFour.title': 'متوسط العلامات',
  'gru-tour.real-time.stepFour.description': 'اطلع على متوسط ​​معدل الصف المحسوب في الوقت الحقيقي لجميع الإجابات',
  'gru-tour.real-time.stepFive.title': 'عرض البيانات المجهولة',
  'gru-tour.real-time.stepFive.description': 'استخدم هذا الخيار لإظهار عرض مجهول لبيانات الطالب.',
  ...
  'gru-century-skills.legends.national': 'المركز الوطني للبحوث من أجل الحياة والعمل.',
  'gru-century-skills.content.groups.cognitive': 'المهارات والاستراتيجيات المعرفية الرئيسية.',
  'gru-century-skills.content.groups.content': 'محتوى المعرفة الرئيسي',
  'gru-century-skills.content.groups.learning': 'مهارات وتقنيات التعلم الأساسية',
  'gru-rubric-edit.upload-rubric': 'تحميل سلم تقييم',
  'gru-rubric-edit.copy.success-message': 'لقد نسخت سلم التقييم {{title}}. هل تريد تعديله؟ ',
  'gru-rubric-creation.url': 'رابط',
  'gru-rubric-creation.upload-file': 'تحميل الملف',
  'gru-rubric-creation.add-category': 'ضِف فئة جديدة',
  'gru-rubric-creation.gru-preview-url.preview': 'ضِف سلم تقييم أعلاه وعاينه هنا.',
  ...
  'gru-rubric-creation.feedback-guidance-placeholder': 'لخِّص ملاحظاتك على المقال ككل.',
  'gru-rubric-creation.gru-category.category-title': 'عوان الفئة',
  'gru-rubric-creation.gru-category.category-feedback': 'عند معاينة هذه الفئة، انتبه لهذف الكاتب. ',
  'gru-rubric-creation.gru-category.gru-scoring-levels.0': 'مثال: تخطى الاحترافية',
  'gru-rubric-creation.gru-category.gru-scoring-levels.1': 'مثال: محترف',
  'gru-rubric-creation.gru-category.gru-scoring-levels.2': 'مثال: قريب من الاحترافية',
  ...
  'gru-rubric-creation.gru-category.gru-scoring-levels.new-level': 'إضافة مستوى جديد',
  ...
  'gru-rubric-creation.gru-category.gru-scoring-levels.name-error': 'يرجى إدخال عنوان المستوى',
  'gru-rubric-creation.gru-category.gru-scoring-levels.score-error': 'يرجى إدخال قيمة العلامة',
  'gru-rubric-creation.gru-category.gru-scoring-levels.no-levels-error': 'يرجى وضع قيمة لمستوى واحد على الأقل.',
  ...
  'gru-study-header.no-suggestions': 'نحن نعمل على أفضل الاقتراحات لدعم عملية التعليم',
  ...
  'gru-suggest-test.pre-test-lead': 'يفضل الخضوع لاختبار قبل البدء بالدرس لتقييم مدى استيعاب الطالب للمفهوم الذي سيتم طرحه في هذا الدرس. يساعد هذا الاختبار الطالب في التحضير لمحتوى الدرس دون التأثير على علامة الآداء. ',
  'gru-suggest-test.post-test-lead': 'الاختبار التالي هو اختبار بعد الانتهاء من الدرس، ويفضل الخضوع له لتقييم مدى استيعاب الطالب للمفهوم الذي تم طرحه أثناء شرح الدرس، ولن يؤثرهذا الاختبار على علامة الآداء. ',
  'gru-suggest-test.backfill-lead': 'بناءً على إجاباتك في الامتحان المسبق للدرس، يُنصح بمراجعة مواد إضافية قبل البدء بالدرس، فمراجعة إحدى المواد المساندة يساعد الطالب في تعلم مادة جديدة. ',
  'gru-suggest-test.benchmark-lead': 'أنت على استعداد لإظهار مدى استيعابك من خلال الخضوع للتقييم معياري. سيتم منحك شارة في حال إكمال هذا التقييم بنجاح، لن يؤثر هذا التقييم على علامة الآداء. ',
  'gru-suggest-test.resource-lead': 'بناءً على آدائك في هذا المساق، سيعزز المصدر التالي اسيعابك له. ',
  ...
  'gru-performance-chart.teacher-tooltip': 'من طلابك أكمل كل التقييمات في هذا الدرس.',
