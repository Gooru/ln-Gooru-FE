...
window.i18ln = {
  ...
  'common.disappear-after-login':
    'This will disappear after {{loginNumber}} logins',
  ...
  'common.errors.username-length':
    'Username must be between 4 and 254 characters.',
  ...
  'class.quick-start.existing-course-desc':
    'The quickest way to start a classroom',
  ...
  'class.quick-start.remix-desc':
    'Copy and customize a featured course for your students',
  ...
  'content.classes.create.condition-prompt':
    'How will students join your classroom?',
  ...
  'content.modals.delete-bookmark.confirmation':
    'Do you want to unbookmark this {{type}}?',
  ...
  'content.modals.delete-content.delete-warning':
    'All content in this {{type}} will be deleted',
  ...
  'content.modals.remove-student.data-lost':
    'If they re-join the class, all past data will be lost',
  ...
  'user.joined-classes.zero':
    'You\'re currently enrolled in {{count}} classrooms',
  ...
  'user.teaching-classes.zero':
    'You\'re currently teaching {{count}} classrooms',
  ...
  'student-landing.join-classroom':
    'Join your teacher\'s classroom to start learning',
  ...
  'teacher-landing.class.class-management-tab.assessment-min-score':
    'Assessment Minimum Score for Trophies',
  ...
  'goals.create.error-length-reflection':
    'Reflection must have max 2000 characters',
  ...
  'gru-add-to.add-to-existing-classroom-lead':
    'Choose a classroom you want to add to',
  ...
  'gru-assessment-confirmation.title':
    'You are about to start an assessment...',
  ...
  'gru-submit-confirmation.finish-description':
    'Click “Finish Quiz” to submit your responses.',
  ...
  'gru-login-prompt.instructions':
    'You need to sign in to complete that action.',
  ...
  'player.gru-viewer.not-iframe-url.footer_1':
    'Why am I seeing this blank page?',
  ...
  'gru-resource-new.resource-already-exist':
    'This resource already exists in Gooru!',
  ...
  'cards.gru-class-card.archived.download-report':
    'Download your data for this class.',
  'cards.gru-class-card.archived.no-report-available':
    'This class has no assigned course content.',
  ...
  'home.no-classes-found.featured-courses.description':
    'Browse math, science, social studies, and ELA courses.',
  ...
  'home.no-classes-found.teacher-toolkit.description':
    'This toolkit has resources to help you get started.',
  ...
  'taxonomy.gru-taxonomy-selector.competency-subject-and-course':
    'Competencies Framework and Course',
  ...
  'taxonomy.modals.gru-standard-picker.browseCompetencySelectorText':
    'What competencies will be covered?',
  ...
  'gru-take-tour.student-home.stepSeven.description':
    'Access and update your content and user profile.',
  ...
  'gru-take-tour.student-home.stepTen.description':
    'See all the classrooms in which you are enrolled.',
  ...
  'gru-take-tour.student-performance.stepFive.description':
    'Go ahead and analyze your performance!',
  ...
  'gru-take-tour.student-class.stepFour.description':
    'Review your overall class performance.',
  ...
  'gru-take-tour.study-player.stepThree.description':
    'Indicates the course you are working on.',
  ...
  'gru-tour.assessments-settings.stepTwo.title':
    'Answer Key and Number of Attempts',
  ...
  'gru-rubric-creation.gru-preview-url.preview':
    'Add rubric above and preview here',
  ...
  'oa.pending-submissions': 'Submissions Pending',
