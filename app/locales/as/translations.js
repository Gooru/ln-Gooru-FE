...
export default Object.assign(quizzesTranslations, {
  ...
  'errors.tooShort':
    '{{description}} বহু বেছি চুটি (নিম্নতম হৈছে  {{min}}টা আখৰ) ',
  'errors.before': '{{description}} {{before}}ৰ আগত থাকিব লাগিব',
  'errors.after': '{{description}} {{after}}ৰ পাচত থাকিব লাগিব',
  'errors.wrongDateFormat': '{{description}}  {{format}}ৰ ফৰ্মেটত থাকিব লাগিব',
  'errors.wrongLength':
    '{{description}} ভুল দীঘত আছে ( {{is}}টা আখৰ হ\'ব লাগিব)',
  'errors.notANumber': '{{description}} এটা সংখ্যা হ\'ব লাগিব',
  'errors.notAnInteger': '{{description}} এটা পূৰ্ণ সংলহ্যা হ\'ব লাগিব',
  'errors.greaterThan': '{{description}} {{gt}}তকৈ ডাঙৰ হ\'ব লাগিব',
  'errors.greaterThanOrEqualTo':
    '{{description}} {{gte}}তকৈ ডাঙৰ অথবা তাৰ সমান হ\'ব লাগিব',
  'errors.equalTo': '{{description}}  {{is}}ৰ সমান হ\'ব লাগিব',
  'errors.lessThan': '{{description}} {{lt}}তকৈ সৰু হ\'ব লাগিব',
  'errors.lessThanOrEqualTo':
    '{{description}} {{lte}}তকৈ সৰু অথবা তাৰ সমান হ\'ব লাগিব',
  'errors.otherThan': '{{description}} {{value}}তকৈ বেলেগ হ\'ব লাগিব',
  'errors.odd': '{{description}} অযুগ্ম হ\'ব লাগিব',
  'errors.even': '{{description}} যুগ্ম হ\'ব লাগিব',
  'errors.positive': '{{description}} সকৰাত্মক হ\'ব লাগিব',
  'errors.date': '{{description}} এটা বৈধ তাৰিখ হ\'ব লাগিব',
  'errors.email': '{{description}} এটা বৈধ ইমেইল এড্ৰেচ হ\'ব লাগিব',
  ...
  'common.no-suggest-search-results-message':
    'আপোনাৰ বানান চাওক। আমি সকলোৱে ভুল কৰোঁ! অথবা একেই ধৰণৰ শব্দ সন্ধান কৰিবলৈ চেষ্টা কৰক।',
  ...
  'common.advanced-editing': 'অগ্ৰিম সম্পাদন',
  'common.announcements': 'ঘোষণাসমূহ',
  ...
  'common.archive': 'লেখ্যাগাৰ',
  'common.assessment': 'মূল্যাংকন',
  'common.assessment-disabled': 'আপুনি এই মূল্যাংকনটো প্ৰয়াস কৰিব নোৱাৰিব',
  'common.assessment-external': 'মূল্যাংকন-বাহ্যিক',
  'common.assessment-pl.zero': 'মূল্যাংকনবোৰ',
  ...
  'common.assign-to-class': 'শ্ৰেণীকোঠালৈ অনুমোদন জনাওক',
  'common.assign-to-course': 'পাঠ্যক্ৰমলৈ অনুমোদন জনাওক',
  'common.attempt': 'সংখ্যা প্ৰয়াস',
  ...
  'common.back-to-data': 'ডাটালৈ প্ৰত্যাৱৰ্তন',
  'common.back-to-report': 'প্ৰতিবেদনলৈ প্ৰত্যাৱৰ্তন',
  'common.best-practices': 'শ্ৰেষ্ঠ অনুশীলনসমূহ',
  'common.beta': 'বেটা',
  'common.big-ideas': 'ডাঙৰ ধাৰণাসমূহ',
  ...
  'common.cancel': 'প্ৰত্যাহাৰ',
  'common.categories': 'বৰ্গসমূহ',
  'common.category': 'বৰ্গ',
  'common.categoryOptions.k12': 'K-12',
  'common.categoryOptions.k12IN': 'K12IN',
  'common.categoryOptions.higher-ed': 'উচ্চ শিক্ষা',
  'common.categoryOptions.professional-dev': 'বৃত্তিগত উন্নয়ন',
  'common.century-skills': 'একবিংশ শতিকাৰ দক্ষতা',
  'common.choose': 'বাছনি',
  'common.choose-file': 'এটা ফাইল বাছনি কৰক',
  'common.class': 'শ্ৰেণীকোঠা',
  'common.classScores': 'শ্ৰেণীৰ নম্বৰসমূহ',
  ...
  'common.completion': 'সম্পাদন',
  'common.community': 'সম্প্ৰদায়',
  'common.confirm': 'অনুমোদন',
  'common.confirm-copy': 'অনুমোদন আৰু নকল',
  'common.content': 'বিষয়বস্ত',
  'common.content-manager': 'বিষয়বস্ত পৰিচালক',
  'common.contentUnavailable': 'বিষয়বস্ত উপলব্ধ নহয়',
  'common.contentUnavailabletoday':
    'কাৰ্য্যকলাপসমূহ বৰ্তমান নাই। পাঠ্যক্ৰম মেপ নাইবা মাই কন্টেন্টৰ পৰা শ্ৰেণী কাৰ্য্যকলাপসমূহ যোগ কৰক।',
  'common.contentUnavailableyesterday': 'কোনো কাৰ্য্যকলাপ যোগ কৰা নাই।',
  'common.contributed-by': 'ৰ দ্বাৰা অৱদান',
  'common.copy': 'নকল',
  'common.copy-to': 'লৈ নকল কৰা ',
  'common.correct': 'শুদ্ধ',
  'common.correct-answer': 'শুদ্ধ উত্তৰ',
  'common.correct-answers': 'শুদ্ধ উত্তৰ(সমূহ)',
  'common.incorrect-answers': 'অশুদ্ধ উত্তৰ',
  'common.rubric-graded': 'ৰিউব্ৰিক গ্ৰেডেড',
  'common.self-graded': 'স্ব-গ্ৰেডেড',
  'common.rubric-grade': 'ৰিউব্ৰিক গ্ৰেড',
  'common.brief': 'হ্ৰস্ব',
  ...
  'common.showcollections': 'সংগ্ৰহবোৰ দেখুওৱা',
  'common.showlessons': 'পাঠবোৰ দেখুওৱা',
  'common.collapse': 'খহি পৰ',
  'common.expand': 'বহল',
  'common.edit-assessment': 'মূল্য়ায়নৰ সম্পাদনা',
  'common.edit-collection': 'সংগ্ৰহৰ সম্পাদনা',
  'common.edit-course': 'পাঠ্য়ক্ৰমৰ  সম্পাদনা',
  'common.edit-question': 'প্ৰশ্নৰ সম্পাদনা',
  'common.edit-resource': 'সম্পদৰ সম্পাদনা',
  'common.edit-rubric': 'ৰিউব্ৰিকৰ সম্পাদনা',
  'common.email_support': 'support@gooru.org',
  'common.emotions.emotion-1': 'মোক সহায়ৰ প্ৰয়োজন',
  'common.emotions.emotion-2': 'মই বুজা নাই',
  'common.emotions.emotion-3': 'মিহ...',
  'common.emotions.emotion-4': 'মই বুজিছো',
  'common.emotions.emotion-5': 'মই বুজাব পাৰো',
  'common.enter-url': 'URL অন্তৰ্ভূক্ত কৰক',
  'common.enrolled-students': 'পঞ্জীভূত শিক্ষাৰ্থীসকল',
  'common.errors.join-class-code':
    'অনুগ্ৰহ কৰি শ্ৰেণীকোঠাৰ ক\'ড অন্তৰ্ভূক্ত কৰক',
  'common.errors.answer-has-no-image': 'অনুগ্ৰহ কৰি এখন উত্তৰচিত্ৰ আপল\'দ কৰক',
  'common.errors.add-username':
    'অনুগ্ৰহ কৰি এটা ব্য়ৱহাৰকাৰীৰ নাম অন্তৰ্ভূক্ত কৰক',
  'common.errors.add-course-title':
    'অনুগ্ৰহ কৰি পাঠ্য়ক্ৰমৰ শিৰোনাম অন্তৰ্ভূক্ত কৰক',
  ...
  'common.errors.can-not-join-class':
    'ওপচ্ ! শ্ৰেণীকোঠাত যোগদান কৰিব পৰা নাই। অনুগ্ৰহ কৰি কিছু সময় পাছত পুনৰ চেষ্টা কৰক ।',
  'common.errors.assessment-not-added-to':
    'ওপচ্ ! পাঠৰ লগত এতিয়া মূল্য়ায়ন যোগ দিব পৰা নাই। অনুগ্ৰহ কৰি কিছু সময় পাছত পুনৰ চেষ্টা কৰক ।',
  'common.errors.assessment-not-copied':
    'ওপচ্ ! এতিয়া মূল্য়ায়ন নকল কৰিব পৰা নাই । অনুগ্ৰহ কৰি কিছু সময়ৰ পাছত পুনৰ চেষ্টা কৰক ।',
  'common.errors.assessment-not-created':
    'ওপচ্ ! এতিয়া মূল্য়ায়ন সৃষ্টি কৰিব পৰা নাই। অনুগ্ৰহ কৰি কিছু সময়ৰ পাছত পুনৰ চেষ্টা কৰক ।',
  'common.errors.assessment-not-updated':
    'ওপচ্ ! এতিয়া মূল্য়ায়ন উন্নীত কৰিব পৰা নাই। অনুগ্ৰহ কৰি কিছু সময়ৰ পাছত পুনৰ চেষ্টা কৰক ।',
  'common.errors.category-title-presence':
    'অনুগ্ৰহ কৰি বৰ্গৰ শিৰোনাম অন্তৰ্ভূক্ত কৰক ।',
  'common.errors.class-min-score':
    'নূন্য়তম নম্বৰ 1ৰ পৰা 100ৰ ভিতৰত থাকিব লাগিব',
  'common.errors.class-not-created':
    'ওপচ্ ! এতিয়া শ্ৰেণীকোঠা সৃষ্টি কৰিব পৰা নাই। অনুগ্ৰহ কৰি কিছু সময়ৰ পাছত পুনৰ চেষ্টা কৰক ।',
  'common.errors.class-title-presence':
    'অনুগ্ৰহ কৰি আপোনাৰ শ্ৰেণীকোঠাৰ নাম এটা দিয়ক ।',
  'common.errors.collection-not-added-to':
    'ওপচ্ ! বৰ্তমান পাঠৰ সৈতে নতুন ক্ৰম যোগ কৰিব পৰা নাই । অনুগ্ৰহ কৰি কিছু সময় পাছত পুনৰ চেষ্টা কৰক ।',
  'common.errors.collection-not-copied':
    'ওপচ্ ! এতিয়া সংগ্ৰহ নকল কৰিব পৰা নাই। অনুগ্ৰহ কৰি কিছু সময়ৰ পাছত পুনৰ চেষ্টা কৰক ।',
  'common.errors.collection-not-created':
    'ওপচ্ ! এতিয়া সংগ্ৰহ সৃষ্টি কৰিব পৰা নাই। অনুগ্ৰহ কৰি কিছু সময়ৰ পাছত পুনৰ চেষ্টা কৰক ।',
  'common.errors.collection-not-updated':
    'ওপচ্ ! এতিয়া সংগ্ৰহ উন্নীত কৰিব পৰা নাই। অনুগ্ৰহ কৰি কিছু সময়ৰ পাছত পুনৰ চেষ্টা কৰক ।',
  'common.errors.collection-title-presence':
    'অনুগ্ৰহ কৰি সংগ্ৰহৰ শিৰোনাম অন্তৰ্ভূক্ত কৰক ।',
  'common.errors.correct-answer-presence':
    'অনুগ্ৰহ কৰি শুদ্ধ উত্তৰত সংকেত দিয়ক ।',
  'common.errors.course-not-copied':
    'ওপচ্ ! এতিয়া পাঠ্য়ক্ৰমৰ নকল কৰিব পৰা নাই। অনুগ্ৰহ কৰি কিছু সময়ৰ পাছত পুনৰ চেষ্টা কৰক ।',
  'common.errors.course-not-created':
    'ওপচ্ ! এতিয়া পাঠ্য়ক্ৰমৰ সৃষ্টি কৰিব পৰা নাই। অনুগ্ৰহ কৰি কিছু সময়ৰ পাছত পুনৰ চেষ্টা কৰক ।',
  'common.errors.course-not-updated':
    'ওপচ্ ! এতিয়া পাঠ্য়ক্ৰমৰ উন্নীত কৰিব পৰা নাই। অনুগ্ৰহ কৰি কিছু সময়ৰ পাছত পুনৰ চেষ্টা কৰক।',
  ...
  'common.errors.lesson-not-copied':
    'ওপচ্ ! এতিয়া পাঠ নকল কৰিব পৰা নাই। অনুগ্ৰহ কৰি কিছু সময়ৰ পাছত পুনৰ চেষ্টা কৰক ।',
  'common.errors.lesson-not-created':
    'ওপচ্ ! এতিয়া পাঠ সৃষ্টি কৰিব পৰা নাই। অনুগ্ৰহ কৰি কিছু সময়ৰ পাছত পুনৰ চেষ্টা কৰক ।',
  'common.errors.lesson-not-loaded':
    'ওপচ্ ! এতিয়া পাঠ ল\'ড কৰিব পৰা নাই। অনুগ্ৰহ কৰি কিছু সময় পাছত পুনৰ চেষ্টা কৰক ।',
  ...
  'common.errors.password-required': 'অনুগ্ৰহ কৰি পাছৱৰ্ড অন্তৰ্ভূক্ত কৰক ।',
  'common.errors.password-special-characters':
    'অনুগ্ৰহ কৰি বিশেষ আখৰবোৰ ব্য়ৱহাৰ নকৰিব ।',
  ...
  'common.errors.question-not-created':
    'ওপচ্ ! এতিয়া প্ৰশ্ন সৃষ্টি কৰিব পৰা নাই। অনুগ্ৰহ কৰি কিছু সময়ৰ পাছত পুনৰ চেষ্টা কৰক।',
  ...
  'common.errors.resource-missing-type':
    'অনুগ্ৰহ কৰি সমলৰ এটা ভাগ নিৰ্বাচন কৰক ।',
  ...
  'common.errors.resource-not-added-to-collection':
    'ওপচ্ ! এতিয়া সমল সংগ্ৰহত যোগ কৰিব পৰা নাই। অনুগ্ৰহ কৰি কিছু সময়ৰ পাছত পুনৰ চেষ্টা কৰক ।',
  'common.errors.resource-not-copied':
    'ওপচ্ ! এতিয়া সমল নকল কৰিব পৰা নাই। অনুগ্ৰহ কৰি কিছু সময়ৰ পাছত পুনৰ চেষ্টা কৰক ।',
  'common.errors.resource-not-created':
    'ওপচ্ ! এতিয়া সমল সৃষ্টি কৰিব পৰা নাই। অনুগ্ৰহ কৰি কিছু সময়ৰ পাছত পুনৰ চেষ্টা কৰক ।',
  'common.errors.resource-not-updated':
    'ওপচ্ ! এতিয়া সমল উন্নীত কৰিব পৰা নাই। অনুগ্ৰহ কৰি কিছু সময়ৰ পাছত পুনৰ চেষ্টা কৰক।',
  'common.errors.resource-same-host-url': 'সমলবোৰ গুৰু URL সমূহৰ হব নোৱাৰিব ।',
  'common.errors.resource-title-length': 'শিৰোনাম 5০ আখৰতকৈ অধিক হব নোৱাৰিব।',
  'common.errors.rubric-title-presence':
    'অনুগ্ৰহ কৰি ৰিউব্ৰিক শিৰোনাম অন্তৰ্ভূক্ত কৰক ।',
  'common.errors.rubric-url-presence':
    'অনুগ্ৰহ কৰি ৰিউব্ৰিক URL অন্তৰ্ভূক্ত কৰক ।',
  ...
  'common.errors.sign-up-error':
    'ওপচ্ ! এতিয়া চাইন আপ কৰিব পৰা নাই । অনুগ্ৰহ কৰি কিছু সময়ৰ পাছত পুনৰ চেষ্টা কৰক ।',
  'common.errors.sign-up-first-name':
    'অনুগ্ৰহ কৰি আপোনাৰ প্ৰথম নামতো অন্তৰ্ভূক্ত কৰক ।',
  'common.errors.sign-up-last-name':
    'অনুগ্ৰহ কৰি আপোনাৰ  শেষৰ নামতো অন্তৰ্ভূক্ত কৰক ।',
  'common.errors.sign-up-name-length':
    'শেষৰ নামটোত কমেও দুটা আখৰ থাকিব লাগিব ।',
  ...
  'common.errors.unit-not-copied':
    'ওপচ! এতিয়া ইউনিত নকল কৰিব পৰা নাই। অনুগ্ৰহ কৰি কিছু সময় পাছত পুনৰ চেষ্টা কৰক ।',
  'common.errors.unit-not-created':
    'ওপচ! এতিয়া  ইউনিত বনাব পৰা নাই। অনুগ্ৰহ কৰি কিছু সময়ৰ পাছত পুনৰ চেষ্টা কৰক ।',
  'common.errors.unit-not-loaded':
    'ওপচ! এতিয়া ইউনিত ল\'ড কৰিব পৰা নাই। অনুগ্ৰহ কৰি কিছু সময়ৰ পাছত পুনৰ চেষ্টা কৰক ।',
  'common.errors.unit-title-required':
    'অনুগ্ৰহ কৰি ইউনিতৰ শিৰোনাম অন্তৰ্ভুক্ত কৰক ।',
  'common.errors.user-email-presence':
    'অনুগ্ৰহ কৰি এটা বৈধ ইমেইল অন্তৰ্ভুক্ত কৰক ।',
  'common.errors.username-length': 'ইউজাৰনেমটো 4 ৰ পৰা 254 ৰ ভিতৰত হব লাগিব ।',
  'common.errors.forgot-password-gmail':
    'অনুগ্ৰহ কৰি গুগল চাইন ইন ব্যবহাৰ কৰক । আমি আপোনাৰ পাচৱৰ্দ পুনৰ সংহতি কৰিব পৰা নাই ।',
  'common.errors.no-studymaterial':
    'এই শ্ৰেণীটোক দিয়া পাঠ্য়ক্ৰমৰ কোনো পঢ়া সামগ্ৰী নাই । ইয়াৰ ব্যৱস্থা গ্ৰহণৰ বাবে শিক্ষকৰ সৈতে যোগাযোগ কৰক',
  ...
  'common.finish': 'শেষ কৰক ',
  'common.first-name': 'প্ৰথম নাম ',
  'common.follow': 'অনুসৰণ কৰক',
  'common.followers': 'অনুগামী',
  'common.following': 'অনুসৰণ  কৰি থকা ',
  'common.forgotPassword': 'পাছৱৰ্দ পাহৰা হ\'ল ',
  'common.from': 'পৰা ',
  'common.from-my-assessments': 'মোৰ মূল্যায়ন সমূহৰ পৰা ',
  ...
  'common.in-progress': 'অগ্ৰগতিত',
  'common.instructor': 'নিৰ্দেশক',
  'common.last-name': 'শেষ নাম ',
  'common.last-updated': 'শেষবাৰ উন্নীতকৰন হৈছিল',
  'common.latest-attempt': 'শেহতীয়া প্ৰয়াস',
  'common.launch-anonymous': 'লন্স এননিমাচ ',
  'common.launch-on-air': 'পোনপটীয়াকৈ যাওক ',
  'common.learning-objectives': 'লক্ষ্যসমূহৰ অধ্যয়ন ',
  'common.learning-target': 'সূক্ষ্ম-মানবিশিষ্ট',
  'common.learning-target-mobile': 'মানত সূক্ষ্ম-মানবিশিষ্ট',
  'common.lesson': 'পাঠ',
  'common.lessonInitial': 'L',
  'common.lesson-title': 'পাঠৰ শিৰোনাম ',
  'common.lessonObj.zero': 'পাঠসমূহ ',
  'common.lessonObj.one': 'পাঠ',
  'common.lessonObj.other': 'পাঠসমূহ ',
  'common.libraries': 'পুথিভঁৰালসমূহ ',
  ...
  'common.narration': 'বৃত্তান্ত ',
  'common.new-assessment': 'নতুন মূল্যায়ন ',
  ...
  'common.not-provided': 'যোগান ধৰা হোৱা নাই',
  'common.not-specified': 'বিনিৰ্দিষ্ট কৰা নাই',
  'common.not_started': 'আৰম্ভ হোৱা নাই',
  'common.nothing-to-display': 'প্ৰদৰ্শন কৰিবলৈ একো নাই',
  'common.number': 'নহয়।',
  'common.numberStudents.zero': '{{count}} ছাত্ৰ-ছাত্ৰীসকল',
  'common.numberStudents.one': '{{count}} ছাত্ৰ-ছাত্ৰী',
  'common.numberStudents.other': '{{count}} ছাত্ৰ-ছাত্ৰীসকল',
  'common.of': 'পৰা',
  'common.off': 'OFF',
  'common.on': 'ON',
  'common.other': 'অন্য',
  ...
  'common.post-message': 'বাৰ্তা পঠিয়াওক',
  'common.preview': 'পূৰ্বদৰ্শন',
  'common.profile': 'সংক্ষিপ্ত জীৱনপঞ্জী',
  'common.profile-publishing': 'সংক্ষিপ্ত জীৱনপঞ্জী দৃশ্যমানতা',
  'common.publish-to': 'মোৰ সংক্ষিপ্ত জীৱনপঞ্জীৰ ভঁৰালৰ পৰা এইটো দৃশ্যমান কৰক',
  'common.published-by': 'ৰ দ্বাৰা প্ৰকাশ কৰা হৈছে।',
  ...
  'common.question-pl.zero': 'প্ৰশ্নসমূহ',
  'common.question-pl.one': 'প্ৰশ্ন',
  'common.question-pl.other': 'প্ৰশ্নসমূহ',
  'common.question-title': 'প্ৰশ্নৰ শিৰোনাম',
  'common.question-type.SA': 'একক উত্তৰ',
  'common.question-type.MC': 'বহু-বৈকল্পিক',
  'common.question-type.FIB': 'খালী ঠাই পূৰণ কৰক',
  'common.question-type.T/F': 'শুদ্ধ নাইবা অশুদ্ধ',
  'common.question-type.T_F': 'শুদ্ধ নাইবা অশুদ্ধ',
  'common.question-type.MA': 'বহুধা উত্তৰ',
  ...
  'common.remix-question': 'প্ৰশ্ন ৰিমিক্স কৰক',
  'common.remix-question-lead': 'আপুনি এটা প্ৰশ্ন ৰিমিক্স কৰিবলৈ লৈছে।',
  'common.remix-question-success':
    'আপুনি এটা প্ৰশ্ন {{questionTitle}} ৰিমিক্স কৰিলে। আপুনি সেই প্ৰশ্নটো সম্পাদনা কৰিব বিচাৰে নে?',
  'common.remix-resource': 'সম্পদ ৰিমিক্স কৰক',
  'common.remix-resource-lead': 'আপুনি এটা সম্পদ ৰিমিক্স কৰিবলৈ লৈছে',
  'common.remix-resource-success':
    'আপুনি এটা সম্পদ {{resourceTitle} ৰিমিক্স কৰিলে। আপুনি সেই সম্পদটো সম্পাদনা কৰিব বিচাৰে নে?',
  'common.remix-unit': 'একক ৰিমিক্স কৰক',
  'common.remix-unit-lead': 'আপুনি এটা একক ৰিমিক্স কৰিলে',
  ...
  'common.resource-pl.other': 'সম্পদবোৰ',
  'common.resource-title': 'সম্পদৰ শীৰ্ষক',
  'common.resource-url': 'সম্পদৰ URL',
  'common.role': 'ভূমিকা',
  'common.rubric': 'ৰুব্ৰিক',
  'common.rubric-creation': 'ৰুব্ৰিক সৃষ্টি',
  'common.rubrics': 'ৰুব্ৰিক',
  'common.rubric-title': 'ৰুব্ৰিক শীৰ্ষক',
  'common.save': 'চেভ কৰক',
  'common.de-select': 'ডি চিলেক্ট কৰক',
  'common.select-all': 'সকলো চিলেক্ট কৰক',
  'common.none': 'এটাও নহয়',
  ...
  'common.save-finish': 'চেভ কৰক আৰি শেষ কৰক',
  'common.school': 'বিদ্যালয়',
  'common.school-info': 'বিদ্যালয়ৰ তথ্য',
  'common.score': 'শ্ৰৌত',
  'common.select': 'চিলেক্ট কৰক',
  'common.select-a-framework':
    'অনুগ্ৰহ কৰি ওপৰৰ কাৰ্যক্ৰম তথ্য ভাগত প্ৰথমে এটা মানকৰ ফ্ৰেমৱৰ্ক নিৰ্বাচন কৰক।',
  'common.sentence': 'বাক্য',
  'common.settings': 'চেটিং',
  'common.search': 'সন্ধান কৰক',
  'common.search-placeholder': 'সন্ধান কৰক',
  'common.search-placeholder-text': 'সন্ধান কৰক...',
  'common.search-error-message': 'সন্ধানৰ শব্দ নিম্নতম 3 আখৰৰ হ\'ব লাগিব।',
  'common.search-400-error-message': 'অনুগ্ৰহ কৰি এটা বৈধ সন্ধানৰ শব্দ দিয়ক',
  'common.search-competency': 'সন্ধানৰ দক্ষতা',
  'common.search-standards': 'সন্ধানৰ মানক',
  'common.select-question-type': 'প্ৰশ্নৰ প্ৰকাৰ নিৰ্বাচন কৰক',
  'common.select-resource-type': 'সম্পদৰ প্ৰকাৰ নিৰ্বাচন কৰক',
  'common.send-request': 'অনুৰোধ পঠাওক',
  'common.share': 'শ্বেয়াৰ কৰক',
  'common.show-correct-answer': 'শুদ্ধ উত্তৰ দেখুৱাওক',
  'common.show-more-results': 'আৰু ফলাফল দেখুৱাওক',
  'common.show-results': 'ফলাফল দেখুৱাওক',
  'common.signUp': 'চাইন আপ',
  'common.sortAlphabetical': 'বৰ্ণানুক্ৰমে শ্ৰেণীবিভাজন কৰক',
  'common.sortAverage': 'মাধ্যৰ ওপৰত ভিত্তি কৰি শ্ৰেণীবিভাজন কৰক',
  'common.sort-most-recently': 'শেহতীয়াকৈ আপডেট কৰাৰ ভিত্তিত শ্ৰেণীবিভাজন কৰক',
  'common.state': 'ৰাজ্য অথবা ক্ষেত্ৰ',
  'common.state-territory': 'ৰাজ্য/ক্ষেত্ৰ',
  'common.standard': 'সাধাৰণ মানক',
  'common.standards': 'সাধাৰণ মানক',
  'common.study': 'অধ্যয়ন',
  'common.study-now': 'এতিয়া অধ্যয়ন কৰক',
  'common.student': 'ছাত্ৰ',
  ...
  'common.submitAll': 'সকলো জমা কৰক',
  'common.submit-finish': 'জমা কৰক আৰু সম্পূৰ্ণ কৰক',
  'common.swap': 'ৰি-অৰ্ডাৰ',
  'common.suggestion': 'পৰামৰ্শ',
  'common.suggestions': 'পৰামৰ্শ',
  'common.suggested-resources': 'পৰামৰ্শত দিয়া সম্পদসমূহ',
  'common.support': 'সহায়',
  'common.start-tour': 'এটা ভ্ৰমণ লওক',
  'common.take-me-there': 'মোক তালৈ লৈ যাওক',
  'common.teach': 'পঢ়াওক',
  'common.teacher': 'শিক্ষক',
  'common.timeSpent': 'কটোৱা সময়',
  'common.toggle-dropdown': 'ড্ৰপডাউন টগল কৰক',
  'common.tools': 'সঁজুলি',
  'common.true': 'শুদ্ধ',
  'common.type': 'প্ৰকাৰ',
  'common.title': 'শীৰ্ষক',
  ...
  'common.unitObj.zero': 'একক',
  'common.unitObj.one': 'একক',
  'common.unitObj.other': 'একক',
  'common.untitled-course': 'কাৰ্যক্ৰম 1',
  'common.untitled-lesson': 'শীৰ্ষক নোহোৱা পাঠ',
  'common.untitled-unit': 'শীৰ্ষক নোহোৱা একক',
  'common.update-thumbnail': 'থাম্বনেইল আপডেট কৰক',
  'common.update-photo': 'ফটো আপডেট কৰক',
  'common.upload': 'আপল\'ড কৰক',
  ...
  'index.browseContent.description_3': 'নাইবা',
  'index.browseContent.button': 'ব্ৰাউজ কন্টেন্ট',
  'index.browseContent.footer.description_1': 'ইতিমধ্যে খতিয়ান আছেনে?',
  'index.browseContent.footer.description_2': 'ইয়াত।',
  'index.browseContent.footer.login': 'লগইন',
  'index.browseContent.grades_missing_message':
    'অনুগ্ৰহ কৰি গ্ৰেড আৰু বিষয় পচন্দ কৰক।',
  'index.browseContent.subjects_missing_message':
    'অনুগ্ৰহ কৰি  বিষয় পচন্দ কৰক।',
  'index.gettingStarted.title': 'গুৰুৰ সৈতে আৰম্ভণি হৈছে',
  'index.gettingStarted.toolkit.title': 'টুলকিটৰ সৈতে আৰম্ভণি হৈছে',
  'index.gettingStarted.toolkit.description':
    'গুৰুলৈ স্বাগতম! এই সমলসমূহ শিকিবলৈ আপুনি কেনেদৰে গৌৰোৰ সৈতে কৰিব পাৰে তাক পৰীক্ষা কৰক আৰু সোনকালে আৰম্ভ কৰক।',
  'index.gettingStarted.classroom.title': 'শ্ৰেণীকোঠাটোৰ পৰা সাধুসমূহ',
  'index.gettingStarted.classroom.description':
    'শিক্ষকে কোৱা  সাধুৰ উদাহৰণৰ পৰা শিকা হয়  যি গুৰুৱে তেওঁলোকৰ শ্ৰেণীকোঠাৰ পাৰ্থক্য গঢ়ি তুলে।',
  'index.gettingStarted.events.title': 'আমাৰ ঘটনাসমূহ পৰীক্ষা কৰক!',
  'index.gettingStarted.events.description':
    'গুৰুৰ সৈতে আৰম্ভণি কৰাত সহায় কৰিবলৈ আপোনাক আমি বিনামূলিয়াকৈ ৱেবিনাৰ আৰু প্ৰশিক্ষণ দিয়া হ\'ব।',
  'index.empowerStudents.title':
    'ছাত্ৰ-ছাত্ৰী সকলক নিজৰ পথ শিকিবলৈ  কৰ্তৃত্বশীল গঢ়ি তুলক',
  'index.empowerStudents.find': 'বিচাৰি পোৱা',
  'index.empowerStudents.remix': 'ৰিমিক্স',
  'index.empowerStudents.share': 'শ্বেয়াৰ কৰক',
  'index.empowerStudents.monitor': 'মনিটৰ',
  'index.findDescription':
    'শিক্ষক সকলৰ দ্বাৰা তৈয়াৰী হাজাৰ K-12 সংগ্ৰহ ব্ৰাউজ কৰক, নাইবা 16M সম্পদ বিচাৰক',
  'index.remixDescription':
    'ৰিমিক্স চয়ন আৰু ছাত্ৰ-ছাত্ৰীসকলৰ প্ৰয়োজন সমূহ পূৰ কৰিবলৈ সামগ্ৰীসমূহ উপযুক্ত কৰিব লাগে।',
  ...
  'class.info.class-info': 'শ্ৰেণীকোঠাৰ তথ্য',
  'class.info.teachers': 'শিক্ষকসকল',
  'class.info.students': 'ছাত্ৰ-ছাত্ৰী',
  'class.info.subject': 'বিষয়',
  'class.info.grade': 'গ্ৰেড',
  'class.info.description': 'বিৱৰণ',
  'class.info.edit-info': 'তথ্য সম্পাদন',
  'class.info.share-class': 'শ্ৰেণীকোঠাৰ ভাগ',
  'class.info.invite-co-teachers': 'সহ-শিক্ষকক নিমন্ত্ৰণ কৰক',
  ...
  'class.edit.class-greetings': 'শ্ৰেণীকোঠাৰ ঘোষণা',
  'class.edit.class-greetings-placeholder':
    'আপোনাৰ ছাত্ৰ-ছাত্ৰীসকলক সম্ভাষণ জনাওক, অণুপ্ৰাণিত কৰক, নাইবা এটা ষোষণা দিয়ক, ইত্যাদি।',
  'class.edit.class-minscore': 'ট্ৰফিৰ কাৰণে নূণ্যতম মূল্যাংকণৰ নম্বৰ(1-100%) ',
  'class.edit.course-map': 'ক\'ৰ্চ মেপ',
  'class.edit.edit-class': 'শ্ৰেণীকোঠাৰ পটভূমি সম্পাদন',
  'class.overview.title': 'ক\'ৰ্চ মেপ',
  'class.overview.locate': 'মোক বিচাৰি উলিয়াওক',
  'class.overview.edit-content': 'বিষয়বস্তৰ সম্পাদন',
  'class.overview.add-to-daily-class-activities': 'শ্ৰেণী কাৰ্য্যকলাপত যোগ কৰক',
  'class.overview.assigned-course': 'আপোনালৈ বন্টন কৰা ক\'ৰ্চ',
  'class.overview.pre-study-title': 'আপোনাৰ পাঠ্যক্ৰমৰ বাবে পূৰ্ব-অধ্যয়ন কৰক',
  ...
  'class.overview.course-map.route0-bannerdesc':
    'আপোনাৰ যোগ্যতাৰ প্ৰফাইল অনুসৰি, কিছুমান যোগ্যতা আছে যি আপুনি মাষ্টৰ কৰাৰ প্ৰয়োজন আছে যাতে আপুনি এই ক\'ৰ্চত ভাল ফলাফল লাভ কৰিব পাৰে। আমাৰ ওচৰত এনে ৰুট আছে যি আপোনাক এই দক্ষ্যতা সমূহ দখল কৰিবলৈ সমিধান দিয়ে। বিতংভাৱে চাবলৈ বা জানিবলৈ ইয়াত ক্লিক কৰক। ',
  'class.analytics.performance.title': 'কাৰ্য্য় সম্পাদন চাওক',
  'class.analytics.performance.better-experience-message':
    'এক উচ্চ মানবিশিষ্ট গুৰু অভিজ্ঞতাৰ বাবে, টেবলেট নাইবা ডেক্সটপত ফুল ক্লাছৰুম এনালিটিক্স চাঁওক।',
  ...
  'class.analytics.performance.actions.assessment': 'মূল্যাংকন চাওঁক',
  'class.analytics.performance.actions.collection': 'কালেকচন চাওঁক',
  'class.analytics.performance.actions.both': 'দুয়োটাই চাওঁক',
  'class.analytics.performance.teacher.metricsTable.average': 'মজলীয়া',
  'class.analytics.performance.teacher.metricsTable.class-average':
    'শ্ৰেণীৰ মজলীয়া',
  'class.analytics.performance.grade-items': 'গ্ৰেডৰ বাবে আইটেম',
  'class.analytics.performance.no-grade-items':
    'তোমালোক সকলোকে ধৰা পৰাৰ দৰে দেখাইছে',
  'class.analytics.performance.gru-grade-items.students.zero':
    '{{count}} ছাত্ৰ-ছাত্ৰীবোৰ',
  ...
  'class.analytics.performance.gru-grade-items.students.not-started':
    'আৰম্ভণি হোৱা নাই',
  'class.analytics.mastery.title': 'পাৰদৰ্শিতা চাওঁক',
  'class.quick-start.title': 'এই শ্ৰেণীকোঠাটোলৈ বিষয়বস্তটো বন্টন কৰক।',
  'class.quick-start.new-course': 'এটা নতুন ক\'ৰ্চৰ খৰতকীয়াকৈ আৰম্ভণি কৰক',
  'class.quick-start.new-course-desc':
    'এটা নতুন ক\'ৰ্চ, এক কালেকচন নাইবা এক মূল্যাংকনৰ দ্বাৰা আৰম্ভ কৰক',
  'class.quick-start.course': 'নতুন ক\'ৰ্চ',
  'class.quick-start.new-collection': 'নতুন সংগ্ৰহ ',
  'class.quick-start.new-assessment': 'নতুন মূল্যায়ন ',
  'class.quick-start.remix-a-sample': 'এক নমুনা ৰিমিক্স কৰক',
  'class.quick-start.add-existing-course':
    'আপোনাৰ ভাণ্ডাৰৰ পৰা এটা ক\'ৰ্চ যোগ কৰক',
  'class.quick-start.existing-course-desc':
    'এটা শ্ৰেণীকোঠা আৰম্ভণি কৰাৰ অতি ক্ষীপ্ৰ উপায়',
  'class.quick-start.choose-course': 'ক\'ৰ্চ নিৰ্বাচন কৰক',
  'class.quick-start.remix-from-course': 'এটা বিশেষ ধৰণৰ ক\'ৰ্চৰ ৰিমিক্স',
  'class.quick-start.featured-course': 'এটা বিশেষ ধৰণৰ ক\'ৰ্চ চাওঁক',
  'class.quick-start.remix-desc':
    'আপোনাৰ ছাত্ৰ-ছাত্ৰীৰ বাবে এটা বিশেষ ধৰণৰ ক\'ৰ্চ কপি আৰু উপযুক্ত কৰক',
  'class.quick-start.browse-content':
    'নাইবা আমাৰ বিষয়বস্তৰ সুবিন্যস্ত তালিকাত চকু ফুৰাওক',
  'classes.classesJoined': 'মই শ্ৰেণীকোঠাত যোগদান কৰিলো',
  'classes.classesTaught': 'শ্ৰেণীকোঠাত মই পঢ়াও',
  ...
  'content.classes.create.condition-prompt-code':
    'শ্ৰেণীকোঠাৰ ক\'ডৰ সৈতে কোনোবা',
  'content.classes.create.condition-prompt-invite': 'কেৱল আহ্বান',
  ...
  'content.classes.join.already-member':
    'ইতিমধ্যে আপুনি এই শ্ৰেণীকোঠাৰ এজন সদস্য।',
  'content.classes.join.join-class': 'শ্ৰেণীকোঠাত যোগদান কৰক',
  ...
  'content.questions.edit.builder.add-answer-choice':
    '+ উত্তৰৰ নিৰ্বাচন যোগ কৰক',
  'content.questions.edit.builder.add-hint': 'পৰামৰ্শ সমূহ যোগ কৰক',
  'content.questions.edit.builder.add-explanation': 'বাখ্যা যোগ কৰক',
  'content.questions.edit.builder.answer': 'উত্তৰ',
  'content.questions.edit.builder.answer-instructions.FIB':
    'উত্তৰৰ বাবে 5 টালৈকে পৰামৰ্শ যোগ কৰক আৰু এটা বাখ্যা',
  'content.questions.edit.builder.answer-instructions.HS_IMG':
    'আপুনি ১০ টা লৈকে উত্তৰ চিত্ৰ যোগ কৰিব পাৰিব আৰুএটা বা অধিক  শুদ্ধ উত্তৰ নিৰ্বাচন কৰিব পাৰিব ।',
  ...
  'content.questions.edit.builder.answer-instructions.MA':
    'আপুনি দহটা উত্তৰ, এখন ছবি, এটা বাখ্যা আৰু পাঁচটালৈকে পৰামৰ্শ যোগ কৰিব পাৰে।',
  'content.questions.edit.builder.answer-instructions.MC':
    'আপুনি দহটা উত্তৰ বিকল্প যোগ কৰিব পাৰিব আৰু এটা শুদ্ধ উত্তৰ সূচাব পাৰিব। সৰ্ব্বোচ সীমা:200',
  'content.questions.edit.builder.answer-instructions.OE':
    'শুদ্ধ প্ৰতিক্ৰিয়া লিখক:5000',
  'content.questions.edit.builder.answer-instructions.T/F':
    'শুদ্ধ উত্তৰটো বাছনি কৰক',
  'content.questions.edit.builder.question-instructions.FIB':
    'যেতিয়া আপুনি প্ৰশ্ন লিখে, নিজৰ খালী ঠাইৰ উত্তৰৰ বাবে বন্ধনীৰ প্ৰয়োগ কৰক। উদাহৰণস্বৰুপে: “The big bad [wolf] blew down the [house]”। আপুনি এখন ছবিও যোগ কৰিব পাৰিব।',
  ...
  'content.questions.edit.builder.question-instructions.T/F':
    'আপোনাৰ প্ৰশ্ন লিখক',
  'content.questions.edit.builder.submission-format.title': 'ছাত্ৰ জমা আৰ্হি',
  'content.questions.edit.builder.submission-format.answer-type.text-box':
    'টেক্স বক্স',
  'content.questions.edit.builder.feedback-grading.title': 'সঁহাৰি আৰু গ্ৰেডিং',
  'content.questions.edit.builder.feedback-grading.from-existing-rubric':
    'অস্তিত্ব থকা ৰিউব্ৰিকৰ পৰা',
  'content.questions.edit.builder.feedback-grading.scoring': 'সাফল্য়াংক',
  'content.questions.edit.builder.feedback-grading.maximum-points':
    'অধিকতম বিন্দুবোৰ',
  'content.questions.edit.builder.feedback-grading.increment': 'সংযোজন',
  'content.questions.edit.builder.feedback-grading.rubric-error':
    'অনুগ্ৰহ কৰি এটা ৰিউব্ৰিক যোগ কৰক',
  ...
  'content.modals.delete-class.student-access':
    'ছাত্ৰসকল শ্ৰেণীকোঠাত সোমোৱাৰ অনুমতি নাপাব',
  'content.modals.delete-class.student-data-deleted':
    'সকলো ছাত্ৰ তথ্য় মচি পেলোৱা হব',
  'content.modals.archive-class.title': 'গুদাম শ্ৰেণীকোঠা',
  'content.modals.archive-class.legend':
    'আপুনি আপোনাৰ শ্ৰেণীকোঠা গুদাম হবলৈ গৈ আছে',
  'content.modals.archive-class.links-not-accessible':
    'সকলো অংশ সংযোগে অনুমতি নাপাব',
  'content.modals.archive-class.students-no-access':
    'ছাত্ৰসকল শ্ৰেণীকোঠাত সোমোৱাৰ অনুমতি নাপাব',
  'content.modals.archive-class.not-add-students':
    'আপুনি অধিক ছাত্ৰ শ্ৰেণীকোঠাত যোগ কৰিব নোৱাৰিব',
  ...
  'content.modals.remove-student.title':
    'ছাত্ৰ আঁতৰাই দিয়ক আৰু তেঁওলোকৰ তথ্য় মচি পেলাওক',
  'content.modals.remove-student.legend':
    'আপুনি এই শ্ৰেণীকোঠাৰ পৰা {{studentName}} আঁতৰাই পেলাবলৈ আৰু তেঁওলোকৰ সকলো তথ্য় মচি পেলাবলৈ গৈ আছে ।',
  'content.modals.remove-student.data-inaccessible':
    'তেঁওলোকৰ সকলো তথ্য় মচি পেলোৱা হব আৰু আপুনি বা তেঁওলোকৰ দ্বাৰা সহজলভ্য় নহব',
  'content.modals.remove-student.classroom-access':
    'তেঁওলোক শ্ৰেণীকোঠা বা তালিকাত সোমোৱাৰ অনুমতি নাপাব',
  ...
  'user.rgo': 'RGO',
  'user.create-class': 'শ্ৰেণীকোঠা সৃস্টি কৰক',
  'user.hello': 'হেল্ল\', {{name}}!',
  'user.independent-learning': 'স্বাধীন শিকন',
  ...
  'student-landing.browse-our': 'ব্ৰাউজ কৰক আমাৰ',
  'student-landing.class-code': 'শ্ৰেণী মান',
  'student-landing.featured-courses': 'আনুষংগিক পাঠ্য়ক্ৰমসমূহ',
  'student-landing.class.assigned-course': 'দায়িত্ব দিয়া পাঠ্য়ক্ৰম',
  'student-landing.class.back-to': 'শ্ৰেণীকোঠাসমূহলৈ ঘূৰি যোৱা',
  'student-landing.class.no-course': 'এই শ্ৰেণীকোঠাত এটা সংগতি পাঠ্য়ক্ৰম নাই ।',
  ...
  'student-landing.class.class-activities': 'শ্ৰেণী কাৰ্যকলাপ',
  'student-landing.class.class-activities-tab.today': 'আজি',
  ...
  'student-landing.resume-current-activity': 'বৰ্তমান কাৰ্যকলাপৰ সাৰমৰ্ম',
  'student-landing.last-activity': 'শেষতীয়া কাৰ্যকলাপ',
  'student-landing.start-studying': 'পঢ়া আৰম্ভ কৰক',
  ...
  'student-landing.my-performance.collections': 'সংগৃহীতসমূহ',
  'student-landing.my-performance.filter': 'সংশোধন',
  'student-landing.my-performance.primary-text':
    'বিশ্লেষণ কৰিব খোজা বস্তুবোৰ বাচনি কৰক আৰু আমি এটা গ্ৰাহকমূখী প্ৰদৰ্শন ৰিপৰ্ট কাৰ্যকৰী কৰিম ।',
  'student-landing.my-performance.subject': 'বিষয়',
  'student-landing.my-performance.title': 'আপোনাৰ প্ৰদৰ্শন বিশ্লেষণ কৰক',
  'student-landing.my-performance.time-period': 'সময় ম্য়াদ',
  'student-landing.my-performance.update-report': 'উন্নীত ৰিপৰ্ট',
  ...
  'teacher-landing.create-classroom':
    'শ্ৰেণীকোঠাৰ সৃষ্টি কৰক, বিষয়বস্তু দিয়ক, শিক্ষাৰ্থীসকলক নিমন্ত্ৰন কৰক',
  'teacher-landing.dca-create-info':
    'নিম্ন আইকনত ক্লিক কৰক আৰু বর্গ কাৰ্য্যকলাপ তৈয়াৰ কৰাত লাইব্রেৰিত সামগ্রী অনুসন্ধান কৰক। আপুনি নিশ্চিতভাৱে ক\'ৰ্চ  মানচিত্রত ক্লিক কৰি আপোনাৰ ক\'ৰ্চৰ মানচিত্রৰ বাবে  বর্গ কার্যকলাপত সামগ্রীসমূহ যোগ কৰিব পাৰিব।',
  'teacher-landing.schedule-for-later': 'পিছলৈ অনুসূচিত কৰক',
  'teacher-landing.teach-this-activity-later': 'DCAত পিছত এই কাৰ্যকলাপ শিকাওক',
  'teacher-landing.schedule-dca-instruction-1':
    'এই কাৰ্যকলাপ শিকাবলৈ পিছৰ তাৰিখ এটা লওক।',
  ...
  'teacher-landing.class.courses': 'ক\'ৰ্চ',
  'teacher-landing.class.back-to': 'শ্ৰেণীকোঠাসমূহলৈ ঘূৰি যোৱা',
  ...
  'teacher-landing.class.class-management-tab.assigned-course':
    'দায়িত্ব দিয়া পাঠ্য়ক্ৰম',
  'teacher-landing.class.class-management-tab.archive': 'লেখ্যাগাৰ',
  'teacher-landing.class.class-management-tab.archive-class': 'আৰ্কাইভ শ্ৰেণী',
  ...
  'teacher-landing.class.class-management-tab.attend-class-with-code':
    'ক\'ডৰ সৈতে শ্ৰেণীলৈ যাওক',
  'teacher-landing.class.class-management-tab.class-information':
    'শ্ৰেণীৰ তথ্য',
  'teacher-landing.class.class-management-tab.class-name': 'শ্ৰেণীকোঠাৰ নাম',
  'teacher-landing.class.class-management-tab.class-code': 'শ্ৰেণী মান',
  'teacher-landing.class.class-management-tab.click-to-copy-class-code':
    'শ্ৰেণীৰ ক\'ড নকল কৰিবলৈ ক্লিক কৰক',
  'teacher-landing.class.class-management-tab.course-information':
    'পাঠ্যক্ৰমৰ তথ্য',
  'teacher-landing.class.class-management-tab.delete': 'মচি পেলাওক',
  'teacher-landing.class.class-management-tab.delete-class': 'শ্ৰেণী বিলোপ কৰক',
  'teacher-landing.class.class-management-tab.download-roster':
    'ৰোস্তাৰ ডাউনলোদ কৰক',
  'teacher-landing.class.class-management-tab.edit': 'সম্পাদন',
  'teacher-landing.class.class-management-tab.email-address': 'ইমেইল এড্ৰেছ',
  'teacher-landing.class.class-management-tab.first-name': 'প্ৰথম নাম ',
  ...
  'teacher-landing.class.class-management-tab.course-null':
    'শ্ৰেণীকোঠাটোত এতিয়ালৈকে কোনো পাঠ্যক্ৰম দিয়া হোৱা নাই।',
  'teacher-landing.class.class-management-tab.course-subject-null':
    'শ্ৰেণীকোঠাত দিয়া পাঠ্যক্ৰমটো কোনো সক্ৰিয় বিষয়ৰ লগত টেগ কৰা হোৱা নাই।',
  'teacher-landing.class.class-management-tab.students-null':
    'শ্ৰেণীকোঠাত যোগদান কৰিবলৈ শ্ৰেণী ক\'ডটো শিক্ষাৰ্থী সকলৰ মাজত ভাগ-বতৰা কৰি দিয়ক।',
  'teacher-landing.class.students-tab.last-name': 'শেষ নাম',
  'teacher-landing.class.students-tab.first-name': 'প্ৰথম নাম',
  'teacher-landing.class.students-tab.performance': 'প্ৰদৰ্শন',
  'teacher-landing.class.students-tab.proficiency': 'প্ৰবীণতা',
  'teacher-landing.class.students-tab.location': 'স্থান',
  'teacher-landing.class.students-tab.currently-studying':
    'বৰ্তমান অধ্যয়ন কৰি আছে',
  'teacher-landing.class.students-tab.student-id': 'শিক্ষাৰ্থী ID',
  'teacher-landing.class.students-tab.remove': 'আঁতৰাওক',
  'teacher-landing.class.students-tab.mastered': 'দৰ্শতা লাভ কৰা',
  'teacher-landing.class.students-tab.in-progress': 'অগ্ৰগতিত',
  'teacher-landing.class.students-tab.not-started': 'আৰম্ভ হোৱা নাই',
  'teacher-landing.class.students-tab.course-coverage':
    'সম্পূৰ্ণ কৰা কাৰ্যক্ৰম',
  'teacher-landing.class.students-tab.class-statistics': 'শ্ৰেণী পৰিসংখ্য়া',
  'teacher-landing.class.students-tab.proficiency-in': 'প্ৰবীণতা',
  'teacher-landing.class.students-tab.data-not-available': 'ডাটা নাই',
  ...
  'teacher-landing.class.class-activities-tab.today': 'আজি:',
  'teacher-landing.class.class-activities-tab.yesterday': 'কালি:',
  'teacher-landing.class.class-activities-tab.month': 'মাহ:',
  'teacher-landing.class.class-activities-tab.add-from-course-map':
    'ক\'ৰ্চ মেপৰ পৰা যোগ কৰক',
  ...
  'teacher-landing.class.class-activities-tab.enter-max-assessment-time-spent':
    'মূল্যায়ন পূৰ্ণ কৰাত খৰচ হোৱা সময় অন্তৰ্ভুক্ত কৰক',
  'teacher-landing.class.class-activities-tab.enter-max-score':
    'মূল্যায়নৰ বেছিতকৈ বেছি সংখ্যা অন্তৰ্ভুক্ত কৰক',
  'teacher-landing.class.class-activities-tab.hour': 'h',
  'teacher-landing.class.class-activities-tab.min': 'm',
  'teacher-landing.class.class-activities-tab.question-score': 'প্ৰশ্ন সংখ্যা',
  'teacher-landing.class.class-activities-tab.max-score': 'সৰ্বোচ্চ সংখ্যা',
  ...
  'teacher-landing.class.class-activities-tab.add-subject-framework':
    'শ্ৰেণীৰ পটভূমিত এটা বিষয় আৰু ফ্ৰেমৱৰ্ক বাচনি কৰক',
  'teacher-landing.class.class-activities-tab.create-external-collection':
    'এটা বাহিৰা সংগ্ৰহ সৃষ্টি কৰক',
  ...
  'teacher-landing.class.class-settings.class-settings-sec.class-settings-sec-desc':
    'ত্ৰফি ক্ৰয় কৰিবৰ বাবে নূন্যতম কাৰ্যকাৰিতা',
  'teacher-landing.class.class-settings.class-settings-sec.class-code':
    'শ্ৰেণী মান',
  'teacher-landing.class.class-settings.class-settings-sec.subject': 'বিষয়',
  ...
  'teacher-landing.class.class-settings.course-settings-sec.is-route0-applicable':
    'ব্যক্তিগতকৰণ লাৰ্নিং পথ প্ৰফাইলৰ অন্তৰালক ক\'ভাৰ কৰা উচিত নে?',
  ...
  'teacher-landing.class.class-settings.student-id': 'শিক্ষাৰ্থী ID',
  'teacher-landing.class.class-settings.joined-on': 'এই তাৰিখত সংযোজিত হৈছিল',
  ...
  'goals.manage.end-date-label': 'শেষ তাৰিখ',
  'goals.manage.type-label': 'লক্ষ্যৰ ধৰণ',
  'goals.manage.status-label': 'স্থিতি',
  'goals.manage.not_started': 'আৰম্ভ হোৱা নাই',
  'goals.manage.activated': ' সক্রিয় কৰা হ\'ল',
  'goals.manage.completed': 'সম্পূৰ্ণ  হোৱা',
  'goals.manage.dropped': 'পেলোৱা হ\'ল',
  'goals.manage.reflection-label': 'প্ৰতিবিম্ব',
  'goals.manage.save': 'চেভ কৰক',
  'goals.manage.update': 'উন্নীত কৰক',
  'goals.manage.goals-not-found':
    'আপুনি এতিয়ালৈকে কোনো লক্ষ্য চেট কৰা নাই । ওপৰৰ "Add Goal" বাতন্তো ক্লিক কৰি আপুনি লক্ষ্য চেট কৰিব পাৰিব',
  'goals.create.error-add-title': 'অনুগ্ৰহ কৰি এটা লক্ষ্য অন্তৰ্ভুক্ত কৰক',
  'goals.create.error-length-title': 'লক্ষ্য 200 বৰ্ণৰ ভিতৰত হব লাগিব',
  'goals.create.error-add-start-date':
    'অনুগ্ৰহ কৰি আৰম্ভণি তাৰিখ অন্তৰ্ভুক্ত কৰক',
  'goals.create.error-add-end-date': 'অনুগ্ৰহ কৰি অন্তিম তাৰিখ অন্তৰ্ভুক্ত কৰক',
  'goals.create.error-greater-end-date':
    'অন্তিম তাৰিখটো আৰম্ভ তাৰিখতকৈ ডাঙৰ হ\'ব লাগিব',
  'goals.create.error-add-status': 'অনুগ্ৰহ কৰি লক্ষ্য স্থিতি অন্তৰ্ভুক্ত কৰক',
  'goals.create.error-length-reflection':
    'প্ৰতিবিম্ব 2000 বৰ্ণৰ ভিতৰত হব লাগিব',
  'goals.create.created-success-msg':
    'আপুনি লক্ষ্যটো সৃষ্টি কৰিলে {{goalTittle}}',
  'goals.delete.deleted-success-msg': 'আপুনি লক্ষ্যটো বিলোপ কৰিলে',
  'goals.update.updated-success-msg': 'আপুনি লক্ষ্যটো উন্নিত কৰিলে',
  'gru-add-to.add-assessment-to-lesson': 'মোৰ মূল্যায়নৰ পৰা যোগ কৰক',
  'gru-add-to.add-assessment-to-lesson-lead':
    'এই পাঠটোত যোগ কৰিবৰ বাবে এটা মূল্যায়ন বাচনি কৰক',
  ...
  'gru-add-to.add-to-existing-classroom': 'বৰ্তমান থকা শ্ৰেণীকোঠাৰ লগত যোগ কৰক',
  'gru-add-to.add-to-existing-classroom-lead':
    'আপুনি যোগ দিব বিচৰা শ্ৰেণীকোঠাটো বাচনি কৰক',
  'gru-add-to.add-to-assessment': 'মূল্যায়ন বা সংগ্ৰহত যোগ কৰক',
  ...
  'gru-add-rubric-to-question.lead':
    'এই প্ৰশ্নত যোগ দিবলৈ এটা ৰুব্ৰিক বাচনি কৰক।',
  'gru-add-rubric-to-question.no-rubrics':
    'আপুনি এই যিকোনো উত্তৰ দিব পৰা প্ৰশ্নটোৰ সংযোগ কৰিব পৰাকৈ এতিয়ালৈকে কোনো ৰুব্ৰিক সৃষ্টি কৰা নাই। আপুনি মোৰ বিষয়বস্তুৰ অধীনত ৰুব্ৰিক সৃষ্টি কৰিব পাৰে যিবোৰ মোৰ প্ৰফাইলৰ পৰা এক্সেচ কৰিব পাৰি।',
  'gru-add-rubric-to-question.go-to-content': 'মোৰ বিষয়বস্তুলৈ যাওক',
  'gru-assessment-confirmation.title': 'আপুনি এতিয়া এটা মূল্যায়ন আৰম্ভ কৰিব',
  'gru-assessment-confirmation.description': 'এইটো মূল্যায়নত, {{model.title}}',
  'gru-assessment-confirmation.setting-forward':
    'আপুনি কেৱল আগলৈ নেভিগেট কৰিব পাৰিব',
  ...
  'gru-assessment-confirmation.start': 'আৰম্ভ কৰক',
  'gru-assessment-confirmation.submit': 'জমা কৰক',
  'gru-submit-confirmation.title': 'এই কুইজ শেষ কৰক আৰু সকলো জমা কৰক',
  'gru-submit-confirmation.description':
    'আপুনি এই প্ৰয়াসটো শেষ কৰি সকলো উত্তৰ জমা কৰিবলৈ লৈছে। এৰি দিয়া যিকোনো প্ৰশ্ন ভুল বুলি ধৰা হ\'ব।',
  'gru-submit-confirmation.cancel': 'প্ৰত্যাহাৰ',
  'gru-submit-confirmation.ok': 'ok',
  'gru-submit-confirmation.confirm': 'কুইজ শেষ কৰক',
  'gru-submit-confirmation.finish-description':
    'আপোনাৰ উত্তৰবোৰ জমা কৰিবলৈ "Finish Quiz" ক্লিক কৰক',
  'gru-quick-course-search.add-from-course':
    'বৰ্তমান থকা কাৰ্যক্ৰমৰ পৰা যোগ কৰক',
  'gru-quick-course-search.view-featured-courses': 'এটা বিশেষ ধৰণৰ ক\'ৰ্চ চাওঁক',
  'gru-quick-course-search.assign': 'অনুমোদন',
  'gru-share-pop-over.copy': 'নকল',
  'gru-share-pop-over.ios-tooltip': 'নকল কৰিবলৈ টেপটো ধৰি ৰাখক',
  'gru-share-pop-over.multiarch-tooltip': 'নকল কৰিবলৈ Ctrl + C প্ৰেছ কৰক',
  'gru-share-pop-over.safari-osx-tooltip': 'নকল কৰিবলৈ Cmd + C প্ৰেছ কৰক',
  'gru-share-pop-over.share-course': 'আপোনাৰ ক\'ৰ্চ লিংকৰ লগত শ্বেয়াৰ কৰক',
  ...
  'gru-category-panel.teacher.cta': 'স্তৰিবোৰ চাওক',
  'gru-category-panel.student.title': 'শিক্ষাৰ্থীৰ বাবে',
  'gru-category-panel.student.body':
    'ভালপোৱা কামবোৰ চাওক, নিৰ্মাণ কৰক আৰু শিক্ষণ সামগ্ৰীৰ দ্বাৰা প্ৰগতিৰ ওপৰত চকু ৰাখক।',
  'gru-category-panel.student.cta': 'অন্তৰ্ভুক্ত কৰক',
  'gru-category-panel.student.text-placeholder':
    'শ্ৰেণীকোঠাৰ ক\'ড অন্তৰ্ভুক্ত কৰক',
  ...
  'class.gru-class-navigation.greetings': 'ঘোষণাসমূহ',
  'class.gru-class-navigation.overview': 'ক\'ৰ্চ মেপ',
  'class.gru-class-navigation.analytics': 'ডাটা',
  'class.gru-class-navigation.teams': 'পাৰ্টীবোৰ',
  'class.gru-class-navigation.information': 'শ্ৰেণীকোঠাৰ তথ্য',
  'class.gru-class-statistics.title': 'শ্ৰেণী পৰিসংখ্য়া',
  'class.gru-class-statistics.on-average': 'গড়ত',
  'class.gru-class-statistics.performance': 'প্ৰদৰ্শন',
  ...
  'gru-user-registration.descriptionWhyGoogle':
    'ই খৰতকীয়া আৰু সহজ। পাচৱৰ্ড নোহোৱাকৈ চাইন ইন কৰিবলৈ আপোনাৰ বৰ্তমান থকা গুগল একাউণ্ট ব্যৱহাৰ কৰক।',
  ...
  'gru-welcome-message.text-temporary-two':
    'আমাৰ সুবিধাসমূহ কেনেকৈ ব্যৱহাৰ কৰিব তাৰ বাবে মাৰ্গদৰ্শন পাবলৈ।',
  'gru-welcome-message.text-one':
    'আপুনি শিক্ষা নেভিগেটৰটোলৈ আগবাঢ়ি যোৱাৰ লগে লগে আমি আপোনাক আপোনাৰ যাত্ৰাত সহায় তলত উল্লেখ কৰা প্ৰকাৰত সহায় কৰিবলৈ পাই সুখী হৈছোঁ।',
  'gru-welcome-message.text-two.subtitle': 'এটা ভ্ৰমণ কৰক',
  ...
  'sign-up.step-child-description-1':
    'গুৰুৱে আপোনাৰ একাউণ্ট সৃষ্টি কৰিব নোৱাৰিলে আৰু ইয়াৰ কাৰণ হৈছে আমাৰ',
  ...
  'sign-up.dateOfBirth.months.september': 'ছেপ্তেম্বৰ',
  'sign-up.dateOfBirth.months.october': 'অক্টোবৰ',
  'sign-up.dateOfBirth.months.november': 'নৱেম্বৰ',
  ...
  'sign-up.state': 'ৰাজ্য অথবা ক্ষেত্ৰ',
  'sign-up.district': 'জিলা অথবা ক্ষেত্ৰীয় সংগঠন',
  'sign-up.error-username-taken':
    'উস্‌, এই ব্যৱহাৰকাৰী নামটো লোৱা হৈছে। অন্য এটা চেষ্টা কৰক।',
  'sign-up.error-email-taken': 'এই ইমেইলটো লোৱা হৈছে। অন্য এটা চেষ্টা কৰক।',
  'sign-up.error-role-message': 'অনুগ্ৰহ কৰি এটা ভূমিকা নিৰ্বাচন কৰক। ',
  'sign-up.error-country-message': 'অনুগ্ৰহ কৰি আপোনাৰ দেশ নিৰ্বাচন কৰক',
  ...
  'gru-user-sign-up-cancel.registration_incomplete':
    'আপোনাৰ পঞ্জীয়ন সম্পূৰ্ণ নহয়।',
  'gru-user-sign-up-cancel.leave': 'পঞ্জীয়ন এৰক',
  'gru-user-sign-up-cancel.continue': 'পঞ্জীয়ন আগবঢ়াই নিয়ক',
  'login.title': 'পুনৰ স্বাগতম!',
  'login.description': 'শিকিবলৈ আৰু মাৰ অলপ বাকি।',
  'login.title-session-ends': 'আপোনাৰ কাৰ্য্যকাল শেষ হৈছে।',
  'login.description-session-ends': 'অনুগ্ৰহ কৰি চাইন ইন কৰক',
  'login.gooruAccountTitle': 'আপোনাৰ গুৰু একাউণ্টত লগ ইন কৰক',
  'login.googleButton': 'গুগলৰ দ্বাৰা চাইন ইন কৰক',
  'login.or': 'বা',
  'login.haveAccount': 'আপোনাৰ এটা একাউণ্ট আছে নে?',
  'login.signUpHere': 'ইয়ান চাইন আপ কৰক!',
  'login.forgotPassword': 'আপোনাৰ পাছৱৰ্ড পাহৰিলে?',
  'login.password': 'পাছৱৰ্ড',
  'login.usernameOrEmail': 'ব্যৱহাৰকাৰী নাম অথবা ইমেইল',
  'login.log-in': 'লগ ইন ',
  ...
  'reset-password.new-password-confirm': 'আপোনাৰ পাছৱৰ্ড নিশ্চিত কৰক',
  'reset-password.title': 'পাছৱৰ্ড ৰিচেট কৰক',
  'change-password.change-password': 'পাছৱৰ্ড লিংক সলাওক',
  'change-password.title': 'পাচৱৰ্ড সলাওক',
  'change-password.current-password-label': 'আপোনাৰ বৰ্তমান পাচৱৰ্ড দিয়ক',
  'change-password.change-success': 'পাচৱৰ্ড সফলতাৰে সলনি কৰা হ\'ল !!',
  'change-password.new-password-required':
    'অনুগ্ৰহ কৰি আপোনাৰ নতুন পাচৱৰ্ড দিয়ক।',
  'change-password.change-password-error':
    'উস্‌! কিবা এটা ঠিক নহয়। পাচৱৰ্ড সলাবলৈ অক্ষম। অনুগ্ৰহ কৰি পুনৰ চেষ্টা কৰক',
  'footer.footerDescription':
    'গৰোৱে তাৰ প্লেটফৰ্ম অ\'পেম চ\'ৰ্চ আৰু সম্প্ৰদায়ে সৃষ্টি কৰা বিষয়বস্তুক CC0 কৰি ৰাখিবলৈ প্ৰতিজ্ঞাবদ্ধ।',
  ...
  'search-result.and': 'আৰু',
  'search-result.question': 'প্ৰশ্ন',
  'search-result.questions': 'প্ৰশ্নসমূহ',
  'search-result.in-this-collection': 'এই সংকলনত',
  'search-result.search-results-for': 'ইয়াৰ বাবে ফলাফল সন্ধান কৰক',
  'gru-image-picker.chooseFile': 'এটা ফাইল নিৰ্বাচন কৰক  ...',
  'gru-image-picker.instruction':
    'আপোনাৰ কম্পিউটাৰৰ এট ফাইলৰ পৰা এখন ছবি নিৰ্বাচন কৰক।',
  ...
  'gru-login-prompt.new-user': 'ইয়াত নতুন নে?',
  'gru-login-prompt.not-now': 'এতিয়া নহয়',
  'gru-login-prompt.sign-in': 'চাইন ইন কৰক',
  'gru-multiple-answer.instructions':
    'অনুগ্ৰহ কৰি শুদ্ধ উত্তৰটো বাছনি কৰক, আৰু "{{action}}" ত ক্লিক কৰক।',
  'gru-multiple-choice.instructions':
    'অনুগ্ৰহ কৰি শুদ্ধ উত্তৰটো বাছনি কৰক, আৰু "{{action}}" ত ক্লিক কৰক।',
  'gru-open-ended.instructions':
    'অনুগ্ৰহ কৰি নিম্নলিখিত ক্ষেত্ৰখনত নিজৰ উত্তৰ টাইপ কৰক, আৰু যেতিয়া আপোনাৰ কৰি হয় তেতিয়া আপোনাৰ প্ৰতিক্ৰিয়া ছেভ কৰিবলৈ "{{action}}" বুটামত ক্লিক কৰিব।',
  'gru-open-ended.characterLimit': 'আখৰৰ সীমা',
  'gru-question-viewer.answer': 'উত্তৰ',
  'gru-question-viewer.question': 'প্ৰশ্ন',
  ...
  'student-first-experience.competency-level.in-progress':
    '{{count}}টা মানক চলি আছে',
  'student-first-experience.competency-level.not-started':
    '{{count}}টা মানক আৰম্ভ কৰা নাই',
  'student-first-experience.competency-level.your-skyline': 'আপোনাৰ স্কাইলাইন',
  'student-first-experience.explanatory.master.title': 'পাৰ্গতা লাভ কৰা হৈছে',
  'student-first-experience.explanatory.master.desc':
    'সংকেত দিয়ে যে আপুনি মানকসমূহত পাৰদৰ্শিতা লাভ কৰাৰ প্ৰমাণ আছে',
  'student-first-experience.explanatory.in-progress.title': 'চলি আছে',
  'student-first-experience.explanatory.in-progress.desc':
    'সংকেত দিয়ে যে আপুনি মানকসমূহ পঢ়িবলৈ আৰম্ভ কৰিছে আৰু পাৰদৰ্শিতা লাভ কৰাৰ পথত থকা প্ৰমাণ আছে',
  'student-first-experience.explanatory.not-started.title': 'আৰম্ভ হোৱা নাই',
  'student-first-experience.explanatory.not-started.desc':
    'সংকেত দিয়ে যে কোনো প্ৰমাণ নাই আৰু মানকসমূহ পঢ়িবলৈ আৰম্ভ কৰিবলৈ এতিয়াও বাকি আছে ',
  ...
  'player.gru-viewer.not-iframe-url.header_external_assessment_1':
    'এই মূল্যায়নটো গৰোৰ ভিতৰত চাব নোৱাৰি',
  'player.gru-viewer.not-iframe-url.header_2':
    'সম্পদটো নতুন টেবত খুলিবলৈ তলত দিয়া বুটামটো টিপক।',
  'player.gru-viewer.not-iframe-url.view-resource': 'সম্পদ চাওক',
  'player.gru-viewer.not-iframe-url.https_external':
    'এই লিংকটো গৰোৰ ভিতৰত চাব নোৱাৰি।',
  'player.gru-viewer.not-iframe-url.https_new_tab':
    'লিংকটো নতুন টেবত খুলিবলৈ তাক ক্লিক কৰক।',
  'player.gru-viewer.not-iframe-url.footer_1':
    'মই এই খালি পৃষ্ঠাটো কিয় দেখিছোঁ?',
  'player.gru-viewer.not-iframe-url.footer_2':
    'গৰোত যোগ কৰা সম্পদবোৰ হাজাৰ হাজাৰ সম্পাদকৰ পৰা আহে যিসকলে',
  'player.gru-viewer.not-iframe-url.footer_3':
    'নিজৰ বিষয়বস্তু নিৰ্মাণ কৰে আৰু শ্বেয়াৰ কৰে। সম্পদসমূহ কেইবাপ্ৰকাৰৰ চেটিং থাকে, লগতে ',
  'player.gru-viewer.not-iframe-url.footer_4':
    'সেইবোৱ প্ৰয়োজনীয়তা থাকে যিবোৰে আপোনাক অন্য পৃষ্ঠালৈ বিষয়বস্তু চাবলৈ লৈ যায়।',
  'grading-player.answer': 'জমা কৰা কাৰ্য',
  'grading-player.back-to': 'পাছফাল',
  'grading-player.current-response': 'বৰ্তমান উত্তৰ',
  'grading-player.full-rubric': 'সম্পূৰ্ণ ৰুব্ৰিক',
  'grading-player.grading': 'গ্ৰেডিং',
  'grading-player.level': 'স্তৰ',
  'grading-player.roster': 'নামাংকন',
  'grading-player.rubric': 'ৰুব্ৰিক',
  'grading-player.submitted-time': 'জমা কৰা সময়',
  'grading-player.points': 'পইণ্ট',
  'grading-player.prompt': 'টাস্ক প্ৰম্পট',
  'grading-player.overall-comment': 'মুঠ মন্তব্য',
  'grading-player.overall-lead':
    'ৰচনাখনৰ ওপৰত আপোনাৰ সঁহাৰি সম্পূৰ্ণৰুপে সাৰাংশিত কৰক।',
  'grading-player.time-spent': 'কটোৱা সময়',
  'grading-player.total-score': 'মুঠ স্কোৰ',
  'grading-player.student-roster.title': 'ছাত্ৰ-ছাত্ৰীৰ তালিকা',
  'grading-player.student-roster.lead': 'এই প্ৰশ্নটোৰ উত্তৰ দিছে',
  ...
  'profile.gru-navigation.followers': 'অনুগামী',
  'profile.gru-navigation.library': 'পুথিভঁৰাল ',
  'profile.gru-navigation.my-content': 'মোৰ বিষয়বস্তু ',
  'profile.gru-navigation.following': 'অনুসৰণ  কৰি থকা ',
  ...
  'profile.proficiency.mastered': 'দৰ্শতা লাভ কৰা',
  'profile.proficiency.in-progress': 'অগ্ৰগতিত',
  'profile.proficiency.not-started': 'আৰম্ভ হোৱা নাই',
  'profile.proficiency.skyline': 'স্কাইলাইন',
  'profile.proficiency.baseline': 'বেচলাইন',
  'profile.proficiency.grade-line': 'গ্ৰেড লাইন',
  ...
  'profile.proficiency.show-expanded-chart': 'ডাণজ্ঞৰ কৰা তালিকা দেখুৱাওক',
  'profile.preference.language-preference': 'ভাষাৰ পচন্দ',
  'profile.preference.choose-language': 'ভাষা নিৰ্বাচন কৰক',
  'profile.preference.choose-sec-language': 'বাছনি',
  'profile.preference.choose-preferred-language':
    'প্ৰফাইলৰ প্ৰধান ভাষা নিৰ্বাচন কৰক',
  'profile.preference.choose-preferred-other-languages':
    'অন্য পচন্দৰ ভাষা নিৰ্বাচন কৰক',
  'profile.preference.language': 'ভাষা',
  'profile.preference.select-category-label': 'নতুন শ্ৰেণী যোগ কৰক',
  'profile.preference.choose-category': 'শ্ৰেণী চয়ন কৰক',
  'profile.preference.no-data': 'কোনো ডাটা নাই',
  'profile.preference.category-preference': 'শ্ৰেণীৰ পচন্দ',
  'profile.preference.choose-subject': 'বিষয় চয়ন কৰক',
  'profile.preference.choose-fwk': 'ফ্ৰেমৱৰ্ক চয়ন কৰক',
  'profile.preference.add-subject': 'বিষয় যোগ কৰক',
  ...
  'gru-data-picker.study-time': 'অধ্যয়নৰ সময়',
  'gru-data-picker.reaction': 'প্ৰতিক্ৰিয়া',
  'gru-data-picker.attempts': 'প্ৰয়াস',
  'gru-performance-summary.title': 'শীৰ্ষক',
  'gru-performance-summary.scores': 'নম্বৰসমূহ',
  'gru-performance-summary.completion': 'সম্পাদন',
  ...
  'gru-performance.no-content': 'কোনো বিষয়বস্তু নাই ',
  ...
  'gru-resource-new.resource-already-exist':
    'এইসমূহ সামগ্ৰী ইতিমধ্যে গুৰুত উপলব্ধ',
  'gru-assessment-report.gru-summary.total-time-spent':
    'সৰ্বমুঠ অতিবাহিত কৰা সময়',
  'gru-assessment-report.hidden-report':
    'এই মূল্যাংকনৰ আপোনাৰ সম্পূৰ্ণ  প্ৰতিবেদন আপোনাৰ শিক্ষকে লুকুৱাবলৈ নিৰ্বাচন কৰিছে।',
  'cards.gru-class-card.student.zero': '{{count}} ছাত্ৰ-ছাত্ৰী',
  'cards.gru-class-card.student.one': '{{count}} ছাত্ৰ-ছাত্ৰী',
  'cards.gru-class-card.student.other': '{{count}} ছাত্ৰ-ছাত্ৰীসকল',
  'cards.gru-class-card.student.not-started': 'আৰম্ভ হোৱা নাই',
  'cards.gru-class-card.unit.zero': 'কোনো পাঠ্যক্ৰম নাই',
  'cards.gru-class-card.unit.one': '{{count}} গোট',
  'cards.gru-class-card.unit.other': '{{count}}টা অধ্যায়',
  'cards.gru-class-card.archived.request-report':
    'এইটো শ্ৰেণী সংগৃহীত হয় আৰু সংশোধন কৰিব পৰা নাযায়। বৰ্তি থকা শ্ৰেণীৰ ডাটাক প্ৰতিবেদনৰ  জড়িয়তে  উদ্ধাৰ কৰিব পৰা যায়।',
  'cards.gru-class-card.archived.report-in-progress':
    'প্ৰতিবেদন প্ৰস্তত হবলৈ 20 min লৈকে সময়ৰ প্ৰয়োজন হয়। অনুগ্ৰহ কৰি অলপ পাছত পুনৰ পৰীক্ষা কৰক।',
  'cards.gru-class-card.archived.download-report':
    'এই শ্ৰেণীৰ পৰা আপোনাৰ ডাটা ডাউনল\'ড কৰক।',
  'cards.gru-class-card.archived.no-report-available':
    'এই শ্ৰেণীটোৰ পাঠ্যক্ৰমৰ বিষয়বস্ত নাই।',
  'cards.gru-course-card.in': 'ভিতৰ',
  'cards.gru-course-card.units.zero': '{{count}}টা অধ্যায়',
  'cards.gru-course-card.units.one': '{{count}} গোট',
  'cards.gru-course-card.units.other': '{{count}}টা অধ্যায়',
  'cards.gru-course-card.resource.zero': '{{count}} সামগ্ৰীসমূহ',
  'cards.gru-course-card.resource.one': '{{count}} সামগ্ৰী',
  'cards.gru-course-card.resource.other': '{{count}} সামগ্ৰীসমূহ',
  'cards.gru-course-card.and': 'আৰু',
  'cards.gru-course-card.question.zero': '{{count}} প্ৰশ্নসমূহ',
  'cards.gru-course-card.question.one': '{{count}} প্ৰশ্ন',
  'cards.gru-course-card.question.other': '{{count}} প্ৰশ্নসমূহ',
  'cards.gru-course-card.start-studying': 'পঢ়িবলৈ আৰম্ভ কৰক',
  'cards.gru-collection-card.courses.zero': '{{count}} পাঠ্যক্ৰমসমূহ',
  'cards.gru-collection-card.courses.one': '{{count}} পাঠ্যক্ৰম',
  'cards.gru-collection-card.courses.other': '{{count}} পাঠ্যক্ৰমসমূহ',
  'cards.gru-collection-card.students.zero': '{{count}} ছাত্ৰ-ছাত্ৰীসকল',
  'cards.gru-collection-card.students.one': '{{count}} ছাত্ৰ-ছাত্ৰী',
  'cards.gru-collection-card.students.other': '{{count}} ছাত্ৰ-ছাত্ৰীসকল',
  'cards.gru-collection-card.collections.one': '{{count}} সংগ্ৰহ',
  'cards.gru-collection-card.collections.other': '{{count}} সংগৃহীত সমূহ',
  'cards.gru-collection-card.assessments.one': '{{count}}মূল্যাংকণ',
  'cards.gru-collection-card.assessments.other': '{{count}}মূল্যাংকণ সমূহ',
  'cards.gru-collection-card.classrooms.zero': '{{count}} শ্ৰেণীকোঠাসমূহ',
  'cards.gru-collection-card.classrooms.one': '{{count}} শ্ৰেণীকোঠা',
  'cards.gru-collection-card.classrooms.other': '{{count}} শ্ৰেণীকোঠাসমূহ',
  'cards.gru-resource-card.add': 'যোগ কৰক',
  'cards.gru-resource-result-card.skipped': 'স্কিপড',
  'cards.gru-profile-card.followers': 'অনুগামী',
  'cards.gru-profile-card.following': 'অনুসৰণ  কৰি থকা ',
  'cards.gru-user-network-card.follow': 'অনুসৰণ কৰক',
  'reports.gru-table-view.first-tier-header-prefix': 'Q',
  'reports.gru-table-view.student': 'ছাত্ৰ',
  'reports.gru-table-view.reaction': 'প্ৰতিক্ৰিয়া',
  'reports.gru-table-view.reactions': 'সঁহাৰিসমূহ',
  'reports.gru-table-view.score': 'শ্ৰৌত',
  'reports.gru-table-view.scores': 'নম্বৰসমূহ',
  'reports.gru-table-view.study-time': 'অধ্যয়নৰ সময়',
  'reports.gru-table-view.time': 'সময়',
  'reports.gru-table-view.time-spent': 'কটোৱা সময়',
  'reports.gru-table-view.totals': 'সৰ্বমুঠ',
  'gru-emotion-picker.react-to-resource': 'সামগ্ৰীটোৰ সঁহাৰি',
  'home.no-classes-found.create-class.title':
    'এটা গুৰু শ্ৰেণীকোঠাৰ দ্বাৰা পঢ়াওক',
  ...
  'home.no-classes-found.join-class.button-text':
    'শ্ৰেণীকোঠাৰ ক\'ড অন্তৰ্ভুক্ত কৰক',
  'home.no-classes-found.featured-courses.title': 'আনুষংগিক পাঠ্য়ক্ৰমসমূহ',
  'home.no-classes-found.featured-courses.description':
    'গণিত, বিজ্ঞান, সমাজ বিদ্যা আৰু ELA পাঠ্যক্ৰমসমূহ ব্ৰাউজ কৰক।',
  'home.no-classes-found.featured-courses.button-text':
    'আনুষংগিক পাঠ্য়ক্ৰমসমূহ',
  'home.no-classes-found.teacher-toolkit.title': 'শিক্ষকৰ টুলকিট',
  ...
  'taxonomy.gru-taxonomy-selector.competency-subject-and-course':
    'দক্ষ্যতাৰ ৰুপৰেখা আৰু পাঠ্যক্ৰম',
  'taxonomy.gru-taxonomy-selector.primary-subject-and-course':
    'মানদণ্ডৰ ৰেখা আৰু পাঠ্যক্ৰম',
  ...
  'locateme.attempt': 'প্ৰয়াস',
  'locateme.lastAcessesed': 'অন্তিম উপায়',
  'taxonomy.modals.gru-domain-picker.browseSelectorText':
    'এই গোটটোৱে কোনটো পৰিসৰ ক\'ভাৰ কৰিব?',
  'taxonomy.modals.gru-domain-picker.selectedText.zero':
    '{{count}} পৰিসৰসমূহ বাছনি কৰা হ\'ল',
  'taxonomy.modals.gru-domain-picker.selectedText.one':
    '{{count}} পৰিসৰ বাছনিকৃত হ\'ল',
  'taxonomy.modals.gru-domain-picker.selectedText.other':
    '{{count}} পৰিসৰসমূহ বাছনি কৰা হ\'ল',
  'taxonomy.modals.gru-domain-picker.shortcutText': 'পাঠ্যক্ৰম আছে',
  'taxonomy.modals.gru-standard-picker.browseSelectorText':
    'কি কি মানদণ্ডসমূহ ক\'ভাৰ কৰা হ\'ব?',
  'taxonomy.modals.gru-standard-picker.browseCompetencySelectorText':
    'কি কি পাৰদৰ্শিতাসমূহ ক\'ভাৰ কৰা হ\'ব?',
  'taxonomy.modals.gru-standard-picker.selectedText.zero':
    '{{count}} মানদণ্ডসমূহ বাছনি কৰা হ\'ল',
  'taxonomy.modals.gru-standard-picker.selectedText.one':
    '{{count}} মানদণ্ড বাছনিকৃত হ\'ল',
  'taxonomy.modals.gru-standard-picker.selectedText.other':
    '{{count}} মানদণ্ডসমূহ বাছনি কৰা হ\'ল',
  'taxonomy.modals.gru-standard-picker.selectedCompetencyText.zero':
    '{{count}} পাৰদৰ্শিতাসমূহ বাছনি কৰা হ\'ল',
  'taxonomy.modals.gru-standard-picker.selectedCompetencyText.one':
    '{{count}} পাৰদৰ্শিতা বাছনিকৃত হ\'ল',
  'taxonomy.modals.gru-standard-picker.selectedCompetencyText.other':
    '{{count}} পাৰদৰ্শিতাসমূহ বাছনি কৰা হ\'ল',
  'taxonomy.modals.gru-standard-picker.shortcutText': 'ইউনিটক টেগ কৰা হ\'ল',
  'account-settings.title': 'একাউন্ট ছেটিংছ',
  'account-settings.account-info': 'একাউণ্টৰ তথ্য',
  'account-settings.private-info': 'ব্যক্তিগত তথ্য',
  'account-settings.email-address': 'ইমেইল এড্ৰেছ',
  'account-settings.gender': 'লিংগ',
  'account-settings.birthday': 'জন্মদিন',
  'gru-rich-text-editor.bold': 'ব\'ল্ড',
  'gru-rich-text-editor.expression': 'অভিব্যক্তি',
  'gru-rich-text-editor.italic': 'ইটালিক',
  'gru-rich-text-editor.subscript': 'চাবস্ক্ৰিপ্ট',
  'gru-rich-text-editor.superscript': 'চুপাৰস্ক্ৰিপ্ট',
  'gru-rich-text-editor.underline': 'আণ্ডাৰলাইন',
  'gru-rich-text-editor.bullets': 'বুলেট',
  'gru-rich-text-editor.expressions-panel.tabs.calculus': 'কেলকুলাচ',
  'gru-rich-text-editor.expressions-panel.tabs.greek-letters': 'গ্ৰীক আখৰ',
  'gru-rich-text-editor.expressions-panel.tabs.layout': 'লেআউট',
  'gru-rich-text-editor.expressions-panel.tabs.relation': 'সম্পৰ্ক',
  'gru-rich-text-editor.expressions-panel.tabs.set-theory': 'সংহতি সিদ্ধান্ত',
  'gru-rich-text-editor.expressions-panel.tabs.symbols': 'চিহ্ন',
  'gru-rich-text-editor.expressions-panel.tabs.trigonometry': 'ত্ৰিকোণমিতি',
  'gru-rich-text-editor.expressions-panel.insert-expression': 'যোগ কৰক',
  'gru-rich-text-editor.expressions-panel.update-expression': 'উন্নীত কৰক',
  ...
  'gru-settings-edit.answer-key': 'ছাত্ৰ-ছাত্ৰী উত্তৰ কী শেষত চাব পাৰিব',
  'gru-settings-edit.attempts': 'প্ৰয়াসবোৰ',
  'gru-settings-edit.attempts-unlimited': 'অসীমিত',
  'gru-settings-edit.backwards':
    'ছাত্ৰ-ছাত্ৰীসকলে পাছফালৰ পৰা নেভিগেট কৰিব পাৰে আৰু প্ৰতিক্ৰিয়া সলনি কৰিব পাৰে',
  'gru-settings-edit.feedback':
    'ছাত্ৰ-ছাত্ৰী সকলে তেওঁলোক শুদ্ধ/অশুদ্ধ  হয়নে চাব পাৰে',
  'gru-settings-edit.feedback-immediate': 'প্ৰতি প্ৰশ্ন আৰু অৱশেষত',
  'gru-settings-edit.feedback-never': 'কেতিয়াও',
  'gru-settings-edit.feedback-summary': 'অৱশেষত',
  'gru-settings-edit.navigation-scoring': 'নেভিগেছন আৰু স্ক\'ৰিং',
  'gru-settings-edit.disable-heading': 'ক\'ৰ্চ মেপত মূল্যাংকন সক্ৰিয় কৰক',
  'gru-settings-edit.disable-legend':
    'ছাত্ৰ-ছাত্ৰীসকলে তেওঁলোকৰ মূল্যাংকন ক\'ৰ্চ মেপৰ পৰা অংশ লব পাৰিব',
  'gru-icon-popover.settings-visibility-title':
    'নিশ্চিত হওক যে আপোনাৰ বিষয়বস্ত দৃশ্যমান হয়',
  'gru-icon-popover.settings-visibility-content':
    'এই ছেটিংঙে আপোনাৰ ব্যৱহাৰকাৰী প্ৰফাইলৰ পৰা আপোনাৰ বিষয়বস্ত দৃশ্যমান কৰি তুলিব। যদি আপুনি আপোনাৰ সহকৰ্মীৰ সৈতে তৈয়াৰ কৰা পাঠ্যক্ৰমসমূহ, চয়নসমূহ, মূল্যাংকনসমূহ, সামগ্ৰীসমূহ আৰু/নাইবা প্ৰশ্নসমূহ ভগাব বিচাৰে, আমি এই অংশটো অন কৰিবলৈ পৰামৰ্শ আগবঢ়াও।',
  'gru-take-tour.text': 'ভ্ৰমণ',
  'gru-take-tour.teacher-home.stepOne.title': 'এটা ভ্ৰমণ কৰক',
  'gru-take-tour.teacher-home.stepOne.description':
    'ভ্ৰমণ আৰু আপোনাৰ মূখ্য পৃষ্ঠালৈ আপোনাক স্বাগতম! এতিয়া আৰম্ভ কৰা হওঁক!',
  'gru-take-tour.teacher-home.stepTwo.title': 'নক্সা',
  'gru-take-tour.teacher-home.stepTwo.description':
    'নক্সাটোত ক্লিক কৰি আপুনি আপোনাৰ মূখ্য পৃষ্ঠালৈ উলতিব পাৰিব।',
  'gru-take-tour.teacher-home.stepThree.title': 'চাৰ্চ বাৰ',
  'gru-take-tour.teacher-home.stepThree.description':
    'আপোনাৰ আগ্ৰহ থকা বিষয়ৰ বাবে আমাৰ বিষয়বস্তৰ কেটালগ বিচাৰক।',
  'gru-take-tour.teacher-home.stepFour.title': 'শ্ৰেণীকোঠাসমূহ',
  'gru-take-tour.teacher-home.stepFour.description':
    'আপোনাৰ মূখ্য পৃষ্ঠালৈ ঘূৰি ব\'লক।',
  'gru-take-tour.teacher-home.stepFive.title': 'বিষয়বস্ত পৰিচালক',
  'gru-take-tour.teacher-home.stepFive.description':
    'আপোনাৰ বিষয়বস্ত তৈয়াৰ কৰিবলৈ আৰু সেইটো পাবলৈ কুইক লিংক।',
  'gru-take-tour.teacher-home.stepSix.title': 'পুথিভঁৰাল ',
  'gru-take-tour.teacher-home.stepSix.description':
    'আমাৰ বিশেষ পাঠ্যক্ৰমসূহ ব্ৰাউজ কৰক।',
  'gru-take-tour.teacher-home.stepSeven.title': 'আপোনাৰ ব্ৰাউজ',
  'gru-take-tour.teacher-home.stepSeven.description':
    'আপোনাৰ বিষয়বস্ত, উপভোক্তা প্ৰফাইল, আৰু ছেটিং এক্সেছ কৰক আৰু উন্নীত কৰক।',
  'gru-take-tour.teacher-home.stepEight.title': 'সহায়',
  'gru-take-tour.teacher-home.stepEight.description':
    'সহায়তা কেন্দ্ৰ নাইবা লগআউট এক্সেছ কৰক।',
  'gru-take-tour.teacher-home.stepNine.title': 'শ্ৰেণীকোঠাসমূহ',
  'gru-take-tour.teacher-home.stepNine.description':
    'আপুনি বৰ্তমান শিক্ষাদান কৰি থকা শ্ৰেণীসমূহৰ এখন তালিকা চাওঁক।',
  'gru-take-tour.teacher-home.stepTen.title': 'সংগ্ৰীহিত শ্ৰেণীসমূহ',
  'gru-take-tour.teacher-home.stepTen.description':
    'আপুনি অতীতত শিক্ষাদান কৰা শ্ৰেণীসমূহৰ এখন তালিকা চাওঁক।',
  'gru-take-tour.teacher-home.stepEleven.title': 'শ্ৰেণীকোঠা সৃস্টি কৰক',
  'gru-take-tour.teacher-home.stepEleven.description':
    'আপোনাৰ শ্ৰেণীকোঠাৰ নাম লওঁক আৰু এটা নতুন শ্ৰেণীকোঠা তৈয়াৰ কৰিবলৈ বুটামটোত ক্লিক কৰক।',
  'gru-take-tour.student-home.stepOne.title': 'এটা ভ্ৰমণ কৰক',
  'gru-take-tour.student-home.stepOne.description':
    'ভ্ৰমণ আৰু আপোনাৰ মূখ্য পৃষ্ঠালৈ আপোনাক স্বাগতম। আপোনাৰ মূখ্য পৃষ্ঠাত উপলব্ধ সুবিধাসমূহলৈ ব\'লক।',
  'gru-take-tour.student-home.stepFeaturedCourses.title':
    'আনুষংগিক পাঠ্য়ক্ৰমসমূহ',
  'gru-take-tour.student-home.stepFeaturedCourses.description':
    'আপোনাৰ আগ্ৰহ থকা পাঠ্যক্ৰম সমূহৰ বাবে লাৰ্নিং নেভিগেটৰৰ সামগ্ৰীসমূহৰ কেটালগৰ বিশেষ পাঠ্যক্ৰম ব্ৰাউজ কৰক।',
  'gru-take-tour.student-home.stepTwo.title': 'নক্সা',
  'gru-take-tour.student-home.stepTwo.description':
    'নক্সাটোত ক্লিক কৰি আপুনি আপোনাৰ মূখ্য পৃষ্ঠালৈ উলতিব পাৰিব।',
  'gru-take-tour.student-home.stepThree.title': 'চাৰ্চ বাৰ',
  'gru-take-tour.student-home.stepThree.description':
    'আপোনাৰ আগ্ৰহ থকা বিষয়সমূহৰ বাবে আমাৰ বিষয়বস্তৰ কেটালগ বিচাৰক।',
  'gru-take-tour.student-home.stepFour.title': 'মোৰ শিক্ষা',
  'gru-take-tour.student-home.stepFour.description':
    'আপোনাৰ মূখ্য পৃষ্ঠালৈ উলতি ব\'লক।',
  'gru-take-tour.student-home.stepFive.title': 'পুথিভঁৰাল ',
  'gru-take-tour.student-home.stepFive.description':
    'সেই বিষয়সমূহৰ কাৰণে লাৰ্নিং নেভিগেটৰৰ সুবিধাৰ পাঠ্যক্ৰম আৰু পাৰ্টনাৰ লাইব্ৰেৰি ব্ৰাউজ কৰক য\'ত আপোনাৰ  আগ্ৰহ আছে।',
  'gru-take-tour.student-home.stepSix.title': 'প্ৰদৰ্শন',
  'gru-take-tour.student-home.stepSix.description':
    'আপুনি পঞ্জীভূক্ত হৈ থকা পাঠ্যক্ৰমৰ আপোনাৰ পাৰদৰ্ক্ষিতাৰ সাৰংশ চাওক। ',
  'gru-take-tour.student-home.stepSeven.title': 'আপোনাৰ ব্ৰাউজ',
  'gru-take-tour.student-home.stepSeven.description':
    'আপোনাৰ বিষয়বস্ত আৰু উপভোক্তাৰ প্ৰফাইললৈ যাওক আৰু আপডেট কৰক।',
  'gru-take-tour.student-home.stepEight.title': 'সহায়',
  'gru-take-tour.student-home.stepEight.description':
    'সহায়তা কেন্দ্ৰ নাইবা লগআউট এক্সেছ কৰক।',
  'gru-take-tour.student-home.stepNine.title': 'ঘোষণাসমূহ',
  'gru-take-tour.student-home.stepNine.description':
    'ইয়াত আপুনি ঘোষণা সমূহ দেখিবলৈ পাব যি আপোনাৰ শিক্ষক নাইবা বিদ্যালয়ে জানিবলৈ বিছাৰে।',
  'gru-take-tour.student-home.stepTen.title': 'শ্ৰেণীকোঠাসমূহ',
  'gru-take-tour.student-home.stepTen.description':
    'সকলো শ্ৰেণীকোঠাসমূহেই দেখিব য\'ত আপুনি পঞ্জীভূত কৰিছিল।',
  'gru-take-tour.student-home.stepEleven.title': 'স্বাধীন শিকন',
  'gru-take-tour.student-home.stepEleven.description':
    'আপুনি বুকমাৰ্ক কৰা বিষয়বস্তৰ অন্বেষণ কৰক আৰু যাৰ বিষয়ে আপুনি আৰু অধিক শিকিবলৈ বিছাৰে।',
  'gru-take-tour.student-home.stepTwelve.title': 'শ্ৰেণীকোঠাত যোগদান কৰক',
  'gru-take-tour.student-home.stepTwelve.description':
    'এটা শ্ৰেণীকোঠাত যোগদান কৰিবলৈ শ্ৰেণীকোঠাৰ ক\'ডটো এন্টাৰ কৰক।',
  'gru-take-tour.student-home.stepThirteen.title': 'শেষ!',
  'gru-take-tour.student-home.stepThirteen.description':
    'এতিয়া আগবাঢ়ক আৰু সেই পাঠ্যক্ৰমত ক্লিক কৰক য\'ত আপুনি এটা শ্ৰেণীকোঠাত যোগদান কৰিবলৈ পঞ্জীয়ন কৰিছিল, নাইবা সেই সামগ্ৰীটো বিচাৰক য\'ট আপোনাৰ আগ্ৰহ আছে।',
  'gru-take-tour.student-performance.stepOne.title': 'স্বাগতম!',
  'gru-take-tour.student-performance.stepOne.description':
    'আপোনাৰ পাৰদৰ্শিতাৰ ডেছবৰ্ডলৈ আপোনাক স্বাগতম। আপুনি নিৰীক্ষণ কৰিব পাৰিব যে আপুনি সকলো শ্ৰেণী আৰু পাঠ্যক্ৰমত কেনেদৰে পাৰদৰ্শিতা দেখুৱাব পাৰিছে।',
  'gru-take-tour.student-performance.stepTwo.title': 'ফিল্টাৰ টেব',
  'gru-take-tour.student-performance.stepTwo.description':
    'ক্ৰিয়াকলাপ, কালদৈঘ্য, বিষয় আৰু পাঠ্যক্ৰমৰ দ্বাৰা আপোনাৰ পাৰদৰ্শিতা দেখুৱাবলৈ কাঁড় ডালত ক্লিক কৰক।',
  'gru-take-tour.student-performance.stepThree.title': 'উন্নীত ৰিপৰ্ট',
  'gru-take-tour.student-performance.stepThree.description':
    'এবাৰ যেতিয়া আপুনি আপোনাৰ ফিল্টাৰবোৰ চয়ন কৰে, তেতিয়া আপুনি প্ৰতিবেদন নিৰীক্ষণ কৰিবলৈ আপডেট ৰিৰ্পটত ক্লিক কৰক।',
  'gru-take-tour.student-performance.stepFour.title': 'ডাউনল\'দ/ছপা',
  'gru-take-tour.student-performance.stepFour.description':
    'আপোনাৰ প্ৰতিবেদন ডাউনল\'ড কৰক।',
  'gru-take-tour.student-performance.stepFive.title': 'শেষ!',
  'gru-take-tour.student-performance.stepFive.description':
    'আগবাঢ়ি যাওক আৰু আপোনাৰ পাৰদৰ্শিতা বিশ্লেষণ কৰক!',
  'gru-take-tour.student-class.stepOne.title': 'স্বাগতম!',
  'gru-take-tour.student-class.stepOne.description':
    'আপোনাৰ শ্ৰেণীকোঠালৈ স্বাগতম। ইয়াত আপুনি আপোনাৰ শ্ৰেণীৰ কাৰ্য্যাৱলী, ক\'ৰ্চ মেপ, আৰু পাৰদৰ্শিতাৰ ডাটা বিচাৰি পাব। ব\'লক আৰম্ভণি কৰো!',
  'gru-take-tour.student-class.stepTopBar.title':
    'পাঠ্যক্ৰম, পাৰদৰ্শিতা, সম্পাদন',
  'gru-take-tour.student-class.stepTopBar.description':
    'আপোনাৰ পাঠ্যক্ৰম আৰু এতিয়ালৈকে হোৱা পাৰদৰ্শিতাৰ সাৰংশ চাওঁক।',
  'gru-take-tour.student-class.stepTwo.title': 'শ্ৰেণী কাৰ্যকলাপ',
  'gru-take-tour.student-class.stepTwo.description':
    'আপোনাৰ শিক্ষকৰ দ্বাৰা অনুমোদন জনোৱা কৰ্মসমূহ আজিয়েই চাওঁক আৰু অধ্যয়ণ কৰক।',
  'gru-take-tour.student-class.stepThree.title': 'ক\'ৰ্চ মেপ',
  'gru-take-tour.student-class.stepThree.description':
    'পাঠ্যক্ৰমত সংগৃহীত আৰু মূল্যাংকণসমূহ সম্পূৰ্ণ কৰিবলৈ  গোটসমূহ আৰু পাঠসমূহত ক্লিক কৰক।',
  'gru-take-tour.student-class.stepFour.title': 'মোৰ ৰিপৰ্ট',
  'gru-take-tour.student-class.stepFour.description':
    'আপোনাৰ সমগ্ৰ শ্ৰেণীৰ পাৰদৰ্শিতাৰ পুনৰ্নিৰীক্ষণ কৰক।',
  'gru-take-tour.student-class.stepFive.title': 'শেষ!',
  'gru-take-tour.student-class.stepFive.description':
    'ক\'ৰ্চ মেপ নাইবা দৈনিক ক্ৰিয়াকলাপত ক্লিক কৰি পাঠ্যক্ৰম পঢ়িবলৈ আৰম্ভ কৰক।',
  'gru-take-tour.teacher-class.stepOne.title': 'স্বাগতম!',
  'gru-take-tour.teacher-class.stepOne.description':
    'আপোনাৰ শ্ৰেণীকোঠালৈ স্বাগতম। ইয়াত আমি আপোনাৰ দৈনিক শ্ৰেণীৰ ক্ৰিয়াকলাপ, ক\'ৰ্চ মেপ, উন্নীতকৰণ শ্ৰেণীৰ তথ্য আৰু শিক্ষাৰ্থীৰ পাৰদৰ্শিতা ডাটাৰ পুননিৰীক্ষণ কৰিব আৰু নিৰীক্ষণ কৰিবলৈ সক্ষম হ\'ম। আৰম্ভ কৰো ব\'লক!',
  'gru-take-tour.teacher-class.stepTopBar.title':
    'পাঠ্যক্ৰম, পাৰদৰ্শিতা, সম্পাদন',
  'gru-take-tour.teacher-class.stepTopBar.description':
    'আপোনাৰ পাঠ্যক্ৰম আৰু এতিয়ালৈকে সকলো ছাত্ৰ-ছাত্ৰীৰ পাৰদৰ্শিতাৰ সাৰংশ চাওঁক।',
  'gru-take-tour.teacher-class.stepTwo.title': 'দৈনিক শ্ৰেণীৰ কাৰ্য্যকলাপ',
  'gru-take-tour.teacher-class.stepTwo.description':
    'আপোনাৰ ছাত্ৰ-ছাত্ৰীৰ বাবে আজিৰ কাৰ্য্যকলাপ চাওঁক আৰু বন্টন কৰক।',
  'gru-take-tour.teacher-class.stepThree.title': 'ক\'ৰ্চ মেপ',
  'gru-take-tour.teacher-class.stepThree.description':
    'পাঠ্যক্ৰমত দিয়া গোটসমূহ, পাঠসমূহ, সংগ্ৰহ নাইবা বন্টনক নিৰীক্ষণ কৰক নাইবা সম্পাদন কৰক।',
  'gru-take-tour.teacher-class.stepFour.title': 'মোৰ ৰিপৰ্ট',
  'gru-take-tour.teacher-class.stepFour.description':
    'পাঠ্যক্ৰমত আপোনাৰ ছাত্ৰ-ছাত্ৰীয়ে কেনেদৰে পাৰদৰ্শিতা দেখুৱাইছে আৰু তেওঁলোকৰ প্ৰতিবেদনৰ সাৰংশ নিৰীক্ষণ কৰক।',
  'gru-take-tour.teacher-class.stepClassManagement.title':
    'শ্ৰেণী ব্যৱস্থাপনা ',
  'gru-take-tour.teacher-class.stepClassManagement.description':
    'আপোনাৰ শ্ৰেনীৰ তথ্য আৰু শ্ৰেণীত তালিকাভুক্ত ছাত্ৰ-ছাত্ৰী সকলক বন্টন নাইবা উন্নীত কৰক।',
  'gru-take-tour.teacher-class.stepFive.title': 'শেষ!',
  'gru-take-tour.teacher-class.stepFive.description':
    'এতি যাওঁক আৰু আপোনাৰ ছাত্ৰ-ছাত্ৰীৰ সৈতে শ্বেয়াৰ কৰক।',
  'gru-take-tour.study-player.stepOne.title': 'স্বাগতম!',
  'gru-take-tour.study-player.stepOne.description':
    'এইটো আপোনাৰ ষ্টাডি প্লেয়াৰ। আপোনাৰ সৈতে উপলব্ধ সুবিধাসমূহৰ জড়িয়তে আগবাঢ়ক।',
  'gru-take-tour.study-player.stepTwo.title': 'ক\'ৰ্চ মেপ',
  'gru-take-tour.study-player.stepTwo.description':
    'আপোনাৰ ক\'ৰ্চ মেপলৈ যিকোনো সময়তে যাবলৈ আইকনটোত  ক্লিক কৰক।',
  'gru-take-tour.study-player.stepThree.title': 'পাঠ্যক্ৰমৰ নাম',
  'gru-take-tour.study-player.stepThree.description':
    'আপুনি কাম কৰি থকা পাঠ্যক্ৰমক সূচায়।',
  'gru-take-tour.study-player.stepFour.title': 'পৰামৰ্শ',
  'gru-take-tour.study-player.stepFour.description':
    'বৰ্তমান আপুনি যি অধ্যয়ন কৰি আছে , তাৰ ওপৰত আধাৰিত অতিৰিক্ত সম্পদ আপুনি বিছাৰিব পাৰিব।',
  'gru-take-tour.study-player.stepFive.title': 'সম্পাদন',
  'gru-take-tour.study-player.stepFive.nuTitle': 'সামৰ্থ্যসমূহ',
  'gru-take-tour.study-player.stepFive.description':
    'আপুনি কিমান ক\'ৰ্চ সম্পূৰ্ণ কৰিলে তাক সূচায়।',
  'gru-take-tour.study-player.stepSix.title': 'প্ৰদৰ্শন',
  'gru-take-tour.study-player.stepSix.description':
    'পাঠ্যক্ৰমত আপুনি কেনে পাৰদৰ্ক্ষিতা দেখুৱায় তাক সূচায়।',
  'gru-take-tour.study-player.stepSeven.title': 'সম্পদৰ বাবে প্ৰতিক্ৰিয়া',
  'gru-take-tour.study-player.stepSeven.description':
    'আপোনাৰ শিক্ষকে জানিব বিচাৰিছে যে আপুনি এই সম্পদৰ বিষয়ে কি ভাৱে।',
  'gru-take-tour.study-player.stepEight.title': 'শেষ!',
  'gru-take-tour.study-player.stepEight.description': 'পঢ়িবলৈ আৰম্ভ কৰক!',
  'gru-take-tour.study-player.stepNine.title': 'পুনৰ চয়নলৈ',
  'gru-take-tour.study-player.stepNine.description':
    'আপোনাৰ চয়ন নাইবা মূল্য়াংকনলৈ উভতি যাবলৈ আইকনটোত ক্লিক কৰক।',
  'gru-take-tour.library.stepOne.title': 'স্বাগতম!',
  'gru-take-tour.library.stepOne.description':
    'লাৰনিং নেভিগেটৰৰ পুথিভঁৰাললৈ আপোনাক স্বাগতম।',
  'gru-take-tour.library.stepTwo.title': 'আনুষংগিক পাঠ্য়ক্ৰমসমূহ',
  'gru-take-tour.library.stepTwo.description':
    'শিক্ষকৰ দ্বাৰা শ্ৰেণীকোঠাত বিকশিত আৰু বাস্তৱায়িত পাঠ্যক্ৰমৰ অন্ব্ষণ কৰক।',
  'gru-take-tour.library.stepThree.title': 'অন্য পুথিভঁৰাল সমূহ',
  'gru-take-tour.library.stepThree.description':
    'গুৰুৰ অংশীদাৰীৰ দ্বাৰা বিকশিত সামগ্ৰীৰ অন্বেষণ কৰক।',
  'gru-take-tour.library.stepFour.title': 'পূৰ্বদৰ্শন',
  'gru-take-tour.library.stepFour.description':
    'আপোনাৰ আগ্ৰহ চাবলৈ পাঠ্যক্ৰমটো পূৰ্বদৰ্শন কৰা হয়।',
  'gru-take-tour.library.stepFive.title': 'শ্বেয়াৰ কৰক',
  'gru-take-tour.library.stepFive.description':
    'বেলেগৰ সৈতে এই পাঠ্যক্ৰমটো শ্বেয়াৰ কৰক।',
  'gru-take-tour.library.stepSix.title': 'বুকমাৰ্ক',
  'gru-take-tour.library.stepSix.description':
    'এই পাঠ্যক্ৰমটো পাছত পুননিৰীক্ষণ কৰিবলৈ বুকমাৰ্ক কৰক।',
  'gru-take-tour.profile.stepOne.title': 'স্বাগতম!',
  'gru-take-tour.profile.stepOne.description':
    'আপোনাৰ প্ৰফাইললৈ স্বাগতম। ইয়াত আপুনি আপোনাৰ বিষয়বস্ত, ব্যক্তিগত তথ্য, আৰু অনুগামী সকলৰ বিষয়ে এক্সেছ কৰিব পাৰিব।',
  'gru-take-tour.profile.stepTwo.title': 'মোৰ বিষয়বস্তু ',
  'gru-take-tour.profile.stepTwo.description':
    'নতুন তালিকা তৈয়াৰ কৰক আৰু আপুনি ৰিমিক্স কৰা তালিকাসমূহ নিৰীক্ষণ কৰক।',
  'gru-take-tour.profile.stepThree.title': 'মোৰ বিষয়ে',
  'gru-take-tour.profile.stepThree.description':
    'আপোনাৰ ব্যক্তিগত তথ্য, বিদ্যালয়ৰ তথ্য আৰু আপোনাৰ প্ৰফাইলৰ ছবি উন্নীত কৰক।',
  'gru-take-tour.profile.stepFour.title': 'লক্ষ্যসমূহ',
  ...
  'gru-tour.assessments-settings.stepOne.title': 'নেভিগেছন আৰু স্ক\'ৰিং',
  'gru-tour.assessments-settings.stepOne.description':
    'এই চেটিংটোৱে নিৰ্ধাৰণ কৰে ছাত্ৰ-ছাত্ৰীসকলে এটা মূল্যায়ন কেনেকৈ কৰিব আৰু দেখুৱায় তেওঁলোকৰ উত্তৰবোৰ শুদ্ধ নে ভুল। ই তেওঁলোকক উত্তৰ কী নেদেখুৱায়।',
  'gru-tour.assessments-settings.stepTwo.title': 'উত্তৰ কী আৰু প্ৰয়াসৰ সংখ্যা',
  'gru-tour.assessments-settings.stepTwo.description':
    'এই চেটিংটোৱে এটা উত্তৰ কী ওলাই পৰাৰ সুদিধা প্ৰদান কৰে আৰু ছাত্ৰ-ছাত্ৰীসকলে মূল্যায়নত দিয়া প্ৰয়াসৰ সংখ্যা ঠিক কৰে।',
  'gru-tour.overview.stepOne.title': 'ক\'ৰ্চ মেপ',
  'gru-tour.overview.stepOne.description':
    'কাৰ্যক্ৰম মেপখনে আপোনাৰ ছাত্ৰ-ছাত্ৰীসকলক আপুনি তেওঁলোকক কৰিবলৈ দিয়া সকলো মূল্যায়ন আৰু সংকলনবোৰ চাব পাৰে।',
  'gru-tour.overview.stepTwo.title': 'শ্ৰেণী মান',
  'gru-tour.overview.stepTwo.description':
    'আপুনি সৃষ্টি কৰা প্ৰতিটো শ্ৰেণিকোঠাৰ এটা বিশিষ্ট কোড আছে। ছাত্ৰ-ছাত্ৰীসকলে আপোনাৰ শ্ৰেণীকোঠাত অংশগ্ৰহণ কৰিবলৈ সাজু হোৱাৰ পাচত আপুনি তেওঁলোকক এই কোডটো দিব আৰু আপোনাৰ বিষয়বস্তু চব পাৰিব।',
  'gru-tour.overview.stepThree.title': 'ছাত্ৰ-ছাত্ৰী আৰু শ্ৰেণীৰ ওপৰত চকু ৰাখক',
  'gru-tour.overview.stepThree.description':
    'ই আপোনাৰ শ্ৰেণী আৰু প্ৰতিটো ছাত্ৰৰ মূল্যায়নৰ ডাটা চোৱাৰ সুবিধা প্ৰদান কৰে যেতিয়া ছাত্ৰসকলৰ কাৰ্যক্ৰমত অংশ হিচাপে থকা মূল্যায়নবোৰ সম্পূৰ্ণ কৰে।',
  'gru-tour.overview.stepFour.title': 'শ্ৰেণীকোঠাৰ তথ্য',
  'gru-tour.overview.stepFour.description':
    'ইয়াত আপুনি অপওনাৰ শ্ৰেণীকোঠাৰ নাম সম্পাদনা কৰিব পাৰে, আপোনাৰ ছাত্ৰ-ছাত্ৰীৰ বাবে জানানী পষ্ট কৰিব পাৰে, আপোনাৰ শ্ৰেণীত নামাংকন কৰাৰ ছাত্ৰ-ছাত্ৰীৰ নাম চাব পাৰে আৰু আপোনাৰ শ্ৰেণীকোঠা বিলোপ কৰিব পাৰে।',
  'gru-tour.overview.stepFive.title':
    'আপোনা কাৰ্যক্ৰমৰ বিষয়বস্তুক সম্পাদনা কৰা হৈছে',
  ...
  'gru-tour.real-time.stepTwo.title': 'ব্যক্তিগত ছাত্ৰ-ছাত্ৰীৰ ডাটা ',
  'gru-tour.real-time.stepTwo.description':
    'ব্যক্তিগত ছাত্ৰ-ছাত্ৰীৰ ডাটা প্ৰতিবেদনসমূহ চাবলৈ প্ৰত্যেকজন ছাত্ৰ-ছাত্ৰীয়ে টাইলৰ বাচনি কৰক।',
  'gru-tour.real-time.stepThree.title': 'এটা ভিউ বাচনি কৰক',
  'gru-tour.real-time.stepThree.description':
    'ডাটা  দেখুৱাবলৈ বিকল্পসমূহ চাবলৈ "title view" নাইবা "list view" বাছি লওক।',
  'gru-tour.real-time.stepFour.title': 'গড় সংখ্যা',
  'gru-tour.real-time.stepFour.description':
    'সকলো প্ৰতিক্ৰিয়াৰ বাবে বাস্তৱিক সময়ত গণনা কৰা শ্ৰেণীৰ গড় মান চাওক।',
  'gru-tour.real-time.stepFive.title': 'প্ৰ\'জেক্ট এন\'নিমাছ ডাটা',
  'gru-tour.real-time.stepFive.description':
    'ছাত্ৰ-ছাত্ৰীৰ বেনামী দৃশ্যক প্ৰকল্প কৰিবলৈ এই বিকল্পটো ব্যৱহাৰ কৰক।',
  'gru-course-play.hide-unit-details': 'ইউনিট মেটাডাটা লুকুৱাওক',
  'gru-course-play.view-unit-details': 'ইউনিট মেটাডাটা চাওঁক',
  'gru-course-play.performance': 'প্ৰদৰ্শন',
  'gru-century-skills.legends.hewlett': 'হেৱলেট ডীপাৰ লাৰ্নিং মডেল',
  'gru-century-skills.legends.conley': 'ক\'নলি ফ\'ৰ কী',
  'gru-century-skills.legends.framework': 'P21 ফ্ৰেমৱৰ্ক',
  'gru-century-skills.legends.national':
    'জীৱন আৰু কৰ্মৰ বাবে ৰাষ্ট্ৰীয় গৱেষণা কেন্দ্ৰ',
  'gru-century-skills.content.groups.cognitive':
    'প্ৰমুখ চিন্তাশীল দক্ষতা আৰু ৰণনীতিসমূহ',
  'gru-century-skills.content.groups.content': 'মূখ্য বিষয়বস্তৰ জ্ঞান',
  'gru-century-skills.content.groups.learning':
    'মূখ্য শিক্ষাৰ দক্ষতা আৰু কৌশলসমূহ',
  ...
  'gru-rubric-creation.gru-preview-url.preview':
    'ওপৰত নিৰ্দেশনাৱলীখন অৰ্ন্তভূক্ত কৰক আৰু ইয়াত পুননিৰীক্ষণ কৰক',
  'gru-rubric-creation.overall-narrative': 'মুঠ মৌখিক মতামত',
  'gru-rubric-creation.feedback-guidance': 'মতামতৰ নিয়মাৱলী',
  'gru-rubric-creation.required-feedback': 'মতামতৰ প্ৰয়োজন',
  'gru-rubric-creation.feedback-guidance-placeholder':
    'ৰচনাখনৰ ওপৰত আপোনাৰ সঁহাৰি সম্পূৰ্ণৰুপে সাৰাংশিত কৰক।',
  'gru-rubric-creation.gru-category.category-title': 'বৰ্গৰ শিৰোনাম',
  'gru-rubric-creation.gru-category.category-feedback':
    'প্ৰাক্তন। আপুনি যেতিয়া এই বৰ্গৰ পুননিৰীক্ষণ কৰে, লেখকৰ উদ্দেশ্যলৈ সাৱধানেৰে মনোযোগ দিব। ',
  'gru-rubric-creation.gru-category.gru-scoring-levels.0':
    'উদাহৰণ: অতিমাত্ৰাধিক দক্ষতা',
  'gru-rubric-creation.gru-category.gru-scoring-levels.1':
    'উদাহৰণ: সমাৱেশ দক্ষতা',
  'gru-rubric-creation.gru-category.gru-scoring-levels.2':
    'উদাহৰণ: ওচৰৰ দক্ষতা',
  'gru-rubric-creation.gru-category.gru-scoring-levels.3':
    'উদাহৰণ: আৰম্ভণিৰ দক্ষতা',
  'gru-rubric-creation.gru-category.gru-scoring-levels.4':
    'উদাহৰণ: দক্ষতাৰ কোনো প্ৰমাণ নাই',
  'gru-rubric-creation.gru-category.gru-scoring-levels.best': 'উত্তম',
  'gru-rubric-creation.gru-category.gru-scoring-levels.levels': 'স্তৰ',
  'gru-rubric-creation.gru-category.gru-scoring-levels.new-level':
    'এক নতুন স্তৰ যোগ কৰক',
  'gru-rubric-creation.gru-category.gru-scoring-levels.scoring': 'সাফল্য়াংক',
  'gru-rubric-creation.gru-category.gru-scoring-levels.worst': 'নিকৃষ্টতম',
  'gru-rubric-creation.gru-category.gru-scoring-levels.name-error':
    'অনুগ্ৰহ কৰি স্তৰৰ শিৰোনাম এন্টাৰ কৰক।',
  'gru-rubric-creation.gru-category.gru-scoring-levels.score-error':
    'অনুগ্ৰহ কৰি নম্বৰৰ মান এন্টাৰ কৰক।',
  'gru-rubric-creation.gru-category.gru-scoring-levels.no-levels-error':
    'অনুগ্ৰহ কৰি অন্ততঃ এটা স্তৰৰ বাবে মান ধাৰ্য্য কৰক।',
  'library.browse-library': 'পুথিভঁৰাল ব্ৰাউজ কৰক',
  'library.featured-courses': 'আনুষংগিক পাঠ্য়ক্ৰমসমূহ',
  'library.gru-library-card.featured-course': 'বিশেষ ৰূপৰ পাঠ্যক্ৰম',
  'library.gru-partner-library-card.course.zero': '{{count}} পাঠ্যক্ৰম',
  'library.gru-partner-library-card.course.one': '{{count}} পাঠ্যক্ৰম',
  'library.gru-partner-library-card.course.other': '{{count}} পাঠ্যক্ৰমসমূহ',
  'library.gru-partner-library-card.collection.zero': '{{count}} সংগ্ৰহ',
  'library.gru-partner-library-card.collection.one': '{{count}} সংগ্ৰহ',
  'library.gru-partner-library-card.collection.other': '{{count}} সংগৃহীত সমূহ',
  'library.gru-partner-library-card.assessment.zero': '{{count}}মূল্যাংকণ',
  'library.gru-partner-library-card.assessment.one': '{{count}}মূল্যাংকণ',
  'library.gru-partner-library-card.assessment.other':
    '{{count}}মূল্যাংকণ সমূহ',
  'library.gru-partner-library-card.resource.zero': '{{count}} সামগ্ৰী',
  'library.gru-partner-library-card.resource.one': '{{count}} সামগ্ৰী',
  'library.gru-partner-library-card.resource.other': '{{count}} সামগ্ৰীসমূহ',
  'library.gru-partner-library-card.question.zero': '{{count}} প্ৰশ্ন',
  'library.gru-partner-library-card.question.one': '{{count}} প্ৰশ্ন',
  'library.gru-partner-library-card.question.other': '{{count}} প্ৰশ্নসমূহ',
  'library.gru-partner-library-card.rubric.zero': '{{count}} নিৰ্দেশনা',
  'library.gru-partner-library-card.rubric.one': '{{count}} নিৰ্দেশনা',
  ...
  'gru-study-header.check-usage': 'আপোনাৰ ব্যৱহীত প্ৰতিবেদন নিৰীক্ষণ কৰক',
  'gru-study-header.no-suggestions':
    'আপোনাৰ শিক্ষাৰ কাৰণে আমি অতি উত্তম পৰামৰ্শৰ বাবে কাম কৰি আছো',
  'gru-study-header.resource.zero': 'সম্পদ',
  'gru-study-header.resource.one': 'সম্পদ',
  'gru-study-header.resource.other': 'সম্পদবোৰ',
  ...
  'gru-suggest-test.post-test-header': 'পৰীক্ষাৰ পাছত (বৈকল্পিক)',
  'gru-suggest-test.backfill-header': 'পৰামৰ্শৰ চয়ন (বৈকল্পিক)',
  'gru-suggest-test.benchmark-header': 'বুকমাৰ্ক-টেষ্ট (বৈকল্পিক)',
  'gru-suggest-test.resource-header': 'পৰামৰ্শৰ প্ৰতিবেদন (বৈকল্পিক)',
  'gru-suggest-test.signature_collection-header': 'পৰামৰ্শৰ চয়ন (বৈকল্পিক)',
  'gru-suggest-test.signature_collection-lead':
    'এই কাৰ্যক্ৰমটোত আপোনাৰ প্ৰদৰ্শনৰ ওপৰত ভিত্তি কৰি, তলত দিয়া সংকলনটোৱে আপোনাৰ বুজাৰ মাত্ৰা বঢ়াব পাৰে।',
  ...
  'gru-suggest-test.backfill-lead':
    'আপোনাৰ প্ৰি-টেষ্টৰ উত্তৰবিলাকৰ ওপৰত ভিত্তি কৰি, পাঠটো আৰম্ভ কৰাৰ আগত অতিৰিক্ত বস্তু পুনৰীক্ষণ কৰিলে সহায় পাব। সহায়ৰ বিষয়বস্তু পুনৰীক্ষণ কৰিলে ছাত্ৰ-ছাত্ৰীসকলে নতু বস্তু শিকিবলৈ সহায় পায়।',
  'gru-suggest-test.benchmark-lead':
    'আপুনি এতিয়া আপোনাৰ বুজাৰ ক্ষমতা এটা বেঞ্চমাৰ্ক মূল্যায়ন কৰি দেখুৱাবলৈ সাহ্য। বেঞ্চমাৰ্কটো সফলতাৰে সম্পূড়ন কৰাৰ বাবে আপুনি এটা বেজ পাব, বেঞ্চমাৰ্কে আপোনাৰ কাৰ্যক্ৰম ওৰদৰ্শন স্কোৰৰ ওপৰত কোনো প্ৰভাৱ নেপেলায়।',
  'gru-suggest-test.resource-lead':
    'আপোনাৰ পাৰদৰ্শিতা এই পাঠ্যক্ৰমৰ ওপৰত ভিত্তি কৰি, নিম্নলিখিত সামগ্ৰীয়ে যথাসম্ভৱ আপোনাৰ বুজি পোৱাত সহায়ক হ\'ল।',
  'gru-suggest-test.no': 'নহয়, ধন্যবাদ',
  'gru-suggest-test.no-suggestions': 'এইয়া হৈছে আপোনাৰ পাৰদৰ্শিতাৰ সাৰংশ',
  'gru-suggest-test.take': '{{type}} লওক',
  'gru-suggest-test.take-signature-collection': 'প্ৰস্তাবিত সংকলন পঢ়ক',
  'gru-suggest-test.take-signature-assessment': 'প্ৰস্তাবিত মূল্যায়ন পঢ়ক',
  'gru-suggest-test.take-backfill-pretest': 'প্ৰস্তাবিত সংকলন পঢ়ক',
  'gru-suggest-test.take-resource': 'সম্পদ পঢ়ক',
  'gru-suggest-test.end-of-course': 'আপুনি কাৰ্যক্ৰমটোৰ শেষ পালেহি।',
  'gru-content-suggestion.header': 'আমাৰ সৈতে আপোনাৰ বাবে এটা পৰামৰ্শ আছে!',
  'gru-content-suggestion.suggestion-text.collection':
    'এই বিষয়ৰ আপুনি কৰা প্ৰদৰ্শৰ ওপৰত ভিত্তি কৰি আমি আপোনাক আমাৰ প্ৰস্তাৱিত সংকলন পঢ়িবলৈ পৰামৰ্শ দিছোঁ যাতে আপুনি পাৰদৰ্শিতা লাভ কৰা সহায় পায়।',
  'gru-content-suggestion.suggestion-text.assessment':
    'এই বিষয়ৰ আপুনি কৰা প্ৰদৰ্শৰ ওপৰত ভিত্তি কৰি আমি আপোনাক আমাৰ প্ৰস্তাৱিত মূল্যায়ন পঢ়িবলৈ পৰামৰ্শ দিছোঁ যাতে আপুনি পাৰদৰ্শিতা লাভ কৰা সহায় পায়।',
  'student-open-ended-summary.overall-comment': 'মুঠ মন্তব্য',
  'student-open-ended-summary.overall-score': 'সৰ্বমুঠ নম্বৰ',
  'student-open-ended-summary.prompt': 'প্ৰশ্ন প্ৰম্পট ',
  ...
  'report.competency-report.no-subject': 'কোনো বিষয় বন্টন কৰা নাই',
  'report.competency-report.prerequisites': 'পূৰ্বাৱশ্যকীয়',
  'report.competency-report.signature-assessments': 'স্বাক্ষৰ মূল্যাংকন',
  'report.competency-report.signature-collections': 'স্বাক্ষৰ চয়ন',
  ...
  'self-report.validation-error-time': 'বৈধ তাৰিখ এন্টাৰ কৰক',
  'notifications.notificationlist-header-title': 'জাননী',
  'notifications.show-more': 'আৰু দেখাওক',
  'notifications.type.teacher-suggestion-title':
    'শ্ৰেণীত আপোনাৰ বাবে নতুন শিক্ষকৰ প্ৰস্তাব আছে : {{ classTitle }}',
  ...
  'notifications.type.teacher-grading-complete-title':
    'শিক্ষকে শ্ৰেণীকোঠাত আপোনাৰ আনুগত্যক শ্ৰেণীবদ্ধ কৰিলে : {{ classTitle }}',
  'notifications.typeinclass.teacher-suggestion-title':
    'আপোনাৰ ওচৰত  শিক্ষকৰ এক নতুন পৰামৰ্শ আছে।',
  'notifications.typeinclass.student-gradable-submission-title':
    'শ্ৰেণীত গ্ৰেড দিবলৈ আপোনাৰ {{occurrence}}টা ছাত্ৰৰ বস্তু আছে : {{ classTitle }}',
  'notifications.typeinclass.student-self-report-title':
    '{{occurrence}} ছাত্ৰ-ছাত্ৰী(সকল) য়ে পাৰদৰ্ক্ষিতাৰ প্ৰতিবেদন দিলে',
