...
export default Object.assign(quizzesTranslations, {
  ...
  'errors':{  
   ...
   'common':{  
      ...
      'no-suggest-results-message':'You can search and  find the related content.',
      'no-suggest-search-results-message':'Check your spelling. We all make mistakes! Or try searching for a similar word instead.',
      ...
      'contentUnavailabletoday':'No current activities. Add Daily Class Activities from the Course Map or My Content.',
      ...
      'errors':{  
         ...
         'getting-next-resource':'There was an error submitting your answer. Please try again.',
      ...
      'no-content-my-report':'No reports available yet. Once you begin studying, your reports will become available.',
      ...
      'no-dca-student':'Your teacher has not yet assigned any collections or assessments to Daily Class Activities.',
      'no-dca-teacher':'No current activities. Add Daily Class Activities from the Course Map or My Content.',
      'notScored':'Unscored',
      ...
      'studen-id-display':'Student ID (not displayed on Profile, displayed in Anonymous mode)',
   ...
   'class':{  
      ...
      'overview':{  
         ...
         'course-map':{  
            ...
            'rescope-info':'This Navigator course is a personalized course covering standards across multiple grades. Each student is provided a unique course to help fill gaps, reinforce concepts and practices, and accelerate their learning. Personalized routes are designed and students are re-routed in real-time to maximize each student\'s learning potential and to navigate to their set destination.',
            'custom-msg':'We are personalizing this course specifically for you based on your proficiency. Please check back in a little while to see the personalized course map.',
            'route0-bannerdesc':'As per your competency profile, there are some competencies that you need to master so that you can do well in this course. We have a route that we recommend you take to master these competencies. Click here to see the details.'
         }
      },
      'analytics':{  
         'performance':{  
   ...
   'content':{  
      ...
      'classes':{  
         ...
         'join':{  
            ...
            'join-not-allowed':'The class you are trying to join is no longer active. Please contact your teacher for the correct class code.',
      ...
      'modals':{  
         ...
         'delete-rubric':{  
            ...
            'delete-error':'Oops! Unable to delete Rubric right now. Please try again shortly.',
            'confirmation':'Are you sure you want to continue? Please click “Permanently Delete”.',
            'first-check':'This is a permanent delete and cannot be undone'
         },
         'remove-content':{  
   ...
   'student-landing':{  
      ...
      'no-content-classrooms':'This classroom currently has no content available',
   ...
   'student-independent-learning':{  
      ...
      'no-bookmarks':'When you start bookmarking Courses, Collections, and Assessments, they will appear here.',
   ...
   'teacher-landing':{  
      ...
      'dca-create-info':'Click on the icons below and search for content from the Gooru Library to create a daily class activity. You can also add content to daily class activity from your course map by clicking on Course Map.',
      'schedule-for-later':'Schedule For Later',
      'teach-this-activity-later':'teach this activity later at DCA',
      'schedule-dca-instruction-1':'Pick a later date on which to teach this activity.',
      'schedule-dca-instruction-2':'This activity will appear at DCA for the chosen date.',
      'navigator-banner':{  
      ...
      'class':{  
         ...
         'class-activities-tab':{  
            ...
            'welcome-dca':'Welcome to your Daily Class Activities where you can assign collections and assessments for students to complete today. Please note: any reports generated will only be available today for the most recent attempt.'
         },
      ...
      'welcome-course-map':'This is your Course Map where you can view course content, turn assessments on or off and launch assessments in real-time. You can also view overall class performance and completion. For a detailed view of class performance, visit your classroom\'s Report tab.',
      'welcome-rescoped-course-map':'This course has been personalized for each student in the class. You can view each student’s course map in the Class Management page by clicking on the student’s learning pathway ("->")',
      'welcome-premium-course-map':'This Navigator course is a personalized course covering standards across multiple grades. Each student is provided a unique course to help fill gaps, reinforce concepts and practices, and accelerate their learning. Personalized routes are designed and students are re-routed in real-time to maximize each student\'s learning potential and to navigate to their set destination.'
   },
   'goals':{  
      'manage':{  
         'title':'My Goals!',
   ...
   'gru-add-rubric-to-question':{  
      ...
      'no-rubrics':'You have not yet created any rubrics that can be attached to this Free Response Question. You can create rubrics under My Content which can be accessed from your profile.',
   ...
   'profile':{  
      ...
      'proficiency':{  
         'is-empty':'No data available yet. Once you begin studying, your data will become available.',
   ...
   'gru-take-tour':{  
      ...
      'teacher-home':{  
         ...
         'stepEleven':{  
            ...
            'description':'Name your classroom and click the button to create a new classroom.'
         }
      },
      'student-home':{  
         'stepOne':{  
            'title':'Take a Tour',
            'description':'Welcome to Take a Tour and your homepage! Let’s walk through the features available to you on your homepage.'
         },
         'stepFeaturedCourses':{  
            'title':'Featured Courses',
            'description':'Browse the featured courses in the Learning Navigator’s content catalog for topics that interest you.'
         },
         'stepTwo':{  
            'title':'Logo',
            'description':'Clicking on the logo returns you to your homepage.'
         ...
         'stepFive':{  
            'title':'Library',
            'description':'Browse the Learning Navigator’s featured courses and partner libraries for topics that interest you.'
         },
         'stepSix':{  
            'title':'Performance',
         ...
         'stepEleven':{  
            ...
            'description':'Explore the topics you have bookmarked and that you want to learn more about.'
         },
         'stepTwelve':{  
      ...
      'student-class':{  
         ...
         'stepTopBar':{  
            ...
            'description':'See a summary of your course and overall performance so far.'
         },
         'stepTwo':{  
            'title':'Daily Class Activities',
            'description':'Access and study today’s activities assigned by your teacher.'
         },
         'stepThree':{  
            'title':'Course Map',
         ...
         'stepFive':{  
            'title':'Finished!',
            'description':'Start studying the course by clicking on the Course Map or Daily Activities.'
         }
      },
      'teacher-class':{  
         'stepOne':{  
            'title':'Welcome!',
            'description':'Welcome to your classroom. Here you will we be able to view and assign your daily class activities, course map, update class information and review student performance data. Let’s get started!'
         },
         'stepTopBar':{  
            'title':'Course, Performance, Completion',
            'description':'See a summary of your course and overall student performance so far.'
         },
         'stepTwo':{  
            'title':'Daily Class Activities',
         ...
         'stepThree':{  
            'title':'Course Map',
            'description':'View or edit the units, lessons, collections or assessments assigned in the course.'
         },
         'stepFour':{  
            'title':'My Report',
            'description':'View the summary of how your students are performing in the course and access their reports.'
         },
         'stepClassManagement':{  
            'title':'Class Management',
            'description':'Assign or update your class information and students enrolled in the class.'
         },
         'stepFive':{  
            'title':'Finished!',
      ...
      'study-player':{  
         ...
         'stepTwo':{  
            'title':'Course Map',
            'description':'Click on the icon at any time to return to your Course Map.'
         },
         'stepThree':{  
            'title':'Course Name',
         ...
         'stepFour':{  
            'title':'Suggestions',
            'description':'Additional resources you may want to explore based on what you are currently studying.'
         },
         'stepFive':{  
            'title':'Completion',
         ...
         'stepNine':{  
            ...
            'description':'Click on the icon at any time to return to your Collection or Assessment.'
         }
      },
      'library':{  
         'stepOne':{  
      ...
      'profile':{  
         'stepOne':{  
            'title':'Welcome!',
            'description':'Welcome to your Profile. Here you can access your content, personal information and followers.'
         },
         'stepTwo':{  
            'title':'My Content',
         ...
         'stepThree':{  
            'title':'About Me',
            'description':'Update your personal information, school information and your profile picture.'
         },
         'stepFour':{  
            'title':'Goals',
   ...
   'gru-rubric-edit':{  
      ...
      'copy':{  
         'success-message':'You\'ve copied rubric {{title}}. Do you want to edit that Rubric?'
      }
   },
   'gru-rubric-creation':{  
      'url':'URL',
   ...
   'gru-study-header':{  
      ...
      'no-suggestions':'We\'re working on the best suggestions to support your learning',
      'resource':{  
         'zero':'Resource',
         'one':'Resource',
         'other':'Resources'
   ...
   'gru-suggest-test':{  
      ...
      'signature_collection-lead':'Based on your performance on this course, the following collection may enhance your understanding.',
      'signature_assessment-header':'Suggested Assessment (Optional)',
      'signature_assessment-lead':'Based on your performance on this course, the following assessment may enhance your understanding.',
   ...
   'gru-content-suggestion':{  
      ...
      'suggestion-text':{  
         'collection':'Based on your performance on this topic, we recommend that you go through our suggested collection to help you gain mastery.',
         'assessment':'Based on your performance on this topic, we recommend that you go through our suggested assessment to help you gain mastery.'
      }
   },
   ...
   'gru-performance-chart':{  
      'teacher-tooltip':'of your students have completed all the assessments in this lesson'
   },
   'report':{  
   ...
   'notifications':{  
      ...
      'show-more':'SHOW MORE',
      'type':{  
         'teacher-suggestion-title':'You have a new teacher suggestion in class : {{ classTitle }}',
         'student-gradable-submission-title':'You have {{occurrence}} item(s) to grade in class : {{ classTitle }}',
         'student-self-report-title':'{{occurrence}} Student(s) reported performance at class : {{ classTitle }}',
         'teacher-override-title':'Teacher has corrected your submission at class : {{ classTitle }}  ',
         'teacher-grading-complete-title':'Teacher has graded your submission at class : {{ classTitle }}'
      },
      'typeinclass':{  
         'teacher-suggestion-title':'You have a new teacher suggestion',
         'student-gradable-submission-title':'You have {{occurrence}} student item(s) to grade',
         'student-self-report-title':'{{occurrence}} Student(s) reported performance',
         'teacher-override-title':'Teacher has corrected your submission',
         'teacher-grading-complete-title':'Teacher has graded your submission at class'
      }
   }
});
