...
export default Object.assign(quizzesTranslations, {
  ...
  'common': {
    ...
    'no-lesson-info-message': 'इस इकाई में कोई पाठ नही है।',
    'no-collection-info-message': 'इस पाठ में कोई संग्रह नहीं है।',
    'gooru-suggestions': 'Gooru सुझाव',
    'gooru-catalog': 'Gooru Catalog',
    'suggestion-made-to': 'सुझाव दिया गया',
    'student-selected': 'छात्र चुने गए',
    'no-suggest-result-message': ' कोई मिलान सामग्री नहीं मिली',
    ...
    'no-unschedule-items': 'आपके पास कोई भी ऐसी गतिविधि नहीं है जिसके लिए शेड्यूलिंग की आवश्यकता हो',
    'repeat-activity': 'दोहराने की गतिविधि',
    ...
    'add-coruse-to-class': 'पाठ्यक्रम जोड़ें',
    ...
    'answer-key-was-hidden': 'नोट: आपके शिक्षक ने उत्तर कुंजी ढक दी है।',
    ...
    'self-graded': 'आत्म श्रेणीबद्ध',
    'rubric-grade': 'रूब्रिक ग्रेड',
    'brief': 'संक्षिप्त करें',
    'update-grade-score': 'अपने फ्रैक को पूरा करने के लिए ग्रेड स्कोर अपडेट करें।',
    'answer-this-rubric': 'अपने फ्रिक को पूरा करने के लिए इस रुब्रिक का उत्तर दें।',
    'all-caught-up': 'आप सभी पकड़े गए हैं!',
    'no-users-to-grade': 'इस frq के लिए ग्रेड करने के लिए कोई उपयोगकर्ता नहीं हैं।',
    ...
    'delete-instructions': {
      ...
      'content-inaccessible': 'सभी सामग्री इसके साथ जुड़े हुए कक्षा खण्डों  के लिए दुर्गम होगी'
    },
    ...
    'drag-drop-suggestions': 'या  खींचें और सुझाव छोड़ें ...',
    ...
    'errors': {
      ...
      'add-question-answer-text': 'कृपया पसन्द का उत्तर  टेक्स्ट दर्ज करें।',
      ...
      'class-min-score': 'न्यूनतम स्कोर 1 और 100 के बीच की एक संख्या होनी चाहिए',
      ...
      'reset-password-error': ' ओह! कुछ ठीक नहीं है। पासवर्ड रीसेट करने में असमर्थ। कृपया जल्द ही पुनः प्रयास करें।',
      ...
      'resource-invalid-url': 'अमान्य यूआरएल।',
      ...
      'sign-in-credentials-not-valid': 'ओह! कुछ ठीक नहीं है। कृपया अपना उपयोगकर्ता नाम और पासवर्ड दोबार जांचें और पुनः प्रयास करें।',
      ...
      'sign-up-first-name': 'कृपया अपना प्रथम  नाम  अंकित करें।',
      ...
      'sign-up-valid-email': 'कृपया एक  मान्य ई - मेल एड्रेस डालें।',
      ...
      'no-studymaterial': 'इस वर्ग को सौंपा गया पाठ्यक्रम इसमें कोई अध्ययन सामग्री नहीं है इसे ठीक करने के लिए कृपया अपने शिक्षक से संपर्क करें'
    },
    ...
    'no-followers': 'आपके पास अभी तक अनुसरण करने वाले नहीं हैं।',
    ...
    'no-results-message': 'अपनी स्पैलींग की जाँच करें। हम सभी गलतियां करते हैं! <br/> विस्तार में जाएं और कुछ फ़िल्टर हटा दें। <br/> या इसके बजाय एक समान शब्द खोजने की कोशिश करें।',
    ...
    'nothing-to-display': 'प्रदर्शित करने के लिये कुछ नहीं।',
    'number': 'नहीं।',
    'numberStudents': {
      'zero': '{{गिनती}} छात्र',
      'one': '{{गिनती}} छात्र',
    ...
    'publish-to': ' इसे मेरे प्रोफाइल लाइब्रेरी पर दूसरों के लिए प्रकट बनाएं',
  ...
  'not-found': {
    'tenant': {
      'login-not-found-msg-1': 'gooru किरायेदार लॉगिन नहीं मिला, पृष्ठ स्वचालित रूप से रीडायरेक्ट हो जाएगा',
      'login-not-found-msg-2': 'लॉगिन पेज में',
      'login-not-found-msg-3': 'सेकंड या नीचे दिए गए बटन पर क्लिक करके लॉगिन करें'
    }
  },
  'index': {
  ...
  'content': {
    ...
    'classes': {
      ...
      'join': {
        ...
        'join-not-allowed': 'जिस कक्षा में आप शामिल होने का प्रयास कर रहे हैं वह अब सक्रिय नहीं है। सही कक्षा कोड के लिए कृपया अपने शिक्षक से संपर्क करें।',
  ...
  'student-landing': {
    ...
    'no-classrooms': 'आप अभी तक किसी भी कक्षा में शामिल नहीं हुए हैं। अपने शिक्षक की कक्षा को जोड़ने के लिए \"कक्षा में </br> शामिल हों\" पर क्लिक करें। आप लाइब्रेरी टैब के नीचे </br> एक फीचर्ड पाठ्यक्रम भी खोज सकते हैं।',
    'no-content-classrooms': 'इस कक्षा में वर्तमान में कोई सामग्री उपलब्ध नहीं है',
    'welcome': 'Gooru में आपका स्वागत है।',
    'no-course-assigned': 'इस वर्ग को अभी तक कोई पाठ्यक्रम नहीं सौंपा गया है। कृपया अपने शिक्षक से संपर्क करें।'
  },
  ...
  'teacher-landing': {
    ...
    'dca-create-info': 'नीचे दिए गए आइकन पर क्लिक करें और दैनिक कक्षा गतिविधि बनाने के लिए Gooru लाइब्रेरी से सामग्री की खोज करें। आप पाठ्यक्रम मानचित्र पर क्लिक करके भी अपने पाठ्यक्रम मानचित्र से दैनिक कक्षा गतिविधि में सामग्री  जोड़ सकते हैं।',
    'schedule-for-later': 'बाद के लिये शिड्यूल करें',
    'teach-this-activity-later': 'इस गतिविधि को बाद में डीसीए में सिखायें',
    'schedule-dca-instruction-1': 'इस गतिविधि को सिखाने के लिए बाद की तारीख चुनें।',
    'schedule-dca-instruction-2': 'यह गतिविधि चुनी गई तारीख पर डीसीए में दिखाई देगी।',
    'navigator-banner': {
      'title': 'गणित के लिए नेविगेटर',
      'description': 'सीखने की तकनीक के लिए इस जीपीएस का उपयोग करके, हमने यह सुनिश्चित करने के लिए गणित के लिए नेविगेटर तैयार किया है कि प्रत्येक छात्र आत्मविश्वास प्राप्त कर सके और गणित में अपनी शिक्षा को तेज कर सके। <br/> गणित के लिए नेविगेटर ग्रेड 2-12 से सभी गणित अवधारणाओं को कवर करने का एक कोर्स है। छात्रों को उनके वर्तमान ज्ञान पर निर्माण के लिए डिजाइन किए गए व्यक्तिगत मार्ग के माध्यम से मार्गांतरित किया जाता है और साथ ही साथ उनके ज्ञान को पूण करता है। इस व्यापक और व्यक्तिगत अनुभव के माध्यम से, हर छात्र अधिक उन्नत गणित के लिए पूरी तरह से तैयार हो सकता है।',
    ...
    'class': {
      ...
      'class-management-tab': {
        ...
        'course-null': 'कक्षा को अभी तक कोई पाठ्यक्रम नहीं सौंपा गया है।',
        'course-subject-null': 'कक्षा को सौंपा गया पाठ्यक्रम वैध विषय के लिए टैग नहीं किया गया है।',
      ...
      'students-tab': {
        ...
        'location': 'स्थान',
        'currently-studying': 'अभी अध्ययन कर रहे हैं',
        ...
        'proficiency-in': 'में प्रवीणता',
        'data-not-available': 'डेटा उपलब्ध नहीं',
        'course-coverage-label': 'कक्षा में सभी छात्रों के लिए दक्षताओं की संचयी गणना',
        'error-message': 'कक्षा में कोई पाठ्यक्रम निर्धारित नहीं है या छात्रों के पास कक्षा में अभी तक रोस्टेड नहीं है। एक बार पाठ्यक्रम कक्षा को सौंपा गया है और छात्रों को रोस्ट किया गया है, कक्षा की योग्यता रिपोर्ट यहां दिखाई जाएगी'
      },
      'class-activities': 'कक्षा की दैनिक गतिविधियां',
      ...
      'class-activities-tab': {
        ...
        'enter-max-assessment-time-spent': 'मूल्यांकन पूरा करने में बिताया गया समय दर्ज करें',
      ...
      'class-settings': {
        'class-settings-sec': {
          'generate-pathway': 'सीखने के मार्ग को निजीकृत करें',
          'class-settings-sec-head': 'वर्ग सेटिंग्स',
          'class-settings-sec-desc': 'ट्रॉफी अर्जित करने के लिए न्यूनतम प्रदर्शन',
          'class-code': 'कक्षा का कोड',
          'subject': 'विषय',
          'framework': 'ढांचा',
          ...
          'offline-msg': 'एक बार ऑफ़लाइन चिह्नित करने के बाद, कक्षा को फिर से ऑनलाइन नहीं बनाया जा सकता है।',
          'offline-toggle-tooltip': 'यदि आप इसे एक ऑफ़लाइन कक्षा बनाना चाहते हैं, तो हाँ का चयन करें',
          'offline-tooltip': 'क्लासरूम, जहां छात्र नाविक पर ऑनलाइन अध्ययन नहीं करते हैं, उन्हें ऑफ़लाइन के रूप में चिह्नित किया जाता है। शिक्षक ऑफ़लाइन सीखने वाले छात्रों को ट्रैक करता है और छात्रों की ओर से डेटा दर्ज करता है',
          'language': 'निर्देश की भाषा'
        },
        'student-settings-sec': {
          'student-settings-sec-head': 'छात्र सेटिंग',
          'col-head-active': 'सक्रिय'
        },
        'course-settings-sec': {
          'course-settings-sec-head': 'पाठ्यक्रम सेटिंग्स',
          'is-route0-applicable': 'प्रोफ़ाइल पर अंतराल को कवर करना चाहिए?',
          'apply-settings': 'सेटिंग लागू करें',
          'origin-info': 'सबसे कम ग्रेड स्तर की सामग्री क्या है जिसे आपके छात्रों को अध्ययन करना चाहिए?',
          'current-grade-info': 'आपकी कक्षा का ग्रेड स्तर क्या है?'
        },
        'gen-baseline': {
          'baseline-1': '(1) आप कक्षा के मूल और गंतव्य के आधार पर प्रत्येक छात्र के लिए व्यक्तिगत शिक्षण मार्ग उत्पन्न कर सकते हैं',
          'baseline-2': '(2) डिफ़ॉल्ट रूप से, सभी छात्रों का ग्रेड स्तर उनके गंतव्य के रूप में होता है। आप उन छात्रों के लिए एक उच्च ग्रेड होने के लिए गंतव्य को समायोजित कर सकते हैं जो कक्षा में आगे हैं। छात्र के क्षितिज और उनके गंतव्य के आधार पर एक व्यक्तिगत पाठ्यक्रम मानचित्र बनाने के लिए सीखने के मार्ग को निजीकृत करें पर क्लिक करें।',
          'baseline-3': '(३) पूरी कक्षा के लिए पथ निर्माण पर केवल एक बार कार्रवाई की जा सकती है। उसके बाद, प्रत्येक छात्र के लिए कोई भी अपडेट व्यक्तिगत रूप से करना होगा।',
          'baseline-4': '(4) आप व्यक्तिगत छात्र के लिए डेस्टिनेशन ग्रेड भी समायोजित कर सकते हैं। आइकन पर क्लिक करें <i id = \\\\ \"ember1600 \\\\\" वर्ग = \\\\ \"एम्बर-देखें gru-icon सामग्री-चिह्न replay \\\\\" style = \\\\ \"vertical-align: Middle; \\\\\"> replay </i> एक बार पुष्टि करने के बाद; गंतव्य, वैयक्तिकृत पथ को पुन: स्थापित करने के लिए।'
        },
        'origin': 'मूल',
        'destination': 'गंतव्य',
        'students': 'छात्रों',
        'student-id': 'छात्र आईडी',
        'joined-on': 'पर शामिल हो गए',
        'action-lable-add-student': 'छात्र जोड़ें'
      }
    },
  ...
  'gru-submit-confirmation': {
    ...
    'description': 'आप इस प्रयास को समाप्त करने वाले हैं और सभी प्रतिक्रियाएं  सबमिट कर रहे हैं। किसी भी छोड़ दिये गये सवाल को  गलत माना जाएगा।',
    'cancel': 'रद्द करना',
    'ok': 'ठीक',
    'confirm': 'सभी सबमिट करें ',
  ...
  'gru-share-pop-over': {
    'copy': 'प्रतिलिपि',
    'ios-tooltip': 'कॉपी करने के लिए टैप पकड़ें!',
  ...
  'gru-category-panel': {
    'teacher': {
      ...
      'body': 'डेटा एनालिटिक्स के माध्यम से मानक-संरेखित सामग्री खोजें, सामग्री को कस्टमाइज़ करें और छात्र की प्रगति पर नजर रखें। ',
      'cta': 'कहानियां देखें'
    },
    'student': {
  ...
  'sign-up': {
    ...
    'step-child-description-2': ' सीखते रहें और स्व्यं को  कुछ सालों में देखें!',
  ...
  'change-password': {
    'change-password': 'पासवर्ड लिंक बदलें',
    'title': 'पासवर्ड बदलें',
    'current-password-label': 'अपना वर्तमान पासवर्ड दर्ज करें',
    'change-success': 'पासवर्ड सफलतापूर्वक बदला गया !!',
    'new-password-required': 'कृपया अपना नया पासवर्ड दर्ज करें।',
    'change-password-error': 'उह ओह! कुछ ठीक नहीं है। पासवर्ड बदलने में असमर्थ। कृपया पुन: प्रयास करें।'
  },
  'footer': {
  ...
  'student-first-experience': {
    ...
    'competency': {
      'popover': {
        'title': '{{शीर्षक}} सीमा',
        'content': 'अपने गंतव्य तक पहुँचने के लिए आपको अपने क्षितिज और इस ग्रेड लाइन के बीच के सभी मानकों का अध्ययन करने की आवश्यकता है।'
      }
    },
    ...
    'competency-level': {
      ...
      'in-progress': '{{गिनती}} प्रगति के मानक',
      'not-started': '{{गिनती}} मानक प्रारंभ नहीं हुए',
      'your-skyline': 'आपका क्षितिज'
    },
    'explanatory': {
      'master': {
        'title': 'महारत हासिल',
        'desc': 'इंगित करता है कि सबूत हैं कि आपने सफलतापूर्वक मानकों में महारत हासिल की है'
      },
      'in-progress': {
        'title': 'चालू',
        'desc': 'इंगित करता है कि ऐसे सबूत हैं कि आपने मानकों का अध्ययन करना शुरू कर दिया है और महारत हासिल करने की दिशा में प्रगति कर रहे हैं'
      },
      'not-started': {
        'title': 'शुरू नही हुआ',
        'desc': 'इंगित करता है कि कोई सबूत नहीं है और आप अभी तक मानकों का अध्ययन शुरू नहीं कर रहे हैं'
      }
    },
    'competency-level-partial': {
      'desc1': 'आप वर्तमान में हैं',
      'desc2': 'गणित के लिए अपने क्षितिज के नक्शे पर आपका स्वागत है। क्षितिज (मोटी सफेद रेखा) उच्चतम मानक को दर्शाता है जिसे आपने प्रत्येक डोमेन में महारत हासिल की है। डोमेन गणित का एक क्षेत्र है जिसका आप अध्ययन करते हैं, जैसे संख्या प्रणाली और भाव और समीकरण। प्रत्येक स्तंभ एक गणित डोमेन का प्रतिनिधित्व करता है। और कॉलम में प्रत्येक बॉक्स डोमेन में एक मानक का प्रतिनिधित्व करता है। एक बार जब आप सीखना शुरू करते हैं और मानकों को पूरा करते हैं, तो आपका क्षितिज लगातार टकराता रहेगा।'
    },
    'units': {
      'other': '{{गिनती}} इकाइयाँ'
    }
  ...
  'profile': {
    ...
    'proficiency': {
      ...
      'not-tagged': 'कक्षा में कोई कोर्स नहीं है या पाठ्यक्रम को वैध विषय या मानकों पर टैग नहीं किया गया है।',
      'show-compressed-chart': 'संक्षिप्त चार्ट दिखाएं',
      'show-expanded-chart': 'विस्तारित चार्ट दिखाएं'
    },
    'preference': {
      'language-preference': 'भाषा वरीयता',
  ...
  'taxonomy.modals': {
    ...
    'gru-standard-picker': {
      'browseSelectorText': 'किन मानकों को आवृत किया जाएगा?',
  ...
  'gru-settings-edit': {
    ...
    'feedback-summary': 'अतं में',
    'navigation-scoring': 'नेविगेशन और स्कोरिंग',
    'disable-heading': 'पाठ्यक्रम मानचित्र में मूल्यांकन सक्रिय करें',
    'disable-legend': 'छात्र अपने पाठ्यक्रम मानचित्र से मूल्यांकन का अभ्यास कर सकते हैं'
  },
  'gru-icon-popover': {
  ...
  'gru-tour': {
    ...
    'overview': {
      ...
      'stepTwo': {
        'title': 'कक्षा कोड',
        'description': 'आपके द्वारा बनाए गए प्रत्येक कक्षाखंड में एक विशिष्ट  वर्ग कोड होता है। जब आप अपने कक्षाखंड में शामिल होने और अपनी सामग्री तक पहुंचने के लिए तैयार हों तो आप छात्रों को यह कोड देंगे।'
      },
      'stepThree': {
        'title': 'छात्र और कक्षा डेटा की निगरानी करें',
        'description': 'यह आपको कक्षा और व्यक्तिगत छात्र मूल्यांकन डेटा देखने की अनुमति देता है यदि उन आकलन को छात्र पूरा करतें है  जो पाठ्यक्रम का हिस्सा हो  '
      },
      'stepFour': {
        'title': 'कक्षा की जानकारी',
        'description': 'यहां आप अपने कक्षाखंड के नाम को संपादित कर सकते हैं, अपने छात्रों के लिए घोषणाएं पोस्ट कर सकते हैं, अपनी कक्षा में नामांकित छात्रों के नाम देख सकते हैं, और अपने कक्षाखंड को हटा सकते हैं।'
      },
      'stepFive': {
      ...
      'stepSix': {
        ...
        'description': 'मूल्यांकन की कक्षा प्रगति की वास्तविक समय में निगरानी के लिए रीयल-टाइम डैशबोर्ड का उपयोग करें। <br> <br> छात्रों के लिए वास्तविक समय निर्धारण लॉन्च करने के लिए प्रत्येक मूल्यांकन के बाईं ओर \"गो लाइव\" आइकन पर क्लिक करें। <br><br><i class=\"real-time-icon\">'
      }
    },
    'quick-start': {
      'stepOne': {
        'title': 'अपने कक्षाखंडो को नेविगेटिंग करें',
        'description': 'यह नव निर्मित कक्षाखंड का एक दृश्य है। किसी भी समय कक्षाखंड में वापस जाने के लिए, \"Classrooms\"  पर क्लिक करें और उस कक्षाखंड का चयन करने के लिए ड्रॉप डाउन मेनू का उपयोग करें जिसे आप दर्ज करना चाहते हैं।\"'
      },
      'stepTwo': {
  ...
  'self-report': {
    ...
    'enter-timeSpent': 'यहाँ बिताया अपना समय दर्ज करें',
    'validation-error-time': 'मान्य समय दर्ज करें'
  },
  'notifications': {
    'notificationlist-header-title': 'सूचनाएं',
    'show-more': 'और अधिक जानें',
    'type': {
      'teacher-suggestion-title': 'आपके पास कक्षा में एक नया शिक्षक सुझाव है : {{ classTitle }}',
      'student-gradable-submission-title': 'कक्षा में ग्रेड के लिए आपके पास {{occurrence}} आइटम है : {{ classTitle }}',
      'student-self-report-title': '{{occurrence}} छात्र (ओं) ने कक्षा में प्रदर्शन की सूचना दी : {{ classTitle }}',
      'teacher-override-title': 'शिक्षक ने कक्षा में आपका सबमिशन सही किया है : {{ classTitle }}  ',
      'teacher-grading-complete-title': 'शिक्षक ने कक्षा में आपके सबमिशन को ग्रेड किया है : {{ classTitle }}'
    },
    'typeinclass': {
      'teacher-suggestion-title': 'आपके पास एक नया शिक्षक सुझाव है',
      'student-gradable-submission-title': 'आपके पास ग्रेड देने के लिये {{occurrence}} छात्र वस्तुएं हैं',
      'student-self-report-title': '{{occurrence}} पांच छात्र(ओं) ने प्रदर्शन की सूचना दी',
      'teacher-override-title': 'शिक्षक ने आपके सबमिशन को सही किया है',
      'teacher-grading-complete-title': 'शिक्षक ने कक्षा में आपके सबमिशन को ग्रेड किया है'
    }
  }
});
