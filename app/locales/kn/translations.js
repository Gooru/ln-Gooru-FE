...
export default Object.assign(quizzesTranslations, {
 ...
 'errors':{  
   ...
   'common':{  
      ...
      'add-content-prompt':'ನೀವು ಇನ್ನೂ <span> {{type}} </span> ಅನ್ನು ರಚಿಸಲಿಲ್ಲ. ಮುಂದುವರಿಯಿರಿ, ದಪ್ಪವಾಗಿರಿ.',
      ...
      'no-assessments-to-display':'ಯಾವುದೇ <span> ಮೌಲ್ಯಮಾಪನಗಳನ್ನು </span> ಪ್ರದರ್ಶಿಸಲು.',
      'no-collections-to-display':'ಯಾವುದೇ <span> ಸಂಗ್ರಹಣೆಗಳು </span> ಪ್ರದರ್ಶಿಸಲು.',
      'no-courses-to-display':'ಪ್ರದರ್ಶಿಸಲು ಯಾವುದೇ <span> ಶಿಕ್ಷಣ </span> ಇಲ್ಲ.',
      'no-questions-to-display':'ಯಾವುದೇ <span> ಪ್ರಶ್ನೆಗಳನ್ನು </span> ಪ್ರದರ್ಶಿಸಲು ಇಲ್ಲ.',
      'no-resources-to-display':'ಯಾವುದೇ <span> ಸಂಪನ್ಮೂಲಗಳನ್ನು </span> ಪ್ರದರ್ಶಿಸಲು.',
      'no-rubrics-to-display':'ಪ್ರದರ್ಶಿಸಲು ಯಾವುದೇ <span> ರಬ್ರಿಕ್ಸ್ </span> ಇಲ್ಲ.',
      ...
      'no-results-message':'ನಿಮ್ಮ ಕಾಗುಣಿತವನ್ನು ಪರಿಶೀಲಿಸಿ. ನಾವೆಲ್ಲರೂ ತಪ್ಪುಗಳನ್ನು ಮಾಡಿದ್ದೇವೆ! <br/> ವಿಶಾಲವಾಗಿ ಹೋಗಿ ಕೆಲವು ಶೋಧಕಗಳನ್ನು ತೆಗೆದುಹಾಕಿ. <br/> ಅಥವಾ ಬದಲಿಗೆ ಇದೇ ಪದವನ್ನು ಹುಡುಕಲು ಪ್ರಯತ್ನಿಸಿ.',
      ...
      'remix-warning':'ಮುಖ್ಯಸ್ಥರು! ಈ ಕೋರ್ಸ್ನಲ್ಲಿ ಸಾಕಷ್ಟು ಆಕರ್ಷಕ ವಿಷಯವಿದೆ ಮತ್ತು ನಕಲು ಮಾಡುವ ಸಮಯ ತೆಗೆದುಕೊಳ್ಳುತ್ತದೆ. ನೀವು ಪ್ರಕ್ರಿಯೆಯನ್ನು ಪ್ರಾರಂಭಿಸಲು ಬಯಸುವಿರಾ ಎಂದು ಖಚಿತಪಡಿಸಿಕೊಳ್ಳಿ ಮತ್ತು 15 ನಿಮಿಷಗಳಲ್ಲಿ ನಿಮ್ಮ <b> ಪ್ರೊಫೈಲ್ನಲ್ಲಿ ಈ ಕೋರ್ಸ್ನ ನಿಮ್ಮ ನಕಲನ್ನು ನೀವು ಕಾಣಬಹುದು. </b>',
      'remove':'ತೆಗೆದುಹಾಕಿ',
      'report':'ವರದಿ',
   ...
   'content':{  
      ...
      'questions':{  
         'edit':{  
            'add-to':'ಸೇರಿಸು',
            'best-practices':'<p> ಪ್ರಶ್ನೆಯು ವಿದ್ಯಾರ್ಥಿಯ ಉತ್ತರಕ್ಕೆ ಅಗತ್ಯವಿರುವ ಒಂದು ಸಂಪನ್ಮೂಲವಾಗಿದೆ, ಮತ್ತು ನಿಮ್ಮ ವಿದ್ಯಾರ್ಥಿಗಳು sbac, parcc ಮತ್ತು ಇತರ ಮೌಲ್ಯಮಾಪನಗಳಲ್ಲಿ ನೋಡಿದ ರೀತಿಯ ಪ್ರಶ್ನೆಗಳನ್ನು ಬೆಂಬಲಿಸಲು ನಾವು ಹಲವಾರು ಪ್ರಶ್ನೆ ಪ್ರಕಾರಗಳನ್ನು ಒದಗಿಸುತ್ತೇವೆ. </p> <p> ಈ ಪ್ರಶ್ನೆ ಪ್ರಕಾರಗಳಿಗೆ ಒಡ್ಡಿಕೊಳ್ಳುವ ವಿದ್ಯಾರ್ಥಿಗಳನ್ನು ನೀಡಲು ಮತ್ತು ಜ್ಞಾನವನ್ನು ಪ್ರದರ್ಶಿಸಲು ಬಹು ಸ್ವರೂಪಗಳನ್ನು ಒದಗಿಸಲು ನೀವು ಬಳಸುವ ಪ್ರಶ್ನೆಗಳ ಪ್ರಕಾರಗಳು. </p> <p> ಮಾನದಂಡಗಳು, ಸೂಕ್ಷ್ಮ ಗುಣಮಟ್ಟ ಮತ್ತು ಜ್ಞಾನದ ಆಳದ ಮಟ್ಟಕ್ಕೆ ನಿಮ್ಮ ಪ್ರಶ್ನೆಗಳನ್ನು ಟ್ಯಾಗ್ ಮಾಡಿ. ಶಿಕ್ಷಕ ಡ್ಯಾಶ್ಬೋರ್ಡ್ ಮೂಲಕ ನಿಮ್ಮ ವಿದ್ಯಾರ್ಥಿಗಳು ಪ್ರಶ್ನೆಗಳನ್ನು ಹೇಗೆ ಸಂವಹಿಸುತ್ತಿದ್ದಾರೆ ಎಂಬುದನ್ನು ನೀವು ನೋಡಬಹುದು. </p>',
            'information':{  
               'question-title':'ಪ್ರಶ್ನೆ ಶೀರ್ಷಿಕೆ',
      ...
      'modals':{  
         ...
         'delete-content':{  
            ...
            'content-legend':'{1} {{type}} </span> {{index}} - {{parentname}} ನಿಂದ {{title}}',
         ...
         'delete-resource':{  
            'legend':'ನೀವು ಶಾಶ್ವತವಾಗಿ ಅಳಿಸಲು ಬಯಸುತ್ತೀರಿ ಎಂಬುದನ್ನು ದೃಢೀಕರಿಸಿ <b> {{title}} </b>',
            'delete-warning':'ಈ {{ಕೌಟುಂಬಿಕತೆ}} ನಲ್ಲಿರುವ ಎಲ್ಲಾ ವಿಷಯಗಳು ಅಳಿಸಲ್ಪಡುತ್ತವೆ',
            'delete-error':'ಓಹ್! ಇದೀಗ {{type}} ಅಳಿಸಲು ಸಾಧ್ಯವಿಲ್ಲ. ದಯವಿಟ್ಟು ಶೀಘ್ರದಲ್ಲೇ ಮತ್ತೆ ಪ್ರಯತ್ನಿಸಿ.',
         ...
         'remove-content':{  
            'legend':'ನೀವು <b> {{parentname}} </b> ನಿಂದ {{title}} </b> ಅನ್ನು ತೆಗೆದು ಹಾಕಲಿದ್ದೀರಿ.',
   ...
   'student-landing':{  
      ...
      'no-classrooms':'ನೀವು ಯಾವುದೇ ತರಗತಿ ಕೊಠಡಿಗಳನ್ನು ಇನ್ನೂ ಸೇರಿಲ್ಲ. ನಿಮ್ಮ ಶಿಕ್ಷಕರ ವರ್ಗವನ್ನು ಸೇರಿಸಲು \\\\\\\'</br> ತರಗತಿಗೆ ಸೇರಲು\\\\\\\' ಕ್ಲಿಕ್ ಮಾಡಿ. ಲೈಬ್ರರಿ ಟ್ಯಾಬ್ನ ಅಡಿಯಲ್ಲಿ ನೀವು ವೈಶಿಷ್ಟ್ಯಗೊಳಿಸಿದ ಪಠ್ಯವನ್ನು ಸಹ ಹುಡುಕಬಹುದು.',
   ...
   'teacher-landing':{  
      ...
      'no-classrooms':'ನೀವು ಇನ್ನೂ ಯಾವುದೇ ತರಗತಿ ಕೊಠಡಿಗಳನ್ನು ರಚಿಸಿಲ್ಲ. ಲೈಬ್ರರಿ ಟ್ಯಾಬ್ನ ಅಡಿಯಲ್ಲಿ ವೈಶಿಷ್ಟ್ಯಗೊಳಿಸಿದ ಪಠ್ಯಕ್ಕಾಗಿ \\\\\\\'ತರಗತಿಯನ್ನು ರಚಿಸು\\\\\\\' ಅಥವಾ ಹುಡುಕಾಟವನ್ನು </br> ಕ್ಲಿಕ್ ಮಾಡಿ.',
   ...
   'gru-add-to':{  
      ...
      'assessments-info':'ಇಲ್ಲಿ ಪಟ್ಟಿ ಮಾಡಲಾದ ಮೌಲ್ಯಮಾಪನಗಳು <b> ಮತ್ತೊಂದು ಪಾಠ ಅಥವಾ ಕೋರ್ಸ್ಗೆ ಸೇರಿಲ್ಲ </b>',
      'collections-info':'ಇಲ್ಲಿ ಪಟ್ಟಿ ಮಾಡಲಾದ ಸಂಗ್ರಹಣೆಗಳು <b> ಮತ್ತೊಂದು ಪಾಠ ಅಥವಾ ಕೋರ್ಸ್ಗೆ ಸೇರಿಲ್ಲ </b>'
   },
   ...
   'forgot-password':{  
      ...
      'footer-google-description-1':'<a href=\'/sign-in\'> \\\\\\"google ನೊಂದಿಗೆ ಸೈನ್ ಇನ್ ಮಾಡಿ\\\\\\" ಅನ್ನು ಒತ್ತುವುದರ ಮೂಲಕ ಮತ್ತೊಮ್ಮೆ ಲಾಗಿಂಗ್ ಮಾಡಲು ಪ್ರಯತ್ನಿಸಿ. </a>',
   ...
   'profile':{  
      ...
      'proficiency':{  
         ...
         'skyline':'ಸ್ಕೈಲೈನ್',
         'baseline':'ಬೇಸ್ಲೈನ್',
         'not-tagged':'ವರ್ಗವು ಯಾವುದೇ ಕೋರ್ಸ್ ಅನ್ನು ಹೊಂದಿಲ್ಲ ಅಥವಾ ಕೋರ್ಸ್ ಅನ್ನು ಮಾನ್ಯವಾದ ವಿಷಯ ಅಥವಾ ಮಾನದಂಡಗಳಿಗೆ ಟ್ಯಾಗ್ ಮಾಡಲಾಗಿಲ್ಲ.'
      }
   },
   'gru-data-picker':{  
      'score':'ಸ್ಕೋರ್',
   ...
   'gru-tour':{  
      ...
      'overview':{  
         ...
         'stepSix':{  
            ...
            'description':'ನೈಜ ಸಮಯದಲ್ಲಿ ಮೌಲ್ಯಮಾಪನದಲ್ಲಿ ವರ್ಗ ಪ್ರಗತಿಯನ್ನು ಮೇಲ್ವಿಚಾರಣೆ ಮಾಡಲು ನೈಜ ಸಮಯದ ಡ್ಯಾಶ್ಬೋರ್ಡ್ ಅನ್ನು ಬಳಸಿ. <br> <br> ವಿದ್ಯಾರ್ಥಿಗಳಿಗೆ ನೈಜ ಸಮಯದ ಮೌಲ್ಯಮಾಪನವನ್ನು ಪ್ರಾರಂಭಿಸಲು ಪ್ರತಿ ಮೌಲ್ಯಮಾಪನದ ಎಡಭಾಗದಲ್ಲಿ ಕಂಡುಬರುವ \\\\\\\'ಗೋ ಲೈವ್\\\\\\\' ಐಕಾನ್ ಕ್ಲಿಕ್ ಮಾಡಿ. <br> <br> <i class = \\\\\\\'real-time-icon\\\\\\\'>'
         }
      },
      'quick-start':{  
         'stepOne':{  
   ...
   'report':{  
      'external-assessment-report':{  
         'note':'ಮೌಲ್ಯಮಾಪನಕ್ಕೆ ವಿದ್ಯಾರ್ಥಿ ವರದಿ ಮಾಡಿದ ಅಂಕಗಳೊಂದಿಗೆ ಇದು ಬಾಹ್ಯ ಮೌಲ್ಯಮಾಪನವಾಗಿದೆ. ವೈಯಕ್ತಿಕ ಪ್ರಶ್ನೆ ಮಟ್ಟದ ಡೇಟಾ ಲಭ್ಯವಿಲ್ಲ.',
   ...
   'notifications':{  
      ...
      'show-more':'ಇನ್ನು ಹೆಚ್ಚು ತೋರಿಸು',
      'type':{  
         'teacher-suggestion-title':'ನೀವು ತರಗತಿಯಲ್ಲಿ ಹೊಸ ಶಿಕ್ಷಕ ಸಲಹೆಯನ್ನು ಹೊಂದಿದ್ದೀರಿ : {{ classTitle }}',
         'student-gradable-submission-title':'You have {{occurrence}} item(s) to grade in class : {{ classTitle }}',
         'student-self-report-title':'{{occurrence}} ವಿದ್ಯಾರ್ಥಿ ವರ್ಗದ ಕಾರ್ಯಕ್ಷಮತೆಯನ್ನು ವರದಿ ಮಾಡಿದ್ದಾರೆ : {{ classTitle }}',
         'teacher-override-title':'ಶಿಕ್ಷಕ ನಿಮ್ಮ ಸಲ್ಲಿಕೆಗಳನ್ನು ವರ್ಗದಲ್ಲಿ ಸರಿಪಡಿಸಿದ್ದಾರೆ : {{ classTitle }}  ',
         'teacher-grading-complete-title':'ಶಿಕ್ಷಕನು ನಿಮ್ಮ ಸಲ್ಲಿಕೆಗಳನ್ನು ತರಗತಿಯಲ್ಲಿ ವರ್ಗೀಕರಿಸಿದ್ದಾನೆ : {{ classTitle }}'
      },
      'typeinclass':{  
         ...
         'teacher-grading-complete-title':'ಶಿಕ್ಷಕನು ನಿಮ್ಮ ಸಲ್ಲಿಕೆಗಳನ್ನು ತರಗತಿಯಲ್ಲಿ ವರ್ಗೀಕರಿಸಿದ್ದಾನೆ'
      }
   }
});
